...
#End Region
    ...
    Private Sub connectBTN_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles connectBTN.Click
        ...
        If String.Equals(tg.GetAppName, "loader") Then
            MsgBox("A target application must be loaded on the Target PC for this Demo")
        End If
    ...
    Private Sub ListBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ListBox1.SelectedIndexChanged
        ...
        If String.Compare(tg.GetAppName, "loader") Then
            Exit Sub
        End If
