xPC Target File Browser Sample:
================================
This sample contains a c# Winform application project developed with
Microsoft Visual Studio 2008 IDE to build a standalone executable 
to connect to an xPC Target PC from a host PC.
...
To run this sample, you will need a host PC and a target PC. Make sure the target PC 
is booted with an xPC Kernel bootable image and connectable to the host PC on the network.
