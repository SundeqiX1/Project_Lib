...
#
# File    : xpc_vc.tmf   $Revision: 1.1.6.26 $ $Date: 2010/03/26 17:48:06 $
#
# Abstract:
...
MODEL           = Copy_2_of_canceshi
MODULES         = Copy_2_of_canceshi_capi.c Copy_2_of_canceshi_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c canac2globals.c 
MAKEFILE        = Copy_2_of_canceshi.mk
MATLAB_ROOT     = C:\matlab2010b
ALT_MATLAB_ROOT = C:\MATLAB~1
MATLAB_BIN      = C:\matlab2010b\bin
ALT_MATLAB_BIN  = C:\MATLAB~1\bin
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\Administrator\Desktop\±¸·Ý
S_FUNCTIONS     = pcl731.c canac2pcisetup.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f C:\Users\ADMINI~1\AppData\Roaming\MATHWO~1\MATLAB\R2010b\mexopts.bat
...
MODELLIB                  = Copy_2_of_canceshilib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Copy_2_of_canceshi_xpc_rtw
...
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\lib\xpccanac2pci_mb1_vc.lib
!else
LIBS = $(LIBS) xpccanac2pci_mb1.lib
!endif 
!if "$(OPT_OPTS)" == "$(DEFAULT_OPT_OPTS)"
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\lib\xpccanac2pci_mb2_vc.lib
!else
LIBS = $(LIBS) xpccanac2pci_mb2.lib
!endif 
!if "$(OPT_OPTS)" == "$(DEFAULT_OPT_OPTS)"
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\lib\xpccanac2pci_mb3_vc.lib
!else
LIBS = $(LIBS) xpccanac2pci_mb3.lib
!endif 
...
$(MODEL)_xpc.dll : set_environment_variables $(OBJS) $(SHARED_LIB) $(LIBS) $(MODELREF_LINK_LIBS)
	...
	$(LD) $(LDFLAGS) $(BLASLIBS) $(LIBS) $(S_FUNCTIONS_LIB) $(CANLIB) $(SHARED_LIB) @$(CMD_FILE) -out:$@
	@del $(CMD_FILE)
...
MODULES_xpccanac2pci_mb1 = \
	dummy.obj \


xpccanac2pci_mb1.lib : rtw_proj.tmw $(MAKEFILE) $(MODULES_xpccanac2pci_mb1)
	@cmd /C "echo ### Creating $@"
	$(LIBCMD) /nologo /out:$@ $(MODULES_xpccanac2pci_mb1)
	@cmd /C "echo ### Created $@"

MODULES_xpccanac2pci_mb2 = \
	dummy.obj \


xpccanac2pci_mb2.lib : rtw_proj.tmw $(MAKEFILE) $(MODULES_xpccanac2pci_mb2)
	@cmd /C "echo ### Creating $@"
	$(LIBCMD) /nologo /out:$@ $(MODULES_xpccanac2pci_mb2)
	@cmd /C "echo ### Created $@"

MODULES_xpccanac2pci_mb3 = \
	dummy.obj \


xpccanac2pci_mb3.lib : rtw_proj.tmw $(MAKEFILE) $(MODULES_xpccanac2pci_mb3)
	@cmd /C "echo ### Creating $@"
	$(LIBCMD) /nologo /out:$@ $(MODULES_xpccanac2pci_mb3)
	@cmd /C "echo ### Created $@"
