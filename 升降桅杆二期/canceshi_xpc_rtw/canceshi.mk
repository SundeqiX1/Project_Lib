...
MODEL           = canceshi
MODULES         = canceshi_capi.c canceshi_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c rtw_modelmap_utils.c xpc_datatype_ground.c canac2globals.c 
MAKEFILE        = canceshi.mk
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\canceshi_xpc_rtw
