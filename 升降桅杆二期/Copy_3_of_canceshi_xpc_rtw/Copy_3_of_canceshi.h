 ...
 */
#ifndef RTW_HEADER_Copy_3_of_canceshi_h_
#define RTW_HEADER_Copy_3_of_canceshi_h_
#include "rtw_modelmap.h"
#ifndef Copy_3_of_canceshi_COMMON_INCLUDES_
# define Copy_3_of_canceshi_COMMON_INCLUDES_
...
#endif                                 /* Copy_3_of_canceshi_COMMON_INCLUDES_ */

#include "Copy_3_of_canceshi_types.h"
...
#define Copy_3_of_canceshi_rtModel     rtModel_Copy_3_of_canceshi
...
typedef struct {
  ...
  real_T IntegerDelay_j;               /* '<S3>/Integer Delay' */
  ...
  real_T IntegerDelay_d;               /* '<S1>/Integer Delay' */
  ...
  boolean_T RelationalOperator_h;      /* '<S3>/Relational Operator' */
  boolean_T RelationalOperator_e;      /* '<S1>/Relational Operator' */
} BlockIO_Copy_3_of_canceshi;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T IntegerDelay_X;               /* '<S2>/Integer Delay' */
  real_T IntegerDelay_X_b;             /* '<S3>/Integer Delay' */
  real_T IntegerDelay_X_h;             /* '<S1>/Integer Delay' */
} D_Work_Copy_3_of_canceshi;

/* Backward compatible GRT Identifiers */
#define rtB                            Copy_3_of_canceshi_B
#define BlockIO                        BlockIO_Copy_3_of_canceshi
#define rtXdot                         Copy_3_of_canceshi_Xdot
#define StateDerivatives               StateDerivatives_Copy_3_of_canceshi
#define tXdis                          Copy_3_of_canceshi_Xdis
#define StateDisabled                  StateDisabled_Copy_3_of_canceshi
#define rtP                            Copy_3_of_canceshi_P
#define Parameters                     Parameters_Copy_3_of_canceshi
#define rtDWork                        Copy_3_of_canceshi_DWork
#define D_Work                         D_Work_Copy_3_of_canceshi

/* Parameters (auto storage) */
struct Parameters_Copy_3_of_canceshi_ {
  ...
  real_T shengjiangy_Value;            /* Expression: 3
                                        ...
                                        */
  real_T IntegerDelay_InitialCondition_a;/* Expression: vinit
  ...
  real_T xuanzhuany_Value;             /* Expression: 3
                                        ...
                                        */
  real_T IntegerDelay_InitialCondition_d;/* Expression: vinit
...
struct rtModel_Copy_3_of_canceshi {
  const char_T *path;
...
extern Parameters_Copy_3_of_canceshi Copy_3_of_canceshi_P;

/* Block signals (auto storage) */
extern BlockIO_Copy_3_of_canceshi Copy_3_of_canceshi_B;

/* Block states (auto storage) */
extern D_Work_Copy_3_of_canceshi Copy_3_of_canceshi_DWork;

/* Model entry point functions */
extern void Copy_3_of_canceshi_initialize(boolean_T firstTime);
extern void Copy_3_of_canceshi_output(int_T tid);
extern void Copy_3_of_canceshi_update(int_T tid);
extern void Copy_3_of_canceshi_terminate(void);

/* Real-time Model object */
extern struct rtModel_Copy_3_of_canceshi *Copy_3_of_canceshi_rtM;
 ...
 *
 * '<Root>' : Copy_3_of_canceshi
 * '<S1>'   : Copy_3_of_canceshi/Subsystem1
 * '<S2>'   : Copy_3_of_canceshi/Subsystem2
 * '<S3>'   : Copy_3_of_canceshi/Subsystem3
 */
#endif                                 /* RTW_HEADER_Copy_3_of_canceshi_h_ */
