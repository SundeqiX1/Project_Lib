...
MODEL           = faren
MODULES         = faren_capi.c faren_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c canac2globals.c 
MAKEFILE        = faren.mk
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\faren_xpc_rtw
