...
typedef struct {
  ...
  real_T CANbitpacking3;               /* '<S12>/CAN bit-packing 3' */
  real_T MultiportSwitch1;             /* '<S8>/Multiport Switch1' */
  real_T Product1_p;                   /* '<S26>/Product1' */
  real_T Product1_n;                   /* '<S27>/Product1' */
  real_T IntegerDelay;                 /* '<S10>/Integer Delay' */
  ...
  real_T MultiportSwitch1_c;           /* '<Root>/Multiport Switch1' */
  real_T CANbitpacking2;               /* '<S2>/CAN bit-packing 2' */
  real_T CANbitpacking2_k;             /* '<S13>/CAN bit-packing 2' */
  real_T SwitchControl;                /* '<S5>/SwitchControl' */
  real_T SwitchControl_o;              /* '<S6>/SwitchControl' */
  real_T IntegerDelay_j;               /* '<S11>/Integer Delay' */
  ...
  real_T IntegerDelay_m;               /* '<S9>/Integer Delay' */
  ...
  real_T CANbitpacking3_dd;            /* '<S17>/CAN bit-packing 3' */
  real_T CANbitpacking2_h;             /* '<S1>/CAN bit-packing 2' */
  real_T CANbitpacking1_j;             /* '<S1>/CAN bit-packing 1' */
  real_T SwitchControl_l;              /* '<S15>/SwitchControl' */
  real_T Add_c;                        /* '<Root>/Add' */
  real_T f1;                           /* '<Root>/f1' */
  real_T f2;                           /* '<Root>/f2' */
  real_T f3;                           /* '<Root>/f3' */
  real_T f4[4];                        /* '<Root>/f4' */
  ...
  real_T a[4];                         /* '<Root>/a' */
  real_T SwitchControl_g;              /* '<S16>/SwitchControl' */
  uint16_T Product_b;                  /* '<Root>/Product' */
  ...
  uint8_T Compare_b;                   /* '<S4>/Compare' */
  uint8_T DataTypeConversion17;        /* '<S12>/Data Type Conversion17' */
  uint8_T DataTypeConversion18;        /* '<S12>/Data Type Conversion18' */
  ...
  uint8_T DataTypeConversion7_m;       /* '<S13>/Data Type Conversion7' */
  uint8_T DataTypeConversion16_c;      /* '<S13>/Data Type Conversion16' */
  uint8_T DataTypeConversion1_i;       /* '<S13>/Data Type Conversion1' */
  uint8_T DataTypeConversion2_j;       /* '<S13>/Data Type Conversion2' */
  uint8_T DataTypeConversion3_n;       /* '<S13>/Data Type Conversion3' */
  uint8_T DataTypeConversion4_a;       /* '<S13>/Data Type Conversion4' */
  uint8_T DataTypeConversion5_k;       /* '<S13>/Data Type Conversion5' */
  uint8_T DataTypeConversion6_g;       /* '<S13>/Data Type Conversion6' */
  ...
  uint8_T DataTypeConversion18_f;      /* '<S17>/Data Type Conversion18' */
  uint8_T DataTypeConversion17_co;     /* '<S17>/Data Type Conversion17' */
  ...
  boolean_T Compare_e;                 /* '<S18>/Compare' */
  boolean_T Compare_a;                 /* '<S32>/Compare' */
  boolean_T LogicalOperator_n;         /* '<S26>/Logical Operator' */
  boolean_T Compare_c;                 /* '<S33>/Compare' */
  boolean_T Compare_l;                 /* '<S19>/Compare' */
  boolean_T Compare_l2;                /* '<S34>/Compare' */
  boolean_T LogicalOperator_a;         /* '<S27>/Logical Operator' */
  boolean_T Compare_lh;                /* '<S20>/Compare' */
  boolean_T Compare_g;                 /* '<S35>/Compare' */
  boolean_T LogicalOperator_l;         /* '<S28>/Logical Operator' */
  boolean_T Compare_aq;                /* '<S21>/Compare' */
  boolean_T Compare_k;                 /* '<S36>/Compare' */
  boolean_T LogicalOperator_p;         /* '<S29>/Logical Operator' */
  boolean_T Compare_f;                 /* '<S22>/Compare' */
  boolean_T Compare_o;                 /* '<S30>/Compare' */
  boolean_T LogicalOperator_o;         /* '<S24>/Logical Operator' */
  boolean_T Compare_li;                /* '<S23>/Compare' */
  boolean_T Compare_go;                /* '<S31>/Compare' */
  boolean_T LogicalOperator_aj;        /* '<S25>/Logical Operator' */
...
typedef struct {
  real_T IntegerDelay_X[2];            /* '<S10>/Integer Delay' */
  real_T IntegerDelay_X_o[2];          /* '<S11>/Integer Delay' */
  real_T IntegerDelay_X_m[2];          /* '<S9>/Integer Delay' */
...
struct Parameters_canceshi1_ {
  real_T shengjiangy1_Value;           /* Expression: 1
                                        * Referenced by: '<Root>/shengjiangy1'
                                        */
  real_T shengjiangy_Value;            /* Expression: 3
                                        * Referenced by: '<Root>/shengjiangy'
                                        */
  real_T xuanzhuany1_Value;            /* Expression: 2
                                        * Referenced by: '<Root>/xuanzhuany1'
                                        */
  real_T xuanzhuany_Value;             /* Expression: 3
                                        * Referenced by: '<Root>/xuanzhuany'
                                        */
  real_T Constant8_Value;              /* Expression: 223
                                        * Referenced by: '<S8>/Constant8'
                                        */
  real_T Constant7_Value;              /* Expression: 239
                                        * Referenced by: '<S8>/Constant7'
                                        */
  real_T Constant6_Value;              /* Expression: 247
                                        * Referenced by: '<S8>/Constant6'
                                        */
  real_T Constant5_Value;              /* Expression: 251
                                        * Referenced by: '<S8>/Constant5'
                                        */
  real_T Constant4_Value;              /* Expression: 253
                                        * Referenced by: '<S8>/Constant4'
                                        */
  real_T Constant3_Value;              /* Expression: 254
  ...
  real_T Constant18_Value;             /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_c;            /* Expression: 6
  ...
  real_T IntegerDelay_InitialCondition;/* Expression: vinit
                                        * Referenced by: '<S10>/Integer Delay'
                                        */
  ...
  real_T constant11_Value;             /* Expression: 0
                                        * Referenced by: '<Root>/constant11'
                                        */
  real_T Constant7_Value_mg;           /* Expression: 43
  ...
  real_T IntegerDelay_InitialCondition_l;/* Expression: vinit
                                          * Referenced by: '<S11>/Integer Delay'
                                          */
  ...
  real_T Constant3_Value_a;            /* Expression: 255
                                        ...
                                        */
  real_T Constant4_Value_my;           /* Expression: 15
  ...
  real_T Constant14_Value_g;           /* Expression: 0
                                        ...
                                        */
  real_T Constant_Value_bh;            /* Expression: 1000
  ...
  real_T Setup_P3_Size[2];             /* Computed Parameter: Setup_P3_Size
                                        * Referenced by: '<Root>/Setup '
                                        */
  real_T Setup_P3[6];                  /* Expression: can1SendS
                                        * Referenced by: '<Root>/Setup '
                                        */
  real_T Setup_P4_Size[2];             /* Computed Parameter: Setup_P4_Size
                                        * Referenced by: '<Root>/Setup '
                                        */
  real_T Setup_P4[5];                  /* Expression: can1RecS
                                        * Referenced by: '<Root>/Setup '
                                        */
  ...
  real_T Setup_P6_Size[2];             /* Computed Parameter: Setup_P6_Size
                                        * Referenced by: '<Root>/Setup '
                                        */
  real_T Setup_P6;                     /* Expression: can2RecS
                                        * Referenced by: '<Root>/Setup '
                                        */
  ...
  real_T Setup_P11_Size[2];            /* Computed Parameter: Setup_P11_Size
                                        * Referenced by: '<Root>/Setup '
                                        */
  real_T Setup_P11[5];                 /* Expression: can1RecSI
                                        * Referenced by: '<Root>/Setup '
                                        */
  ...
  real_T Setup_P13_Size[2];            /* Computed Parameter: Setup_P13_Size
                                        * Referenced by: '<Root>/Setup '
                                        */
  real_T Setup_P13;                    /* Expression: can2RecSI
                                        * Referenced by: '<Root>/Setup '
                                        */
  ...
  uint16_T Constant_Value_c;           /* Computed Parameter: Constant_Value_c
                                        ...
                                        */
  uint16_T Constant_Value_ap;          /* Computed Parameter: Constant_Value_ap
  ...
  uint8_T SwitchControl_Threshold;     /* Expression: uint8(0)
                                        ...
                                        */
  uint8_T Constant_Value_nf;           /* Computed Parameter: Constant_Value_nf
                                        * Referenced by: '<S3>/Constant'
                                        */
  uint8_T Constant_Value_k2;           /* Computed Parameter: Constant_Value_k2
  ...
  uint8_T SwitchControl_Threshold_n;   /* Expression: uint8(0)
                                        ...
                                        */
  uint8_T Constant_Value_iq;           /* Expression: uint8(1)
                                        * Referenced by: '<S6>/Constant'
                                        */
  uint8_T SwitchControl_Threshold_m;   /* Expression: uint8(0)
                                        * Referenced by: '<S6>/SwitchControl'
                                        */
  uint8_T Constant_Value_if;           /* Expression: uint8(1)
 ...
 * '<S3>'   : canceshi1/Compare To Constant
 * '<S4>'   : canceshi1/Compare To Constant1
 * '<S5>'   : canceshi1/Manual Switch
 * '<S6>'   : canceshi1/Manual Switch1
 * '<S7>'   : canceshi1/Manual Switch2
 * '<S8>'   : canceshi1/Subsystem
 * '<S9>'   : canceshi1/Subsystem1
 * '<S10>'  : canceshi1/Subsystem2
 * '<S11>'  : canceshi1/Subsystem3
 * '<S12>'  : canceshi1/Subsystem4
 * '<S13>'  : canceshi1/Subsystem5
 * '<S14>'  : canceshi1/Subsystem6
 * '<S15>'  : canceshi1/255_15shineng/Manual Switch
 * '<S16>'  : canceshi1/255_15shineng/Manual Switch1
 * '<S17>'  : canceshi1/255_15shineng/jihuo
 * '<S18>'  : canceshi1/Subsystem6/Compare To Constant
 * '<S19>'  : canceshi1/Subsystem6/Compare To Constant1
 * '<S20>'  : canceshi1/Subsystem6/Compare To Constant2
 * '<S21>'  : canceshi1/Subsystem6/Compare To Constant3
 * '<S22>'  : canceshi1/Subsystem6/Compare To Constant4
 * '<S23>'  : canceshi1/Subsystem6/Compare To Constant5
 * '<S24>'  : canceshi1/Subsystem6/Subsystem
 * '<S25>'  : canceshi1/Subsystem6/Subsystem1
 * '<S26>'  : canceshi1/Subsystem6/Subsystem2
 * '<S27>'  : canceshi1/Subsystem6/Subsystem3
 * '<S28>'  : canceshi1/Subsystem6/Subsystem4
 * '<S29>'  : canceshi1/Subsystem6/Subsystem5
 * '<S30>'  : canceshi1/Subsystem6/Subsystem/Compare To Constant
 * '<S31>'  : canceshi1/Subsystem6/Subsystem1/Compare To Constant
 * '<S32>'  : canceshi1/Subsystem6/Subsystem2/Compare To Constant
 * '<S33>'  : canceshi1/Subsystem6/Subsystem2/Compare To Constant1
 * '<S34>'  : canceshi1/Subsystem6/Subsystem3/Compare To Constant
 * '<S35>'  : canceshi1/Subsystem6/Subsystem4/Compare To Constant
 * '<S36>'  : canceshi1/Subsystem6/Subsystem5/Compare To Constant
 */
