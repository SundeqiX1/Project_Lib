...
void canceshi1_output(int_T tid)
{
  ...
  canceshi1_B.TmpSignalConversionAtPCL731Inpo[1] = canceshi1_P.Constant2_Value_m;
  canceshi1_B.TmpSignalConversionAtPCL731Inpo[2] = canceshi1_P.Constant3_Value_f;
  canceshi1_B.TmpSignalConversionAtPCL731Inpo[3] = canceshi1_P.Constant4_Value_m;
  canceshi1_B.TmpSignalConversionAtPCL731Inpo[4] = canceshi1_P.Constant5_Value_h;
  canceshi1_B.TmpSignalConversionAtPCL731Inpo[5] = canceshi1_P.Constant6_Value_d;
  canceshi1_B.TmpSignalConversionAtPCL731Inpo[6] = canceshi1_P.Constant7_Value_m;
  canceshi1_B.TmpSignalConversionAtPCL731Inpo[7] = canceshi1_P.Constant8_Value_p;
   ...
   */
  canceshi1_B.Compare = (canceshi1_B.CANbitunpacking5_o3 ==
    canceshi1_P.Constant_Value_nf);

  /* RelationalOperator: '<S4>/Compare' incorporates:
   *  Constant: '<S4>/Constant'
   */
  canceshi1_B.Compare_b = (canceshi1_B.CANbitunpacking5_o3 ==
    canceshi1_P.Constant_Value_k2);

  /* Logic: '<Root>/Logical Operator' */
  canceshi1_B.LogicalOperator = ((canceshi1_B.Compare != 0) ||
    (canceshi1_B.Compare_b != 0));

  /* Product: '<Root>/Product' */
  canceshi1_B.Product_b = (uint16_T)(FALSE ? (int32_T)
    canceshi1_B.LogicalOperator : 0);
   ...
   */
  canceshi1_B.Compare_e = (canceshi1_P.u_Value_l == canceshi1_P.Constant_Value_n);
  ...
  canceshi1_B.LogicalOperator_n = (canceshi1_B.Compare_e &&
    canceshi1_B.Compare_a);

  /* RelationalOperator: '<S33>/Compare' incorporates:
   *  Constant: '<S33>/Constant'
   */
  canceshi1_B.Compare_c = (canceshi1_B.CANbitunpacking_o1 >
    canceshi1_P.Constant_Value_i);

  /* Product: '<S26>/Product' incorporates:
   *  Constant: '<S26>/Constant'
   */
  canceshi1_B.Product = canceshi1_P.Constant_Value * (real_T)
    canceshi1_B.LogicalOperator_n * (real_T)canceshi1_B.Compare_c;
  ...
  canceshi1_B.LogicalOperator_a = (canceshi1_B.Compare_l &&
  ...
  canceshi1_B.LogicalOperator_l = (canceshi1_B.Compare_lh &&
    canceshi1_B.Compare_g);

  /* Product: '<S28>/Product' incorporates:
   *  Constant: '<S28>/Constant'
   */
  canceshi1_B.Product_p = canceshi1_P.Constant_Value_a * (real_T)
  ...
  canceshi1_B.LogicalOperator_p = (canceshi1_B.Compare_aq &&
    canceshi1_B.Compare_k);

  /* Product: '<S29>/Product' incorporates:
   *  Constant: '<S29>/Constant'
   */
  canceshi1_B.Product_n = canceshi1_P.Constant_Value_h * (real_T)
   ...
   */
  canceshi1_B.Compare_o = (canceshi1_B.CANbitunpacking_o1 >
    canceshi1_P.Constant_Value_c);

  /* Logic: '<S24>/Logical Operator' */
  canceshi1_B.LogicalOperator_o = (canceshi1_B.Compare_f &&
    canceshi1_B.Compare_o);

  /* Product: '<S24>/Product' incorporates:
   *  Constant: '<S24>/Constant'
   */
  canceshi1_B.Product_k = canceshi1_P.Constant_Value_g * (real_T)
   ...
   */
  canceshi1_B.Compare_go = (canceshi1_B.CANbitunpacking_o1 <
    canceshi1_P.Constant_Value_ap);

  /* Logic: '<S25>/Logical Operator' */
  canceshi1_B.LogicalOperator_aj = (canceshi1_B.Compare_li &&
    canceshi1_B.Compare_go);

  /* Product: '<S25>/Product1' incorporates:
   *  Constant: '<S25>/Constant1'
   */
  canceshi1_B.Product1 = canceshi1_P.Constant1_Value_p * (real_T)
    canceshi1_B.LogicalOperator_aj;

  /* Sum: '<S14>/Add' */
  canceshi1_B.Add = ((((canceshi1_B.Product + canceshi1_B.Product_c) +
                       canceshi1_B.Product_p) + canceshi1_B.Product_n) +
                     canceshi1_B.Product_k) + canceshi1_B.Product1;
  ...
  /* S-Function (canac2objsend): '<Root>/1808Send' */
  {
    ...
    if (!g_xpccanac2busstatus[1-1]) {
      ...
      EFLAGS_T flags;
      flags = saveAndDisableInterrupts();
      stat = CANPC_write_object_mb1(3, 8, (uint8_T *)&canceshi1_B.CANbitpacking3);
      restoreInterrupts(flags);
      ;
    }
  }
  ...
  switch ((int32_T)0.0) {
   case 0:
    canceshi1_B.MultiportSwitch1 = canceshi1_P.Constant2_Value;
    break;

   case 1:
    canceshi1_B.MultiportSwitch1 = canceshi1_P.Constant3_Value;
    break;

   case 2:
    canceshi1_B.MultiportSwitch1 = canceshi1_P.Constant4_Value;
    break;

   case 3:
    canceshi1_B.MultiportSwitch1 = canceshi1_P.Constant5_Value;
    break;

   case 4:
    canceshi1_B.MultiportSwitch1 = canceshi1_P.Constant6_Value;
    break;

   case 5:
    canceshi1_B.MultiportSwitch1 = canceshi1_P.Constant7_Value;
    break;

   default:
    canceshi1_B.MultiportSwitch1 = canceshi1_P.Constant8_Value;
    break;
  }
   ...
   */
  canceshi1_B.Product1_p = canceshi1_P.Constant1_Value_c * 0.0;

  /* Product: '<S27>/Product1' incorporates:
   *  Constant: '<S27>/Constant1'
   */
  canceshi1_B.Product1_n = canceshi1_P.Constant1_Value_j * 0.0;

  /* S-Function (sfix_udelay): '<S10>/Integer Delay' */
  ...
  if ((int32_T)canceshi1_B.RelationalOperator == 0) {
    canceshi1_B.MultiportSwitch1_c = canceshi1_B.CANbitpacking1;
  } else {
    canceshi1_B.MultiportSwitch1_c = canceshi1_B.CANbitpacking5;
  }
   ...
   */
  tmp = canceshi1_P.Constant7_Value_mg;
  if (rtIsNaN(tmp) || rtIsInf(tmp)) {
    tmp = 0.0;
  } else {
    tmp = fmod(floor(tmp), 256.0);
  ...
  /* Bit Packing: <S13>/CAN bit-packing 2 */
  {
  ...
  /* S-Function (canac2objsend): '<Root>/1808Send2' */
  {
    ...
    if (!g_xpccanac2busstatus[1-1]) {
      ...
      EFLAGS_T flags;
      flags = saveAndDisableInterrupts();
      stat = CANPC_write_object_mb1(4, 8, (uint8_T *)&canceshi1_B.SwitchControl);
      restoreInterrupts(flags);
      ;
    }
  }
   ...
   *  Constant: '<Root>/shengjiangy1'
   *  Constant: '<S6>/Constant'
   */
  if (canceshi1_P.Constant_Value_iq > canceshi1_P.SwitchControl_Threshold_m) {
    canceshi1_B.SwitchControl_o = canceshi1_P.shengjiangy_Value;
  } else {
    canceshi1_B.SwitchControl_o = canceshi1_P.shengjiangy1_Value;
  }

  /* S-Function (sfix_udelay): '<S11>/Integer Delay' */
  canceshi1_B.IntegerDelay_j = canceshi1_DWork.IntegerDelay_X_o[0];

  /* RelationalOperator: '<S11>/Relational Operator' */
  canceshi1_B.RelationalOperator_m = (canceshi1_B.SwitchControl_o ==
  ...
  /* DataTypeConversion: '<Root>/shengjianga' */
  canceshi1_B.shengjianga = canceshi1_B.SwitchControl_o;
  ...
  /* S-Function (canac2objsend): '<Root>/1808Send4' */
  {
    ...
    if (!g_xpccanac2busstatus[1-1]) {
      ...
      EFLAGS_T flags;
      flags = saveAndDisableInterrupts();
      stat = CANPC_write_object_mb1(1, 8, (uint8_T *)
   ...
   */
  if (canceshi1_P.Constant_Value_if > canceshi1_P.SwitchControl_Threshold_f) {
    canceshi1_B.SwitchControl_c = canceshi1_P.xuanzhuany_Value;
  } else {
    canceshi1_B.SwitchControl_c = canceshi1_P.xuanzhuany1_Value;
  }

  /* S-Function (sfix_udelay): '<S9>/Integer Delay' */
  canceshi1_B.IntegerDelay_m = canceshi1_DWork.IntegerDelay_X_m[0];

  /* RelationalOperator: '<S9>/Relational Operator' */
  canceshi1_B.RelationalOperator_o = (canceshi1_B.SwitchControl_c ==
  ...
  canceshi1_B.xuanzhuana = canceshi1_B.SwitchControl_c;
  ...
  /* S-Function (canac2objsend): '<Root>/1808Send5' */
  {
    ...
    if (!g_xpccanac2busstatus[1-1]) {
      ...
      EFLAGS_T flags;
      flags = saveAndDisableInterrupts();
      stat = CANPC_write_object_mb1(2, 8, (uint8_T *)
   ...
   */
  tmp = canceshi1_P.Constant4_Value_my;
  if (rtIsNaN(tmp) || rtIsInf(tmp)) {
    tmp = 0.0;
  } else {
    tmp = fmod(floor(tmp), 256.0);
  ...
  /* S-Function (canac2objsend): '<Root>/3402Send' */
  {
    ...
    if (!g_xpccanac2busstatus[1-1]) {
      ...
      EFLAGS_T flags;
      flags = saveAndDisableInterrupts();
      stat = CANPC_write_object_mb1(5, 8, (uint8_T *)
  ...
  LookUp_U16_U16_SAT( &(canceshi1_B.right3), canceshi1_P.right3_YData,
                     canceshi1_B.CANbitunpacking_o3, canceshi1_P.right3_XData,
                     1U);
   ...
   */
  canceshi1_B.Add_c = (real_T)canceshi1_B.right1 - canceshi1_P.Constant_Value_bh;

  /* DataTypeConversion: '<Root>/f1' */
  canceshi1_B.f1 = canceshi1_B.Add_c;
  ...
  LookUp_U16_U16_SAT( &(canceshi1_B.right2), canceshi1_P.right2_YData,
                     canceshi1_B.CANbitunpacking_o2, canceshi1_P.right2_XData,
                     1U);
...
{
  /* Update for S-Function (sfix_udelay): '<S10>/Integer Delay' incorporates:
   *  Constant: '<Root>/baozhuay'
   */
  ...
  /* Update for S-Function (sfix_udelay): '<S11>/Integer Delay' */
  canceshi1_DWork.IntegerDelay_X_o[0] = canceshi1_DWork.IntegerDelay_X_o[1];
  canceshi1_DWork.IntegerDelay_X_o[1] = canceshi1_B.SwitchControl_o;

  /* Update for S-Function (sfix_udelay): '<S9>/Integer Delay' */
  canceshi1_DWork.IntegerDelay_X_m[0] = canceshi1_DWork.IntegerDelay_X_m[1];
  canceshi1_DWork.IntegerDelay_X_m[1] = canceshi1_B.SwitchControl_c;
...
void canceshi1_initialize(boolean_T firstTime)
{
  ...
  /* external mode info */
  canceshi1_rtM->Sizes.checksums[0] = (2405041577U);
  canceshi1_rtM->Sizes.checksums[1] = (2770552574U);
  canceshi1_rtM->Sizes.checksums[2] = (1600673616U);
  canceshi1_rtM->Sizes.checksums[3] = (3530515317U);
...
void MdlInitializeSizes(void)
{
  ...
  canceshi1_rtM->Sizes.numBlocks = (311);/* Number of blocks */
  canceshi1_rtM->Sizes.numBlockIO = (175);/* Number of block outputs */
  canceshi1_rtM->Sizes.numBlockPrms = (238);/* Sum of parameter "widths" */
}
...
{
  /* InitializeConditions for S-Function (sfix_udelay): '<S10>/Integer Delay' */
  canceshi1_DWork.IntegerDelay_X[0] = canceshi1_P.IntegerDelay_InitialCondition;

  /* InitializeConditions for S-Function (sfix_udelay): '<S11>/Integer Delay' */
  canceshi1_DWork.IntegerDelay_X_o[0] =
    canceshi1_P.IntegerDelay_InitialCondition_l;

  /* InitializeConditions for S-Function (sfix_udelay): '<S9>/Integer Delay' */
