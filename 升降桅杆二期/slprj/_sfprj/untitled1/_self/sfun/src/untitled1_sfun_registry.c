...
{
  extern unsigned int sf_untitled1_process_testpoint_info_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_untitled1_process_testpoint_info_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_untitled1_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_untitled1_autoinheritance_info(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
