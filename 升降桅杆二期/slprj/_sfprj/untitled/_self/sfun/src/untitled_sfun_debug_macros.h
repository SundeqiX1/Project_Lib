...
#define _SFD_MACHINE_CALL(v1,v2,v3) sf_debug_call(_untitledMachineNumber_,UNREASONABLE_NUMBER,UNREASONABLE_NUMBER,MACHINE_OBJECT,v1,v2,v3,(unsigned int) _sfEvent_,-1,NULL,_sfTime_,1)
...
CHARTINSTANCE_CHARTNUMBER,\
CHARTINSTANCE_INSTANCENUMBER)
#define _SFD_CHART_CALL(v1,v2,v3) sf_debug_call(_untitledMachineNumber_,\
CHARTINSTANCE_CHARTNUMBER,\
CHARTINSTANCE_INSTANCENUMBER,\
...
#define _SFD_EML_CALL(v1,v2) eml_debug_line_call(_untitledMachineNumber_,\
CHARTINSTANCE_CHARTNUMBER,\
CHARTINSTANCE_INSTANCENUMBER,\
...
v1,v2,v3)
#define _SFD_SCRIPT_CALL(v1,v2) eml_debug_line_call(_untitledMachineNumber_,\
CHARTINSTANCE_CHARTNUMBER,\
CHARTINSTANCE_INSTANCENUMBER,\
v1,(unsigned int)_sfEvent_,\
v2,_sfTime_,1)
#define _SFD_CHART_COVERAGE_CALL(v1,v2,v3,v4) sf_debug_call(_untitledMachineNumber_,\
CHARTINSTANCE_CHARTNUMBER,\
CHARTINSTANCE_INSTANCENUMBER,\
CHART_OBJECT,v1,v2,v3,(unsigned int) _sfEvent_,\
v4,NULL,_sfTime_,1)
...
#define _SFD_CCP_CALL(v3,v4,v5) sf_debug_call(_untitledMachineNumber_,\
CHARTINSTANCE_CHARTNUMBER,\
CHARTINSTANCE_INSTANCENUMBER,\
