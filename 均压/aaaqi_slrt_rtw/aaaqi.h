...
#ifndef RTW_HEADER_aaaqi_h_
#define RTW_HEADER_aaaqi_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#include "rtw_modelmap.h"
#ifndef aaaqi_COMMON_INCLUDES_
# define aaaqi_COMMON_INCLUDES_
...
#endif                                 /* aaaqi_COMMON_INCLUDES_ */

#include "aaaqi_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_aaaqi                  RT_MODEL_aaaqi_T

/* Definition for use in the target main file */
#define aaaqi_rtModel                  RT_MODEL_aaaqi_T

/* user code (top of export header file) */
#include "xpcdatatypes.h"

/* Block signals for system '<Root>/Subsystem4' */
typedef struct {
  real_T Add;                          /* '<S15>/Add' */
} B_Subsystem4_aaaqi_T;

/* Block states (auto storage) for system '<Root>/Subsystem4' */
typedef struct {
  int8_T Subsystem4_SubsysRanBC;       /* '<Root>/Subsystem4' */
} DW_Subsystem4_aaaqi_T;
...
typedef struct {
  ...
  uint8_T is_active_c8_aaaqi;          /* '<S18>/Chart1' */
  uint8_T is_c8_aaaqi;                 /* '<S18>/Chart1' */
} DW_Chart1_aaaqi_T;
...
typedef struct {
  ...
  real_T u;                            /* '<Root>/水舱最大压力' */
  real_T DataTypeConversion1;          /* '<Root>/Data Type Conversion1' */
  real_T u_c;                          /* '<Root>/凸膜上下腔最小压力' */
  real_T u_m;                          /* '<Root>/凸膜上下腔最大压力' */
  ...
  real_T Saturation_c;                 /* '<S18>/Saturation' */
  real_T Fcn_o;                        /* '<S18>/Fcn' */
  real_T Saturation1_a;                /* '<S18>/Saturation1' */
  ...
  real_T Memory_h;                     /* '<S22>/Memory' */
  real_T Switch;                       /* '<S22>/Switch' */
  real_T Memory1_c;                    /* '<S22>/Memory1' */
  real_T Switch2;                      /* '<S22>/Switch2' */
  real_T DataTypeConversion18;         /* '<Root>/Data Type Conversion18' */
  real_T Memory_ht;                    /* '<S23>/Memory' */
  real_T Switch_g;                     /* '<S23>/Switch' */
  real_T Memory_j;                     /* '<S24>/Memory' */
  real_T Switch_i;                     /* '<S24>/Switch' */
  real_T Memory1_d;                    /* '<S24>/Memory1' */
  real_T Switch2_m;                    /* '<S24>/Switch2' */
  real_T DataTypeConversion22;         /* '<Root>/Data Type Conversion22' */
  real_T Memory1_o;                    /* '<S23>/Memory1' */
  real_T Switch2_a;                    /* '<S23>/Switch2' */
  real_T u_a;                          /* '<Root>/带气注水最大压力' */
  real_T DataTypeConversion1_e;        /* '<S14>/Data Type Conversion1' */
  ...
  real_T DataTypeConversion1_k;        /* '<S5>/Data Type Conversion1' */
  ...
  real_T DataTypeConversion5_a[5];     /* '<Root>/Data Type Conversion5' */
  real_T MultiportSwitch[8];           /* '<S14>/Multiport Switch' */
  real_T uDLookupTable_j;              /* '<Root>/1-D Lookup Table' */
  real_T Gain;                         /* '<Root>/Gain' */
  real_T DataTypeConversion_p[5];      /* '<S6>/Data Type Conversion' */
  real_T Saturation_j;                 /* '<S6>/Saturation' */
  ...
  real_T DataTypeConversion2_a;        /* '<Root>/Data Type Conversion2' */
  ...
  real_T Switch1_a;                    /* '<S38>/Switch1' */
  real_T Switch2_h;                    /* '<S38>/Switch2' */
  real_T Switch3_b;                    /* '<S38>/Switch3' */
  real_T Switch4_d;                    /* '<S38>/Switch4' */
  real_T Switch5_g;                    /* '<S38>/Switch5' */
  real_T Switch6_a;                    /* '<S38>/Switch6' */
  real_T Switch7_b;                    /* '<S38>/Switch7' */
  real_T Switch8_b;                    /* '<S38>/Switch8' */
  real_T Switch9_a;                    /* '<S38>/Switch9' */
  real_T SumofElements;                /* '<S38>/Sum of Elements' */
  real_T MultiportSwitch_b;            /* '<S38>/Multiport Switch' */
  real_T Product_i;                    /* '<S38>/Product' */
  real_T Gain_f;                       /* '<S38>/Gain' */
  real_T Product1_i;                   /* '<S38>/Product1' */
  real_T Gain1;                        /* '<S38>/Gain1' */
  real_T Sum1;                         /* '<S39>/Sum1' */
  real_T Gain1_o;                      /* '<S39>/Gain1' */
  real_T Sum;                          /* '<S39>/Sum' */
  real_T Gain_m;                       /* '<S39>/Gain' */
  real_T Product_c;                    /* '<S39>/Product' */
  real_T Add1_f;                       /* '<S39>/Add1' */
  real_T MultiportSwitch_j;            /* '<S39>/Multiport Switch' */
  real_T Switch1_m;                    /* '<S41>/Switch1' */
  real_T Switch2_mu;                   /* '<S41>/Switch2' */
  real_T Switch3_l;                    /* '<S41>/Switch3' */
  real_T Switch4_i;                    /* '<S41>/Switch4' */
  real_T Switch5_k;                    /* '<S41>/Switch5' */
  real_T Switch6_b;                    /* '<S41>/Switch6' */
  real_T Switch7_h;                    /* '<S41>/Switch7' */
  real_T Switch8_p;                    /* '<S41>/Switch8' */
  real_T Switch9_h;                    /* '<S41>/Switch9' */
  real_T SumofElements_f;              /* '<S41>/Sum of Elements' */
  real_T MultiportSwitch_d;            /* '<S41>/Multiport Switch' */
  real_T Product_j;                    /* '<S41>/Product' */
  real_T Product1_b;                   /* '<S41>/Product1' */
  real_T Product_m;                    /* '<S40>/Product' */
  real_T Add1_m;                       /* '<S40>/Add1' */
  real_T FromWs;                       /* '<S42>/FromWs' */
  real_T FromWs_n;                     /* '<S43>/FromWs' */
  real_T FromWs_f;                     /* '<S44>/FromWs' */
  real_T FromWs_o;                     /* '<S45>/FromWs' */
  real_T MultiportSwitch_m;            /* '<S40>/Multiport Switch' */
  real_T MultiportSwitch1_d;           /* '<S40>/Multiport Switch1' */
  real_T Sum_m;                        /* '<S40>/Sum' */
  real_T Gain_i;                       /* '<S40>/Gain' */
  real_T Sum1_l;                       /* '<S40>/Sum1' */
  real_T Gain1_l;                      /* '<S40>/Gain1' */
  real_T Sum2;                         /* '<S40>/Sum2' */
  real_T Gain2;                        /* '<S40>/Gain2' */
  real_T Sum3;                         /* '<S40>/Sum3' */
  real_T Gain3;                        /* '<S40>/Gain3' */
  real_T diancifa11_1_l;               /* '<S26>/Chart' */
  real_T diancifa11_2_l;               /* '<S26>/Chart' */
  real_T diancifa11_5_d;               /* '<S26>/Chart' */
  real_T diancifa20_n;                 /* '<S26>/Chart' */
  real_T diancifa16_1_l;               /* '<S26>/Chart' */
  real_T diancifa3_m;                  /* '<S26>/Chart' */
  real_T diancifa21_a;                 /* '<S26>/Chart' */
  real_T suoding_a;                    /* '<S26>/Chart' */
  real_T jiesuo_j;                     /* '<S26>/Chart' */
  real_T xuansong_n;                   /* '<S26>/Chart' */
  real_T xuanjin_b;                    /* '<S26>/Chart' */
  real_T bililiuliangfa18_1_a;         /* '<S26>/Chart' */
  real_T bililiuliangfa18_2_d;         /* '<S26>/Chart' */
  real_T bililiuliangfa18_3_p;         /* '<S26>/Chart' */
  real_T bililiuliangfa18_4_c;         /* '<S26>/Chart' */
  ...
  real_T Product_k;                    /* '<S28>/Product' */
  real_T Gain_j;                       /* '<S28>/Gain' */
  real_T Product1_g;                   /* '<S28>/Product1' */
  real_T Gain1_of;                     /* '<S28>/Gain1' */
  real_T Switch1_b;                    /* '<S28>/Switch1' */
  real_T Switch2_ax;                   /* '<S28>/Switch2' */
  real_T Switch3_p;                    /* '<S28>/Switch3' */
  real_T Switch4_e;                    /* '<S28>/Switch4' */
  real_T Switch5_o;                    /* '<S28>/Switch5' */
  real_T Switch6_g;                    /* '<S28>/Switch6' */
  real_T Switch7_n;                    /* '<S28>/Switch7' */
  real_T Switch8_g;                    /* '<S28>/Switch8' */
  real_T Switch9_m;                    /* '<S28>/Switch9' */
  real_T SumofElements_e;              /* '<S28>/Sum of Elements' */
  real_T MultiportSwitch_jk;           /* '<S28>/Multiport Switch' */
  real_T Sum1_n;                       /* '<S30>/Sum1' */
  real_T Gain1_j;                      /* '<S30>/Gain1' */
  real_T Sum_h;                        /* '<S30>/Sum' */
  real_T Gain_p;                       /* '<S30>/Gain' */
  real_T Product_l;                    /* '<S30>/Product' */
  real_T Add1_mg;                      /* '<S30>/Add1' */
  real_T MultiportSwitch_e;            /* '<S30>/Multiport Switch' */
  real_T Product_m3;                   /* '<S32>/Product' */
  real_T Product1_bp;                  /* '<S32>/Product1' */
  real_T Switch1_bv;                   /* '<S32>/Switch1' */
  real_T Switch2_p;                    /* '<S32>/Switch2' */
  real_T Switch3_m;                    /* '<S32>/Switch3' */
  real_T Switch4_f;                    /* '<S32>/Switch4' */
  real_T Switch5_b;                    /* '<S32>/Switch5' */
  real_T Switch6_k;                    /* '<S32>/Switch6' */
  real_T Switch7_g;                    /* '<S32>/Switch7' */
  real_T Switch8_l;                    /* '<S32>/Switch8' */
  real_T Switch9_o;                    /* '<S32>/Switch9' */
  real_T SumofElements_d;              /* '<S32>/Sum of Elements' */
  real_T MultiportSwitch_l;            /* '<S32>/Multiport Switch' */
  real_T Product_e;                    /* '<S31>/Product' */
  real_T Add1_n;                       /* '<S31>/Add1' */
  real_T FromWs_g;                     /* '<S33>/FromWs' */
  real_T FromWs_i;                     /* '<S34>/FromWs' */
  real_T FromWs_ou;                    /* '<S35>/FromWs' */
  real_T FromWs_fu;                    /* '<S36>/FromWs' */
  real_T MultiportSwitch_g;            /* '<S31>/Multiport Switch' */
  real_T MultiportSwitch1_e;           /* '<S31>/Multiport Switch1' */
  real_T Sum_l;                        /* '<S31>/Sum' */
  real_T Gain_o;                       /* '<S31>/Gain' */
  real_T Sum1_p;                       /* '<S31>/Sum1' */
  real_T Gain1_d;                      /* '<S31>/Gain1' */
  real_T Sum2_e;                       /* '<S31>/Sum2' */
  real_T Gain2_c;                      /* '<S31>/Gain2' */
  real_T Sum3_n;                       /* '<S31>/Sum3' */
  real_T Gain3_f;                      /* '<S31>/Gain3' */
  real_T diancifa11_1_d;               /* '<S25>/Chart' */
  real_T diancifa11_2_b;               /* '<S25>/Chart' */
  real_T diancifa11_5_o;               /* '<S25>/Chart' */
  real_T diancifa20_i;                 /* '<S25>/Chart' */
  real_T diancifa16_1_c;               /* '<S25>/Chart' */
  real_T diancifa3_l;                  /* '<S25>/Chart' */
  real_T diancifa21_g;                 /* '<S25>/Chart' */
  real_T suoding_k;                    /* '<S25>/Chart' */
  real_T jiesuo_g;                     /* '<S25>/Chart' */
  real_T xuansong_i;                   /* '<S25>/Chart' */
  real_T xuanjin_l;                    /* '<S25>/Chart' */
  real_T bililiuliangfa18_1_h;         /* '<S25>/Chart' */
  real_T bililiuliangfa18_2_i;         /* '<S25>/Chart' */
  real_T bililiuliangfa18_3_m;         /* '<S25>/Chart' */
  real_T bililiuliangfa18_4_b;         /* '<S25>/Chart' */
  real_T kaigaikaishi_k;               /* '<S25>/Chart' */
  real_T guangaikaishi_j;              /* '<S25>/Chart' */
  real_T SCzhushuiwancheng_f;          /* '<S25>/Chart' */
  real_T SCjiayawancheng_l;            /* '<S25>/Chart' */
  real_T SXQjunyawancheng_h;           /* '<S25>/Chart' */
  real_T SXQxieyawancheng_p;           /* '<S25>/Chart' */
  real_T SQshiyabuchangwancheng_p;     /* '<S25>/Chart' */
  real_T SQxuanjinjianyawancheng_m;    /* '<S25>/Chart' */
  real_T kaigaiwancheng_g;             /* '<S25>/Chart' */
  real_T guangaiwancheng_n;            /* '<S25>/Chart' */
  ...
  uint8_T DataTypeConversion1_p;       /* '<S17>/Data Type Conversion1' */
  uint8_T DataTypeConversion2_c;       /* '<S17>/Data Type Conversion2' */
  uint8_T DataTypeConversion3_g;       /* '<S17>/Data Type Conversion3' */
  uint8_T DataTypeConversion4_b;       /* '<S17>/Data Type Conversion4' */
  uint8_T DataTypeConversion5_i;       /* '<S17>/Data Type Conversion5' */
  uint8_T DataTypeConversion6_b;       /* '<S17>/Data Type Conversion6' */
  uint8_T DataTypeConversion7_e;       /* '<S17>/Data Type Conversion7' */
  ...
  uint8_T DataTypeConversion8_e;       /* '<S17>/Data Type Conversion8' */
  uint8_T DataTypeConversion9_b;       /* '<S17>/Data Type Conversion9' */
  uint8_T DataTypeConversion10_c;      /* '<S17>/Data Type Conversion10' */
  uint8_T DataTypeConversion11_l;      /* '<S17>/Data Type Conversion11' */
  uint8_T DataTypeConversion12_i;      /* '<S17>/Data Type Conversion12' */
  uint8_T DataTypeConversion13_m;      /* '<S17>/Data Type Conversion13' */
  uint8_T DataTypeConversion14_h;      /* '<S17>/Data Type Conversion14' */
  uint8_T DataTypeConversion15_k;      /* '<S17>/Data Type Conversion15' */
  uint8_T DataTypeConversion22_l;      /* '<S17>/Data Type Conversion22' */
  uint8_T DataTypeConversion23_c;      /* '<S17>/Data Type Conversion23' */
  uint8_T DataTypeConversion16_i;      /* '<S17>/Data Type Conversion16' */
  uint8_T DataTypeConversion17_b;      /* '<S17>/Data Type Conversion17' */
  uint8_T DataTypeConversion18_c;      /* '<S17>/Data Type Conversion18' */
  uint8_T DataTypeConversion19_m;      /* '<S17>/Data Type Conversion19' */
  uint8_T DataTypeConversion20_n;      /* '<S17>/Data Type Conversion20' */
  uint8_T DataTypeConversion21_l;      /* '<S17>/Data Type Conversion21' */
  uint8_T DataTypeConversion30_e;      /* '<S17>/Data Type Conversion30' */
  uint8_T DataTypeConversion31_d;      /* '<S17>/Data Type Conversion31' */
  uint8_T DataTypeConversion24_m;      /* '<S17>/Data Type Conversion24' */
  uint8_T DataTypeConversion25_h;      /* '<S17>/Data Type Conversion25' */
  uint8_T DataTypeConversion26_j;      /* '<S17>/Data Type Conversion26' */
  uint8_T DataTypeConversion27_i;      /* '<S17>/Data Type Conversion27' */
  uint8_T DataTypeConversion28_m;      /* '<S17>/Data Type Conversion28' */
  uint8_T DataTypeConversion29_f;      /* '<S17>/Data Type Conversion29' */
  uint8_T DataTypeConversion38;        /* '<S17>/Data Type Conversion38' */
  uint8_T DataTypeConversion39;        /* '<S17>/Data Type Conversion39' */
  uint8_T DataTypeConversion32_g;      /* '<S17>/Data Type Conversion32' */
  uint8_T DataTypeConversion33_g;      /* '<S17>/Data Type Conversion33' */
  uint8_T DataTypeConversion34_i;      /* '<S17>/Data Type Conversion34' */
  uint8_T DataTypeConversion35_a;      /* '<S17>/Data Type Conversion35' */
  ...
  boolean_T Compare_p;                 /* '<S50>/Compare' */
  boolean_T Compare_j;                 /* '<S51>/Compare' */
  boolean_T Compare_k;                 /* '<S52>/Compare' */
  boolean_T Compare_jd;                /* '<S48>/Compare' */
  ...
  boolean_T LogicalOperator1_j;        /* '<Root>/Logical Operator1' */
  ...
  boolean_T Compare_m;                 /* '<S4>/Compare' */
  ...
  boolean_T LogicalOperator3_k;        /* '<S14>/Logical Operator3' */
  boolean_T LogicalOperator2_a;        /* '<S14>/Logical Operator2' */
  boolean_T LogicalOperator_j;         /* '<S14>/Logical Operator' */
  boolean_T LogicalOperator1_e;        /* '<S14>/Logical Operator1' */
  boolean_T LogicalOperator_jg;        /* '<S5>/Logical Operator' */
  boolean_T LogicalOperator1_g;        /* '<S5>/Logical Operator1' */
  boolean_T Compare_kp;                /* '<S1>/Compare' */
  boolean_T Compare_cr;                /* '<S2>/Compare' */
  ...
  B_Chart1_aaaqi_T sf_Chart;           /* '<S20>/Chart' */
  B_Chart1_aaaqi_T sf_Chart1;          /* '<S18>/Chart1' */
  B_Subsystem4_aaaqi_T Subsystem5;     /* '<Root>/Subsystem5' */
  B_Subsystem4_aaaqi_T Subsystem4;     /* '<Root>/Subsystem4' */
} B_aaaqi_T;
...
typedef struct {
  ...
  real_T Memory_PreviousInput_d;       /* '<S22>/Memory' */
  real_T Memory1_PreviousInput_d;      /* '<S22>/Memory1' */
  real_T Memory_PreviousInput_c;       /* '<S23>/Memory' */
  real_T Memory_PreviousInput_m;       /* '<S24>/Memory' */
  real_T Memory1_PreviousInput_m;      /* '<S24>/Memory1' */
  real_T Memory1_PreviousInput_k;      /* '<S23>/Memory1' */
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWs_PWORK_e;                    /* '<S43>/FromWs' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWs_PWORK_p;                    /* '<S44>/FromWs' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWs_PWORK_j;                    /* '<S45>/FromWs' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWs_PWORK_i;                    /* '<S33>/FromWs' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWs_PWORK_jz;                   /* '<S34>/FromWs' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWs_PWORK_m;                    /* '<S35>/FromWs' */

  struct {
    void *TimePtr;
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWs_PWORK_i2;                   /* '<S36>/FromWs' */

  int32_T sfEvent;                     /* '<S19>/jinjichuli' */
  int32_T sfEvent_j;                   /* '<S26>/Chart' */
  int32_T sfEvent_l;                   /* '<S25>/Chart' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_f;                 /* '<S8>/S-Function' */
  ...
  struct {
    int_T AcquireOK;
  } SFunction_IWORK_h;                 /* '<S10>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_i5;                /* '<S11>/S-Function' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_b;                 /* '<S12>/S-Function' */
  ...
  struct {
    int_T PrevIndex;
  } FromWs_IWORK_o;                    /* '<S43>/FromWs' */

  struct {
    int_T PrevIndex;
  } FromWs_IWORK_f;                    /* '<S44>/FromWs' */

  struct {
    int_T PrevIndex;
  } FromWs_IWORK_om;                   /* '<S45>/FromWs' */

  struct {
    int_T AcquireOK;
  } SFunction_IWORK_k;                 /* '<S29>/S-Function' */

  struct {
    int_T PrevIndex;
  } FromWs_IWORK_oe;                   /* '<S33>/FromWs' */

  struct {
    int_T PrevIndex;
  } FromWs_IWORK_f0;                   /* '<S34>/FromWs' */

  struct {
    int_T PrevIndex;
  } FromWs_IWORK_l;                    /* '<S35>/FromWs' */

  struct {
    int_T PrevIndex;
  } FromWs_IWORK_d;                    /* '<S36>/FromWs' */

  uint16_T temporalCounter_i1;         /* '<S19>/jinjichuli' */
  uint16_T temporalCounter_i1_c;       /* '<S26>/Chart' */
  uint16_T temporalCounter_i1_m;       /* '<S25>/Chart' */
  ...
  uint8_T is_active_c2_aaaqi;          /* '<S19>/jinjichuli' */
  uint8_T is_c2_aaaqi;                 /* '<S19>/jinjichuli' */
  ...
  uint8_T is_active_c1_aaaqi;          /* '<S26>/Chart' */
  uint8_T is_c1_aaaqi;                 /* '<S26>/Chart' */
  ...
  uint8_T is_active_c4_aaaqi;          /* '<S25>/Chart' */
  uint8_T is_c4_aaaqi;                 /* '<S25>/Chart' */
  uint8_T is_kaiguangai_o;             /* '<S25>/Chart' */
  uint8_T is_active_kaiguangai;        /* '<S25>/Chart' */
  uint8_T is_SXQxieya_l;               /* '<S25>/Chart' */
  uint8_T is_active_SXQxieya;          /* '<S25>/Chart' */
  uint8_T is_SCjiaya_c;                /* '<S25>/Chart' */
  uint8_T is_active_SCjiaya;           /* '<S25>/Chart' */
  uint8_T is_SCzhushui_e;              /* '<S25>/Chart' */
  uint8_T is_active_SCzhushui;         /* '<S25>/Chart' */
  uint8_T is_SXQjunya_k;               /* '<S25>/Chart' */
  ...
  DW_Chart1_aaaqi_T sf_Chart;          /* '<S20>/Chart' */
  DW_Chart1_aaaqi_T sf_Chart1;         /* '<S18>/Chart1' */
  DW_Subsystem4_aaaqi_T Subsystem5;    /* '<Root>/Subsystem5' */
  DW_Subsystem4_aaaqi_T Subsystem4;    /* '<Root>/Subsystem4' */
} DW_aaaqi_T;

/* Backward compatible GRT Identifiers */
#define rtB                            aaaqi_B
#define BlockIO                        B_aaaqi_T
#define rtP                            aaaqi_P
#define Parameters                     P_aaaqi_T
#define rtDWork                        aaaqi_DW
#define D_Work                         DW_aaaqi_T

/* Parameters for system: '<Root>/Subsystem4' */
struct P_Subsystem4_aaaqi_T_ {
...
struct P_aaaqi_T_ {
  ...
  uint16_T CompareToConstant2_const;   /* Mask Parameter: CompareToConstant2_const
                                        ...
                                        */
  uint16_T CompareToConstant3_const_e; /* Mask Parameter: CompareToConstant3_const_e
  ...
  real_T Constant20_Value;             /* Expression: 0.2
                                        ...
                                        */
  real_T Constant1_Value_i;            /* Expression: -0.05
  ...
  real_T Gain_Gain;                    /* Expression: 1
                                        ...
                                        */
  real_T Constant19_Value_b;           /* Expression: 1
  ...
  real_T Constant2_Value_e;            /* Expression: 0
                                        ...
                                        */
  real_T Constant29_Value_g;           /* Expression: 10
                                        * Referenced by: '<S32>/Constant29'
                                        */
  real_T Constant28_Value_h;           /* Expression: 6
                                        * Referenced by: '<S32>/Constant28'
                                        */
  real_T Constant27_Value_p;           /* Expression: 4
                                        * Referenced by: '<S32>/Constant27'
                                        */
  real_T Constant26_Value_l;           /* Expression: 3
                                        * Referenced by: '<S32>/Constant26'
                                        */
  real_T Constant25_Value_n;           /* Expression: 2
                                        * Referenced by: '<S32>/Constant25'
                                        */
  real_T Constant24_Value_m;           /* Expression: 1.5
                                        * Referenced by: '<S32>/Constant24'
                                        */
  real_T Constant23_Value_g;           /* Expression: 1
                                        * Referenced by: '<S32>/Constant23'
                                        */
  real_T Constant22_Value_d;           /* Expression: 0.6
                                        * Referenced by: '<S32>/Constant22'
                                        */
  real_T Constant21_Value_l;           /* Expression: 0.4
                                        * Referenced by: '<S32>/Constant21'
                                        */
  real_T Constant20_Value_j;           /* Expression: 0.2
  ...
  real_T Switch9_Threshold;            /* Expression: 0.12
                                        ...
                                        */
  real_T Gain1_Gain_k;                 /* Expression: 0.15
                                        * Referenced by: '<S30>/Gain1'
                                        */
  real_T Gain_Gain_p;                  /* Expression: 0.15
  ...
  real_T Switch2_Threshold_a;          /* Expression: 0.26
                                        ...
                                        */
  real_T Switch3_Threshold_b;          /* Expression: 0.24
                                        * Referenced by: '<S32>/Switch3'
                                        */
  real_T Switch4_Threshold_e;          /* Expression: 0.22
                                        * Referenced by: '<S32>/Switch4'
                                        */
  real_T Switch5_Threshold_b;          /* Expression: 0.20
                                        * Referenced by: '<S32>/Switch5'
                                        */
  real_T Switch6_Threshold_h;          /* Expression: 0.18
                                        * Referenced by: '<S32>/Switch6'
                                        */
  real_T Switch7_Threshold_j;          /* Expression: 0.16
                                        * Referenced by: '<S32>/Switch7'
                                        */
  real_T Switch8_Threshold_k;          /* Expression: 0.14
                                        * Referenced by: '<S32>/Switch8'
                                        */
  real_T Switch9_Threshold_c;          /* Expression: 0.12
  ...
  real_T Constant2_Value_b;            /* Expression: 0
                                        ...
                                        */
  real_T Constant19_Value_i;           /* Expression: 1
                                        * Referenced by: '<S38>/Constant19'
                                        */
  real_T Constant18_Value_dz;          /* Expression: 0
                                        * Referenced by: '<S38>/Constant18'
                                        */
  real_T Constant17_Value_k;           /* Expression: 1
                                        * Referenced by: '<S38>/Constant17'
                                        */
  real_T Constant16_Value_b;           /* Expression: 0
                                        * Referenced by: '<S38>/Constant16'
                                        */
  real_T Constant15_Value_n;           /* Expression: 1
  ...
  real_T Constant12_Value_o;           /* Expression: 0
                                        ...
                                        */
  real_T Constant11_Value_gt;          /* Expression: 1
  ...
  real_T Constant8_Value_p;            /* Expression: 0
                                        ...
                                        */
  real_T Constant7_Value_c;            /* Expression: 1
  ...
  real_T Constant4_Value_f;            /* Expression: 0
                                        ...
                                        */
  real_T Constant3_Value_e0;           /* Expression: 1
                                        * Referenced by: '<S38>/Constant3'
                                        */
  real_T Constant2_Value_p;            /* Expression: 0
                                        * Referenced by: '<S38>/Constant2'
                                        */
  real_T Constant29_Value_a;           /* Expression: 10
                                        * Referenced by: '<S38>/Constant29'
                                        */
  real_T Constant28_Value_c;           /* Expression: 6
                                        * Referenced by: '<S38>/Constant28'
                                        */
  real_T Constant27_Value_f;           /* Expression: 4
                                        * Referenced by: '<S38>/Constant27'
                                        */
  real_T Constant26_Value_f;           /* Expression: 3
                                        * Referenced by: '<S38>/Constant26'
                                        */
  real_T Constant25_Value_h;           /* Expression: 2
                                        * Referenced by: '<S38>/Constant25'
                                        */
  real_T Constant24_Value_d;           /* Expression: 1.5
                                        * Referenced by: '<S38>/Constant24'
                                        */
  real_T Constant23_Value_j;           /* Expression: 1
                                        * Referenced by: '<S38>/Constant23'
                                        */
  real_T Constant22_Value_m;           /* Expression: 0.6
                                        * Referenced by: '<S38>/Constant22'
                                        */
  real_T Constant21_Value_h;           /* Expression: 0.4
                                        * Referenced by: '<S38>/Constant21'
                                        */
  real_T Constant20_Value_jg;          /* Expression: 0.2
                                        * Referenced by: '<S38>/Constant20'
                                        */
  real_T Constant1_Value_d;            /* Expression: -0.05
  ...
  real_T Constant18_Value_g;           /* Expression: 0
                                        ...
                                        */
  real_T Constant17_Value_n;           /* Expression: 1
                                        * Referenced by: '<S41>/Constant17'
                                        */
  real_T Constant16_Value_f;           /* Expression: 0
                                        * Referenced by: '<S41>/Constant16'
                                        */
  real_T Constant15_Value_n5;          /* Expression: 1
                                        * Referenced by: '<S41>/Constant15'
                                        */
  real_T Constant14_Value_l;           /* Expression: 0
                                        * Referenced by: '<S41>/Constant14'
                                        */
  real_T Constant13_Value_j;           /* Expression: 1
                                        * Referenced by: '<S41>/Constant13'
                                        */
  real_T Constant12_Value_o5;          /* Expression: 0
                                        * Referenced by: '<S41>/Constant12'
                                        */
  real_T Constant11_Value_g2;          /* Expression: 1
  ...
  real_T Constant8_Value_a;            /* Expression: 0
                                        ...
                                        */
  real_T Constant7_Value_i;            /* Expression: 1
  ...
  real_T Constant3_Value_h;            /* Expression: 1
                                        ...
                                        */
  real_T Constant2_Value_lm;           /* Expression: 0
                                        * Referenced by: '<S41>/Constant2'
                                        */
  real_T Constant29_Value_e;           /* Expression: 10
                                        * Referenced by: '<S41>/Constant29'
                                        */
  real_T Constant28_Value_o;           /* Expression: 6
                                        * Referenced by: '<S41>/Constant28'
                                        */
  real_T Constant27_Value_i;           /* Expression: 4
                                        * Referenced by: '<S41>/Constant27'
                                        */
  real_T Constant26_Value_m;           /* Expression: 3
                                        * Referenced by: '<S41>/Constant26'
                                        */
  real_T Constant25_Value_c;           /* Expression: 2
                                        * Referenced by: '<S41>/Constant25'
                                        */
  real_T Constant24_Value_j;           /* Expression: 1.5
                                        * Referenced by: '<S41>/Constant24'
                                        */
  real_T Constant23_Value_n;           /* Expression: 1
                                        * Referenced by: '<S41>/Constant23'
                                        */
  real_T Constant22_Value_l;           /* Expression: 0.6
                                        * Referenced by: '<S41>/Constant22'
                                        */
  real_T Constant21_Value_ly;          /* Expression: 0.4
                                        * Referenced by: '<S41>/Constant21'
                                        */
  real_T Constant20_Value_o;           /* Expression: 0.2
                                        * Referenced by: '<S41>/Constant20'
                                        */
  real_T bililiuliangfa18_1_Y0_e;      /* Computed Parameter: bililiuliangfa18_1_Y0_e
                                        * Referenced by: '<S26>/bililiuliangfa18_1'
                                        */
  real_T bililiuliangfa18_2_Y0_j;      /* Computed Parameter: bililiuliangfa18_2_Y0_j
                                        * Referenced by: '<S26>/bililiuliangfa18_2'
                                        */
  real_T bililiuliangfa18_3_Y0_d;      /* Computed Parameter: bililiuliangfa18_3_Y0_d
  ...
  real_T bililiuliangfa18_4_Y0_j;      /* Computed Parameter: bililiuliangfa18_4_Y0_j
                                        ...
                                        */
  real_T kaiguangaifa_Y0_i;            /* Computed Parameter: kaiguangaifa_Y0_i
                                        * Referenced by: '<S26>/kaiguangaifa'
                                        */
  real_T Constant1_Value_e;            /* Expression: 1
                                        * Referenced by: '<S38>/Constant1'
                                        */
  real_T Switch1_Threshold_od;         /* Expression: 0.28
                                        * Referenced by: '<S38>/Switch1'
                                        */
  real_T Switch2_Threshold_j;          /* Expression: 0.26
                                        * Referenced by: '<S38>/Switch2'
                                        */
  real_T Switch3_Threshold_o;          /* Expression: 0.24
                                        * Referenced by: '<S38>/Switch3'
                                        */
  real_T Switch4_Threshold_h;          /* Expression: 0.22
                                        * Referenced by: '<S38>/Switch4'
                                        */
  real_T Switch5_Threshold_e;          /* Expression: 0.20
                                        * Referenced by: '<S38>/Switch5'
                                        */
  real_T Switch6_Threshold_a;          /* Expression: 0.18
                                        * Referenced by: '<S38>/Switch6'
                                        */
  real_T Switch7_Threshold_m;          /* Expression: 0.16
                                        * Referenced by: '<S38>/Switch7'
                                        */
  real_T Switch8_Threshold_f;          /* Expression: 0.14
                                        * Referenced by: '<S38>/Switch8'
                                        */
  real_T Switch9_Threshold_o;          /* Expression: 0.12
                                        * Referenced by: '<S38>/Switch9'
                                        */
  real_T Gain_Gain_j;                  /* Expression: 0.8
                                        * Referenced by: '<S38>/Gain'
                                        */
  real_T Gain1_Gain_o;                 /* Expression: 0.8
                                        * Referenced by: '<S38>/Gain1'
                                        */
  real_T Gain1_Gain_ol;                /* Expression: 0.15
                                        * Referenced by: '<S39>/Gain1'
                                        */
  real_T Gain_Gain_n;                  /* Expression: 0.15
  ...
  real_T Constant1_Value_k;            /* Expression: 1
                                        ...
                                        */
  real_T Switch1_Threshold_k;          /* Expression: 0.28
                                        * Referenced by: '<S41>/Switch1'
                                        */
  real_T Switch2_Threshold_b;          /* Expression: 0.26
                                        * Referenced by: '<S41>/Switch2'
                                        */
  real_T Switch3_Threshold_i;          /* Expression: 0.24
                                        * Referenced by: '<S41>/Switch3'
                                        */
  real_T Switch4_Threshold_f;          /* Expression: 0.22
                                        * Referenced by: '<S41>/Switch4'
                                        */
  real_T Switch5_Threshold_n;          /* Expression: 0.20
                                        * Referenced by: '<S41>/Switch5'
                                        */
  real_T Switch6_Threshold_g;          /* Expression: 0.18
                                        * Referenced by: '<S41>/Switch6'
                                        */
  real_T Switch7_Threshold_b;          /* Expression: 0.16
                                        * Referenced by: '<S41>/Switch7'
                                        */
  real_T Switch8_Threshold_g;          /* Expression: 0.14
                                        * Referenced by: '<S41>/Switch8'
                                        */
  real_T Switch9_Threshold_a;          /* Expression: 0.12
                                        * Referenced by: '<S41>/Switch9'
                                        */
  real_T Constant_Value_na;            /* Expression: 2
  ...
  real_T SXQxieya_Value;               /* Expression: 0
                                        ...
                                        */
  real_T _Value;                       /* Expression: 0.33
                                        * Referenced by: '<Root>/水舱最大压力'
                                        */
  real_T _Value_k;                     /* Expression: 0.03
                                        * Referenced by: '<Root>/凸膜上下腔最小压力'
                                        */
  real_T _Value_g;                     /* Expression: 0.33
  ...
  real_T Memory1_X0;                   /* Expression: 0
                                        ...
                                        */
  real_T Saturation_UpperSat_p;        /* Expression: 12
                                        * Referenced by: '<S18>/Saturation'
                                        */
  real_T Saturation_LowerSat_e;        /* Expression: 0
                                        * Referenced by: '<S18>/Saturation'
                                        */
  real_T Saturation1_UpperSat_l;       /* Expression: 600
                                        * Referenced by: '<S18>/Saturation1'
                                        */
  real_T Saturation1_LowerSat_m;       /* Expression: 20
                                        * Referenced by: '<S18>/Saturation1'
                                        */
  ...
  real_T Switch2_Threshold_f;          /* Expression: 0.5
                                        ...
                                        */
  real_T Switch3_Threshold_b4;         /* Expression: 0.5
                                        * Referenced by: '<S13>/Switch3'
                                        */
  real_T Switch4_Threshold_a;          /* Expression: 0.5
                                        * Referenced by: '<S13>/Switch4'
                                        */
  real_T Switch5_Threshold_j;          /* Expression: 0.5
                                        * Referenced by: '<S13>/Switch5'
                                        */
  real_T Switch6_Threshold_k;          /* Expression: 0.5
                                        * Referenced by: '<S13>/Switch6'
                                        */
  real_T Switch7_Threshold_e;          /* Expression: 0.5
                                        * Referenced by: '<S13>/Switch7'
                                        */
  real_T Switch8_Threshold_p;          /* Expression: 0.5
  ...
  real_T Switch18_Threshold;           /* Expression: 0.5
                                        ...
                                        */
  real_T uDLookupTable_tableData_h[2]; /* Expression: [0 115]
                                        * Referenced by: '<Root>/1-D Lookup Table'
                                        */
  real_T uDLookupTable_bp01Data_n[2];  /* Expression: [0 600]
                                        * Referenced by: '<Root>/1-D Lookup Table'
                                        */
  real_T Gain_Gain_f;                  /* Expression: 1
                                        * Referenced by: '<Root>/Gain'
                                        */
  real_T Saturation_UpperSat_m;        /* Expression: 10
  ...
  real_T Memory2_X0;                   /* Expression: 0
                                        ...
                                        */
  real_T Constant_Value_o;             /* Expression: 43
                                        * Referenced by: '<S17>/Constant'
                                        */
  real_T Constant1_Value_jd;           /* Expression: 3
                                        * Referenced by: '<S17>/Constant1'
                                        */
  real_T Constant2_Value_a4;           /* Expression: 32
                                        * Referenced by: '<S17>/Constant2'
                                        */
  real_T Constant3_Value_d;            /* Expression: 1
                                        * Referenced by: '<S17>/Constant3'
                                        */
  real_T Constant4_Value_d;            /* Expression: 255
                                        * Referenced by: '<S17>/Constant4'
                                        */
  real_T Constant5_Value_l;            /* Expression: 255
                                        * Referenced by: '<S17>/Constant5'
                                        */
  real_T Constant6_Value_j;            /* Expression: 255
                                        * Referenced by: '<S17>/Constant6'
                                        */
  real_T Constant7_Value_d;            /* Expression: 255
  ...
  uint8_T ManualSwitch3_CurrentSetting;/* Computed Parameter: ManualSwitch3_CurrentSetting
                                        ...
                                        */
  P_Subsystem4_aaaqi_T Subsystem5;     /* '<Root>/Subsystem5' */
  P_Subsystem4_aaaqi_T Subsystem4;     /* '<Root>/Subsystem4' */
};

/* Real-time Model Data Structure */
struct tag_RTM_aaaqi_T {
  const char_T *path;
...
extern P_aaaqi_T aaaqi_P;

/* Block signals (auto storage) */
extern B_aaaqi_T aaaqi_B;

/* Block states (auto storage) */
extern DW_aaaqi_T aaaqi_DW;

/* External data declarations for dependent source files */
extern const real_T aaaqi_RGND;        /* real_T ground */

/*====================*
 * External functions *
 *====================*/
extern aaaqi_rtModel *aaaqi(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  aaaqi_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_aaaqi_T *const aaaqi_M;
 ...
 *
 * '<Root>' : 'aaaqi'
 * '<S1>'   : 'aaaqi/Compare To Constant'
 * '<S2>'   : 'aaaqi/Compare To Constant1'
 * '<S3>'   : 'aaaqi/Compare To Constant2'
 * '<S4>'   : 'aaaqi/Compare To Constant3'
 * '<S5>'   : 'aaaqi/PCI1716'
 * '<S6>'   : 'aaaqi/PCI6208'
 * '<S7>'   : 'aaaqi/Scope (xPC) 1'
 * '<S8>'   : 'aaaqi/Scope (xPC) 2'
 * '<S9>'   : 'aaaqi/Scope (xPC) 3'
 * '<S10>'  : 'aaaqi/Scope (xPC) 4'
 * '<S11>'  : 'aaaqi/Scope (xPC) 5'
 * '<S12>'  : 'aaaqi/Scope (xPC) 6'
 * '<S13>'  : 'aaaqi/Subsystem1'
 * '<S14>'  : 'aaaqi/Subsystem2'
 * '<S15>'  : 'aaaqi/Subsystem4'
 * '<S16>'  : 'aaaqi/Subsystem5'
 * '<S17>'  : 'aaaqi/chuanganqi'
 * '<S18>'  : 'aaaqi/guangaiquxian'
 * '<S19>'  : 'aaaqi/jinjichuli'
 * '<S20>'  : 'aaaqi/kaigaiquxian'
 * '<S21>'  : 'aaaqi/tiaoshifa'
 * '<S22>'  : 'aaaqi/Subsystem2/husuo'
 * '<S23>'  : 'aaaqi/Subsystem2/husuo1'
 * '<S24>'  : 'aaaqi/Subsystem2/husuo2'
 * '<S25>'  : 'aaaqi/Subsystem2/shoudong'
 * '<S26>'  : 'aaaqi/Subsystem2/zidong'
 * '<S27>'  : 'aaaqi/Subsystem2/shoudong/Chart'
 * '<S28>'  : 'aaaqi/Subsystem2/shoudong/SQfa'
 * '<S29>'  : 'aaaqi/Subsystem2/shoudong/Scope (xPC) 1'
 * '<S30>'  : 'aaaqi/Subsystem2/shoudong/Subsystem'
 * '<S31>'  : 'aaaqi/Subsystem2/shoudong/Subsystem2'
 * '<S32>'  : 'aaaqi/Subsystem2/shoudong/XQfa'
 * '<S33>'  : 'aaaqi/Subsystem2/shoudong/Subsystem2/Signal Builder'
 * '<S34>'  : 'aaaqi/Subsystem2/shoudong/Subsystem2/Signal Builder1'
 * '<S35>'  : 'aaaqi/Subsystem2/shoudong/Subsystem2/Signal Builder2'
 * '<S36>'  : 'aaaqi/Subsystem2/shoudong/Subsystem2/Signal Builder3'
 * '<S37>'  : 'aaaqi/Subsystem2/zidong/Chart'
 * '<S38>'  : 'aaaqi/Subsystem2/zidong/SQfa'
 * '<S39>'  : 'aaaqi/Subsystem2/zidong/Subsystem'
 * '<S40>'  : 'aaaqi/Subsystem2/zidong/Subsystem1'
 * '<S41>'  : 'aaaqi/Subsystem2/zidong/XQfa'
 * '<S42>'  : 'aaaqi/Subsystem2/zidong/Subsystem1/Signal Builder'
 * '<S43>'  : 'aaaqi/Subsystem2/zidong/Subsystem1/Signal Builder1'
 * '<S44>'  : 'aaaqi/Subsystem2/zidong/Subsystem1/Signal Builder2'
 * '<S45>'  : 'aaaqi/Subsystem2/zidong/Subsystem1/Signal Builder3'
 * '<S46>'  : 'aaaqi/chuanganqi/yalishangxiaxian'
 * '<S47>'  : 'aaaqi/chuanganqi/yalishangxiaxian/Compare To Constant1'
 * '<S48>'  : 'aaaqi/chuanganqi/yalishangxiaxian/Compare To Constant11'
 * '<S49>'  : 'aaaqi/chuanganqi/yalishangxiaxian/Compare To Constant3'
 * '<S50>'  : 'aaaqi/chuanganqi/yalishangxiaxian/Compare To Constant5'
 * '<S51>'  : 'aaaqi/chuanganqi/yalishangxiaxian/Compare To Constant7'
 * '<S52>'  : 'aaaqi/chuanganqi/yalishangxiaxian/Compare To Constant9'
 * '<S53>'  : 'aaaqi/guangaiquxian/Chart1'
 * '<S54>'  : 'aaaqi/jinjichuli/jinjichuli'
 * '<S55>'  : 'aaaqi/kaigaiquxian/Chart'
 */
#endif                                 /* RTW_HEADER_aaaqi_h_ */
