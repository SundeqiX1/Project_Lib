...
MODEL           = aaaqi
MODULES         = aaaqi_capi.c aaaqi_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = aaaqi.mk
...
S_FUNCTIONS     = adpci_1784.c canac2pcisetupx.c da6208.c pci1716DIO.c canac2globalsx.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 0
...
MODELLIB                  = aaaqilib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = aaaqi_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\aaaqi_slrt_rtw
