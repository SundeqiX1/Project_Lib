...
MODEL           = ceshi20210224_17
MODULES         = ceshi20210224_17_capi.c ceshi20210224_17_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_look.c rt_look1d.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = ceshi20210224_17.mk
MATLAB_ROOT     = D:\MATLAB2016b\matlab2016b
ALT_MATLAB_ROOT = D:\MATLAB~3\MATLAB~2
MATLAB_BIN      = D:\MATLAB2016b\matlab2016b\bin
ALT_MATLAB_BIN  = D:\MATLAB~3\MATLAB~2\bin
MASTER_ANCHOR_DIR = 
START_DIR       = D:\Users\Administrator\Desktop\พ๙ัน2
S_FUNCTIONS     = canac2pcisetupx.c da6208.c pci1716DIO.c canac2globalsx.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 9
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "D:\MATLAB2016b\matlab2016b\bin\win64\mexopts\msvc2015.xml"
...
MODELLIB                  = ceshi20210224_17lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ceshi20210224_17_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\ceshi20210224_17_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\Users\Administrator\Desktop\811
...
LIBS = $(LIBS) $(MATLAB_ROOT)\toolbox\rtw\targets\xpc\target\build\xpcblocks\lib\xpccanac2pci_vc.lib
!else
LIBS = $(LIBS) xpccanac2pci.lib
!endif 
...
MODULES_xpccanac2pci = \
	dummy.obj \


xpccanac2pci.lib : rtw_proj.tmw $(MAKEFILE) $(MODULES_xpccanac2pci)
	@cmd /C "echo ### Creating $@"
	$(LIBCMD) /nologo /out:$@ $(MODULES_xpccanac2pci)
	@cmd /C "echo ### Created $@"
