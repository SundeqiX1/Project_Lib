...
MODEL           = untitled20210804
MODULES         = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c untitled20210804_capi.c untitled20210804_data.c xpc_datatype_ground.c 
MAKEFILE        = untitled20210804.mk
MATLAB_ROOT     = D:\Program Files\MATLAB\R2016b
ALT_MATLAB_ROOT = D:\Program Files\MATLAB\R2016b
MATLAB_BIN      = D:\Program Files\MATLAB\R2016b\bin
ALT_MATLAB_BIN  = D:\Program Files\MATLAB\R2016b\bin
MASTER_ANCHOR_DIR = 
START_DIR       = D:\相关文件\均压
S_FUNCTIONS     = canac2pcisetupx.c canac2globalsx.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
BUILDARGS       = MATLAB_ROOT=%MATLAB_ROOT% ALT_MATLAB_ROOT=%ALT_MATLAB_ROOT% MATLAB_BIN=%MATLAB_BIN% ALT_MATLAB_BIN=%ALT_MATLAB_BIN%  EXT_MODE=1 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Users\zczg\AppData\Roaming\MathWorks\MATLAB\R2016b\mex_C_win64.xml"
...
MODELLIB                  = untitled20210804lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = untitled20210804_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\untitled20210804_slrt_rtw
