...
MODEL           = a210514
MODULES         = a210514_capi.c a210514_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_nonfinite.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = a210514.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = D:\Users\Administrator\Desktop\均压2
S_FUNCTIONS     = 
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
...
MODELLIB                  = a210514lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = a210514_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\a210514_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\Users\Administrator\Desktop\新建文件夹
