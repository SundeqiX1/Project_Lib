...
MODEL           = Copy_of_canceshi1
MODULES         = Copy_of_canceshi1_capi.c Copy_of_canceshi1_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c canac2globals.c 
MAKEFILE        = Copy_of_canceshi1.mk
...
MODELLIB                  = Copy_of_canceshi1lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Copy_of_canceshi1_xpc_rtw
