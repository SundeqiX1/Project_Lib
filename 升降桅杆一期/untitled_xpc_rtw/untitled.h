...
#define untitled_rtModel               rtModel_untitled
...
#define BlockIO                        BlockIO_untitled
#define rtXdot                         untitled_Xdot
#define StateDerivatives               StateDerivatives_untitled
#define tXdis                          untitled_Xdis
#define StateDisabled                  StateDisabled_untitled
#define rtP                            untitled_P
#define Parameters                     Parameters_untitled
...
extern struct rtModel_untitled *untitled_rtM;
