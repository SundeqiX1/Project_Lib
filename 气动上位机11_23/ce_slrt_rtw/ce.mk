...
MODEL           = ce
MODULES         = ce_capi.c ce_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_look.c rt_look1d.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = ce.mk
MATLAB_ROOT     = D:\Program Files\MATLAB\R2016b
ALT_MATLAB_ROOT = D:\PROGRA~2\MATLAB\R2016b
MATLAB_BIN      = D:\Program Files\MATLAB\R2016b\bin
ALT_MATLAB_BIN  = D:\PROGRA~2\MATLAB\R2016b\bin
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\Administrator\Desktop\气动上位机11_13\气动上位机11_23
S_FUNCTIONS     = da6208.c pci1716.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 81
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "D:\Program Files\MATLAB\R2016b\bin\win64\mexopts\msvc2012.xml"
...
MODELLIB                  = celib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ce_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\ce_slrt_rtw
