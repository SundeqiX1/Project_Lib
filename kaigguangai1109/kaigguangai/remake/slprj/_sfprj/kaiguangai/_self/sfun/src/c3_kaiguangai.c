...
static void initialize_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void disable_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct
  *chartInstance);
static void ext_mode_exec_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct *
  chartInstance);
static void set_sim_state_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void c3_set_sim_state_side_effects_c3_kaiguangai
  (SFc3_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void sf_gateway_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void initSimStructsc3_kaiguangai(SFc3_kaiguangaiInstanceStruct
  *chartInstance);
static void c3_zidong(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_enter_atomic_chushihua(SFc3_kaiguangaiInstanceStruct
  *chartInstance);
static void c3_songkaishijian(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_start(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on10(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_songkaishijian1(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_yanchishijian1(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_tguiling(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_enter_atomic_on2(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on2(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_kaigaishijian(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_songkaishijian2(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on11(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_yanchishijian2(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_t2guiling(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_enter_atomic_on3(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on3(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_suodingshijian(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on7(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_songkaishijian3(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on12(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_yanchishijian3(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_t4guiling(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_enter_atomic_off(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on4(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_jiesuoshijian(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_songkaishijian4(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on14(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_yanchishijian4(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_t6guiling(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_enter_atomic_on5(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on5(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_guangaishijian(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_songkaishijian5(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on16(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_yanchishijian5(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_t8guiling(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_yanchishijian6(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_t10guiling(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_enter_atomic_on6(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on6(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_yajinshijian(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_songkaishijian6(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void c3_on18(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c3_nargout, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static boolean_T c3_c_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c3_b_is_zidong, const char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint16_T c3_g_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c3_b_temporalCounter_i1, const char_T
  *c3_identifier);
static uint16_T c3_h_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_i_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c3_b_dataWrittenToVector, const char_T *c3_identifier,
  boolean_T c3_y[27]);
static void c3_j_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, boolean_T c3_y[27]);
static const mxArray *c3_k_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c3_b_setSimStateSideEffectsInfo, const char_T
  *c3_identifier);
static const mxArray *c3_l_emlrt_marshallIn(SFc3_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc3_kaiguangaiInstanceStruct
  *chartInstance, int32_T c3_ssid);
static void c3_init_sf_message_store_memory(SFc3_kaiguangaiInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc3_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc3_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc3_kaiguangai(chartInstance);
  ...
  *chartInstance->c3_temporalCounter_i1 = 0U;
  *chartInstance->c3_temporalCounter_i1 = 0U;
  *chartInstance->c3_is_active_c3_kaiguangai = 0U;
  *chartInstance->c3_is_c3_kaiguangai = c3_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c3_is_active_c3_kaiguangai == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 2U, *chartInstance->c3_sfEvent);
  }

  if (*chartInstance->c3_is_c3_kaiguangai == c3_IN_zidong) {
...
static void ext_mode_exec_c3_kaiguangai(SFc3_kaiguangaiInstanceStruct
  *chartInstance)
{
  c3_update_debugger_state_c3_kaiguangai(chartInstance);
}
  ...
  chartInstance)
{
  ...
  c3_cb_hoistedGlobal = *chartInstance->c3_is_active_c3_kaiguangai;
  c3_db_y = NULL;
  sf_mex_assign(&c3_db_y, sf_mex_create("y", &c3_cb_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c3_y, 27, c3_db_y);
  c3_db_hoistedGlobal = *chartInstance->c3_is_c3_kaiguangai;
  c3_eb_y = NULL;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *chartInstance->c3_is_active_c3_kaiguangai = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c3_kaiguangai", c3_u,
       27)), "is_active_c3_kaiguangai");
  *chartInstance->c3_is_c3_kaiguangai = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c3_kaiguangai", c3_u, 28)), "is_c3_kaiguangai");
  ...
  *chartInstance)
{
  ...
  c3_set_sim_state_side_effects_c3_kaiguangai(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc3_kaiguangaiInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c3_is_c3_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c3_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c3_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c3_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c3_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_kaiguangai(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[373],T\"yjyichang\",},{M[3],M[59],T\"t\",},{M[3],M[344],T\"t10\",},{M[3],M[74],T\"t2\",},{M[3],M[104],T\"t4\",},{M[3],M[124],T\"t6\",},{M[3],M[168],T\"t8\",},{M[8],M[0],T\"is_active_c3_kaiguangai\",},{M[9],M[0],T\"is_c3_kaiguangai\",},{M[9],M[374],T\"is_zidong\",}}",
  ...
  sf_c3_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc3_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_kaiguangaiInstanceStruct *chartInstance =
      (SFc3_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c3_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc3_kaiguangaiInstanceStruct*) chartInstanceVar
    )->S);
  chart_debug_initialization(((SFc3_kaiguangaiInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c3_kaiguangai((SFc3_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c3_kaiguangai((SFc3_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_kaiguangai(void *chartInstanceVar)
{
  enable_c3_kaiguangai((SFc3_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_kaiguangai(void *chartInstanceVar)
{
  disable_c3_kaiguangai((SFc3_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c3_kaiguangai((SFc3_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c3_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c3_kaiguangai((SFc3_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_kaiguangai(SimStruct* S)
{
  return get_sim_state_c3_kaiguangai((SFc3_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c3_kaiguangai((SFc3_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c3_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c3_kaiguangai((SFc3_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_kaiguangai((SFc3_kaiguangaiInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c3_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c3_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c3_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_kaiguangai(SimStruct *S)
{
  SFc3_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc3_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc3_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc3_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c3_kaiguangai;
  ...
  mdl_start_c3_kaiguangai(chartInstance);
}

void c3_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_kaiguangai_method_dispatcher.\n"
