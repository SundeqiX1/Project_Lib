...
static void initialize_c20_kaiguangai(SFc20_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c20_kaiguangai(SFc20_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c20_kaiguangai(SFc20_kaiguangaiInstanceStruct *chartInstance);
static void disable_c20_kaiguangai(SFc20_kaiguangaiInstanceStruct *chartInstance);
static void c20_update_debugger_state_c20_kaiguangai
  (SFc20_kaiguangaiInstanceStruct *chartInstance);
static void ext_mode_exec_c20_kaiguangai(SFc20_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c20_kaiguangai
  (SFc20_kaiguangaiInstanceStruct *chartInstance);
static void set_sim_state_c20_kaiguangai(SFc20_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c20_st);
static void c20_set_sim_state_side_effects_c20_kaiguangai
  (SFc20_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c20_kaiguangai(SFc20_kaiguangaiInstanceStruct
  *chartInstance);
static void sf_gateway_c20_kaiguangai(SFc20_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c20_kaiguangai(SFc20_kaiguangaiInstanceStruct
  *chartInstance);
static void initSimStructsc20_kaiguangai(SFc20_kaiguangaiInstanceStruct
  *chartInstance);
static void c20_MANUAL(SFc20_kaiguangaiInstanceStruct *chartInstance);
static void c20_exit_internal_MANUAL(SFc20_kaiguangaiInstanceStruct
  *chartInstance);
...
static const mxArray *c20_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static int32_T c20_emlrt_marshallIn(SFc20_kaiguangaiInstanceStruct
...
static const mxArray *c20_b_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static uint8_T c20_b_emlrt_marshallIn(SFc20_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c20_b_is_kaigai, const char_T *c20_identifier);
static uint8_T c20_c_emlrt_marshallIn(SFc20_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
...
static const mxArray *c20_c_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static real_T c20_d_emlrt_marshallIn(SFc20_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c20_b_skhx, const char_T *c20_identifier);
static real_T c20_e_emlrt_marshallIn(SFc20_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void c20_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData);
static uint16_T c20_f_emlrt_marshallIn(SFc20_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c20_b_temporalCounter_i1, const char_T
  *c20_identifier);
static uint16_T c20_g_emlrt_marshallIn(SFc20_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static const mxArray *c20_h_emlrt_marshallIn(SFc20_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c20_b_setSimStateSideEffectsInfo, const char_T *
  c20_identifier);
static const mxArray *c20_i_emlrt_marshallIn(SFc20_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc20_kaiguangaiInstanceStruct
  *chartInstance, int32_T c20_ssid);
static void c20_init_sf_message_store_memory(SFc20_kaiguangaiInstanceStruct
  *chartInstance);
static uint16_T c20__u16_s32_(SFc20_kaiguangaiInstanceStruct *chartInstance,
  int32_T c20_b, uint32_T c20_ssid_src_loc, int32_T c20_offset_src_loc, int32_T
  c20_length_src_loc);
static void init_dsm_address_info(SFc20_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc20_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc20_kaiguangai(chartInstance);
  ...
  *chartInstance->c20_is_active_c20_kaiguangai = 0U;
  *chartInstance->c20_is_c20_kaiguangai = c20_IN_NO_ACTIVE_CHILD;
  ...
  (SFc20_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c20_is_active_c20_kaiguangai == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 19U, *chartInstance->c20_sfEvent);
  }

  if (*chartInstance->c20_is_c20_kaiguangai == c20_IN_MANUAL) {
...
static void ext_mode_exec_c20_kaiguangai(SFc20_kaiguangaiInstanceStruct
  *chartInstance)
{
  c20_update_debugger_state_c20_kaiguangai(chartInstance);
}
  ...
  (SFc20_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  c20_e_hoistedGlobal = *chartInstance->c20_is_active_c20_kaiguangai;
  c20_f_y = NULL;
  ...
  c20_l_hoistedGlobal = *chartInstance->c20_is_c20_kaiguangai;
  c20_m_y = NULL;
  ...
  *chartInstance, const mxArray *c20_st)
{
  ...
  *chartInstance->c20_is_active_c20_kaiguangai = c20_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c20_kaiguangai", c20_u,
       4)), "is_active_c20_kaiguangai");
  ...
  *chartInstance->c20_is_active_jiesuo = c20_b_emlrt_marshallIn(chartInstance,
    ...
    "is_active_jiesuo");
  *chartInstance->c20_is_c20_kaiguangai = c20_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c20_kaiguangai", c20_u, 11)),
    "is_c20_kaiguangai");
  ...
  (SFc20_kaiguangaiInstanceStruct *chartInstance)
{
  if (chartInstance->c20_doSetSimStateSideEffects != 0) {
    if ((*chartInstance->c20_is_c20_kaiguangai == c20_IN_on1) && (sf_mex_sub
  ...
  *chartInstance)
{
  ...
  boolean_T c20_temp;
  boolean_T c20_b_out;
  c20_set_sim_state_side_effects_c20_kaiguangai(chartInstance);
  ...
  *chartInstance->c20_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c20_is_active_c20_kaiguangai == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 19U,
                 *chartInstance->c20_sfEvent);
    *chartInstance->c20_is_active_c20_kaiguangai = 1U;
    ...
    *chartInstance->c20_is_c20_kaiguangai = c20_IN_off1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 20U, *chartInstance->c20_sfEvent);
  } else {
    switch (*chartInstance->c20_is_c20_kaiguangai) {
     case c20_IN_MANUAL:
     ...
     case c20_IN_off1:
      ...
      if (c20_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 20U, *chartInstance->c20_sfEvent);
        *chartInstance->c20_is_c20_kaiguangai = c20_IN_on1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 21U, *chartInstance->c20_sfEvent);
        *chartInstance->c20_temporalCounter_i1 = 0U;
        *chartInstance->c20_skhx = 0.0;
     ...
     case c20_IN_on1:
      ...
      if (c20_b_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 21U, *chartInstance->c20_sfEvent);
        *chartInstance->c20_is_c20_kaiguangai = c20_IN_MANUAL;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c20_sfEvent);
...
static void c20_MANUAL(SFc20_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (c20_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c20_sfEvent);
    *chartInstance->c20_is_c20_kaiguangai = c20_IN_end;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 19U, *chartInstance->c20_sfEvent);
    *chartInstance->c20_skhx = 0.0;
...
const mxArray *sf_c20_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *c20_inData)
{
  ...
  const mxArray *c20_y = NULL;
  SFc20_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc20_kaiguangaiInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance)
{
  ...
  chartInstance->c20_is_active_c20_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c20_is_c20_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c20_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c20_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c20_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c20_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c20_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c20_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c20_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c20_kaiguangai(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[258],T\"gghx\",},{M[1],M[259],T\"kghx\",},{M[1],M[260],T\"skhx\",},{M[1],M[261],T\"yjhx\",},{M[8],M[0],T\"is_active_c20_kaiguangai\",},{M[8],M[7],T\"is_active_kaigai\",},{M[8],M[202],T\"is_active_guangai\",},{M[8],M[208],T\"is_active_songkai\",},{M[8],M[214],T\"is_active_yajin\",},{M[8],M[243],T\"is_active_suoding\",}}",
    "100 S1x9'type','srcId','name','auxInfo'{{M[8],M[246],T\"is_active_jiesuo\",},{M[9],M[0],T\"is_c20_kaiguangai\",},{M[9],M[7],T\"is_kaigai\",},{M[9],M[202],T\"is_guangai\",},{M[9],M[208],T\"is_songkai\",},{M[9],M[214],T\"is_yajin\",},{M[9],M[243],T\"is_suoding\",},{M[9],M[246],T\"is_jiesuo\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M[1],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 19, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c20_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc20_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc20_kaiguangaiInstanceStruct *chartInstance =
      (SFc20_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c20_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc20_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S);
  chart_debug_initialization(((SFc20_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c20_kaiguangai((SFc20_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c20_kaiguangai((SFc20_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c20_kaiguangai(void *chartInstanceVar)
{
  enable_c20_kaiguangai((SFc20_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c20_kaiguangai(void *chartInstanceVar)
{
  disable_c20_kaiguangai((SFc20_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c20_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c20_kaiguangai((SFc20_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c20_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c20_kaiguangai((SFc20_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c20_kaiguangai(SimStruct* S)
{
  return get_sim_state_c20_kaiguangai((SFc20_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c20_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c20_kaiguangai((SFc20_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c20_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc20_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c20_kaiguangai((SFc20_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc20_kaiguangai((SFc20_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c20_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c20_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c20_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c20_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c20_kaiguangai(SimStruct *S)
{
  SFc20_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc20_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc20_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc20_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c20_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c20_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c20_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c20_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c20_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c20_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c20_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c20_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c20_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c20_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c20_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c20_kaiguangai;
  ...
  mdl_start_c20_kaiguangai(chartInstance);
}

void c20_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c20_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c20_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c20_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c20_kaiguangai_method_dispatcher.\n"
