...
static void initialize_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void disable_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct
  *chartInstance);
static void ext_mode_exec_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct *
  chartInstance);
static void set_sim_state_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void c2_set_sim_state_side_effects_c2_kaiguangai
  (SFc2_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void sf_gateway_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void initSimStructsc2_kaiguangai(SFc2_kaiguangaiInstanceStruct
  *chartInstance);
static void c2_zidong(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_enter_atomic_chushihua(SFc2_kaiguangaiInstanceStruct
  *chartInstance);
static void c2_songkaishijian(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_start(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on10(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_songkaishijian1(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_yanchishijian1(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_tguiling(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_enter_atomic_on2(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on2(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_kaigaishijian(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_songkaishijian2(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on11(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_yanchishijian2(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_t2guiling(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_enter_atomic_on3(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on3(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_suodingshijian(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on7(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_songkaishijian3(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on12(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_yanchishijian3(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_t4guiling(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_enter_atomic_off(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on4(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_jiesuoshijian(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_songkaishijian4(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on14(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_yanchishijian4(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_t6guiling(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_enter_atomic_on5(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on5(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_guangaishijian(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_songkaishijian5(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on16(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_yanchishijian5(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_t8guiling(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_yanchishijian6(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_t10guiling(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_enter_atomic_on6(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on6(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_yajinshijian(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_songkaishijian6(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void c2_on18(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c2_nargout, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static boolean_T c2_c_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c2_b_is_zidong, const char_T *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint16_T c2_g_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c2_b_temporalCounter_i1, const char_T
  *c2_identifier);
static uint16_T c2_h_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_i_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c2_b_dataWrittenToVector, const char_T *c2_identifier,
  boolean_T c2_y[27]);
static void c2_j_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, boolean_T c2_y[27]);
static const mxArray *c2_k_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c2_b_setSimStateSideEffectsInfo, const char_T
  *c2_identifier);
static const mxArray *c2_l_emlrt_marshallIn(SFc2_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc2_kaiguangaiInstanceStruct
  *chartInstance, int32_T c2_ssid);
static void c2_init_sf_message_store_memory(SFc2_kaiguangaiInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc2_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc2_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc2_kaiguangai(chartInstance);
  ...
  *chartInstance->c2_temporalCounter_i1 = 0U;
  *chartInstance->c2_temporalCounter_i1 = 0U;
  *chartInstance->c2_is_active_c2_kaiguangai = 0U;
  *chartInstance->c2_is_c2_kaiguangai = c2_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c2_is_active_c2_kaiguangai == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 1U, *chartInstance->c2_sfEvent);
  }

  if (*chartInstance->c2_is_c2_kaiguangai == c2_IN_zidong) {
...
static void ext_mode_exec_c2_kaiguangai(SFc2_kaiguangaiInstanceStruct
  *chartInstance)
{
  c2_update_debugger_state_c2_kaiguangai(chartInstance);
}
  ...
  chartInstance)
{
  ...
  c2_cb_hoistedGlobal = *chartInstance->c2_is_active_c2_kaiguangai;
  c2_db_y = NULL;
  sf_mex_assign(&c2_db_y, sf_mex_create("y", &c2_cb_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c2_y, 27, c2_db_y);
  c2_db_hoistedGlobal = *chartInstance->c2_is_c2_kaiguangai;
  c2_eb_y = NULL;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *chartInstance->c2_is_active_c2_kaiguangai = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c2_kaiguangai", c2_u,
       27)), "is_active_c2_kaiguangai");
  *chartInstance->c2_is_c2_kaiguangai = c2_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c2_kaiguangai", c2_u, 28)), "is_c2_kaiguangai");
  ...
  *chartInstance)
{
  ...
  c2_set_sim_state_side_effects_c2_kaiguangai(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc2_kaiguangaiInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_is_c2_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c2_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c2_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c2_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c2_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_kaiguangai(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[373],T\"yjyichang\",},{M[3],M[59],T\"t\",},{M[3],M[344],T\"t10\",},{M[3],M[74],T\"t2\",},{M[3],M[104],T\"t4\",},{M[3],M[124],T\"t6\",},{M[3],M[168],T\"t8\",},{M[8],M[0],T\"is_active_c2_kaiguangai\",},{M[9],M[0],T\"is_c2_kaiguangai\",},{M[9],M[374],T\"is_zidong\",}}",
  ...
  sf_c2_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc2_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_kaiguangaiInstanceStruct *chartInstance =
      (SFc2_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c2_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc2_kaiguangaiInstanceStruct*) chartInstanceVar
    )->S);
  chart_debug_initialization(((SFc2_kaiguangaiInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c2_kaiguangai((SFc2_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c2_kaiguangai((SFc2_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_kaiguangai(void *chartInstanceVar)
{
  enable_c2_kaiguangai((SFc2_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_kaiguangai(void *chartInstanceVar)
{
  disable_c2_kaiguangai((SFc2_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c2_kaiguangai((SFc2_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c2_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c2_kaiguangai((SFc2_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_kaiguangai(SimStruct* S)
{
  return get_sim_state_c2_kaiguangai((SFc2_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c2_kaiguangai((SFc2_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c2_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c2_kaiguangai((SFc2_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_kaiguangai((SFc2_kaiguangaiInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c2_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c2_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c2_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_kaiguangai(SimStruct *S)
{
  SFc2_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc2_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc2_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc2_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c2_kaiguangai;
  ...
  mdl_start_c2_kaiguangai(chartInstance);
}

void c2_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_kaiguangai_method_dispatcher.\n"
