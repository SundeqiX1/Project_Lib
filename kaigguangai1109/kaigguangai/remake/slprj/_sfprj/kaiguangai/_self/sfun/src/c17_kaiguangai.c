...
static void initialize_c17_kaiguangai(SFc17_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c17_kaiguangai(SFc17_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c17_kaiguangai(SFc17_kaiguangaiInstanceStruct *chartInstance);
static void disable_c17_kaiguangai(SFc17_kaiguangaiInstanceStruct *chartInstance);
static void c17_update_debugger_state_c17_kaiguangai
  (SFc17_kaiguangaiInstanceStruct *chartInstance);
static void ext_mode_exec_c17_kaiguangai(SFc17_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c17_kaiguangai
  (SFc17_kaiguangaiInstanceStruct *chartInstance);
static void set_sim_state_c17_kaiguangai(SFc17_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c17_st);
static void c17_set_sim_state_side_effects_c17_kaiguangai
  (SFc17_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c17_kaiguangai(SFc17_kaiguangaiInstanceStruct
  *chartInstance);
static void sf_gateway_c17_kaiguangai(SFc17_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c17_kaiguangai(SFc17_kaiguangaiInstanceStruct
  *chartInstance);
static void initSimStructsc17_kaiguangai(SFc17_kaiguangaiInstanceStruct
  *chartInstance);
static void c17_MANUAL(SFc17_kaiguangaiInstanceStruct *chartInstance);
static void c17_exit_internal_MANUAL(SFc17_kaiguangaiInstanceStruct
  *chartInstance);
...
static const mxArray *c17_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static int32_T c17_emlrt_marshallIn(SFc17_kaiguangaiInstanceStruct
...
static const mxArray *c17_b_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static uint8_T c17_b_emlrt_marshallIn(SFc17_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c17_b_is_kaigai, const char_T *c17_identifier);
static uint8_T c17_c_emlrt_marshallIn(SFc17_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
...
static const mxArray *c17_c_sf_marshallOut(void *chartInstanceVoid, void
  *c17_inData);
static real_T c17_d_emlrt_marshallIn(SFc17_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c17_b_skhx, const char_T *c17_identifier);
static real_T c17_e_emlrt_marshallIn(SFc17_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static void c17_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c17_mxArrayInData, const char_T *c17_varName, void *c17_outData);
static uint16_T c17_f_emlrt_marshallIn(SFc17_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c17_b_temporalCounter_i1, const char_T
  *c17_identifier);
static uint16_T c17_g_emlrt_marshallIn(SFc17_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static const mxArray *c17_h_emlrt_marshallIn(SFc17_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c17_b_setSimStateSideEffectsInfo, const char_T *
  c17_identifier);
static const mxArray *c17_i_emlrt_marshallIn(SFc17_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c17_u, const emlrtMsgIdentifier *c17_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc17_kaiguangaiInstanceStruct
  *chartInstance, int32_T c17_ssid);
static void c17_init_sf_message_store_memory(SFc17_kaiguangaiInstanceStruct
  *chartInstance);
static uint16_T c17__u16_s32_(SFc17_kaiguangaiInstanceStruct *chartInstance,
  int32_T c17_b, uint32_T c17_ssid_src_loc, int32_T c17_offset_src_loc, int32_T
  c17_length_src_loc);
static void init_dsm_address_info(SFc17_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc17_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc17_kaiguangai(chartInstance);
  ...
  *chartInstance->c17_is_active_c17_kaiguangai = 0U;
  *chartInstance->c17_is_c17_kaiguangai = c17_IN_NO_ACTIVE_CHILD;
  ...
  (SFc17_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c17_is_active_c17_kaiguangai == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 16U, *chartInstance->c17_sfEvent);
  }

  if (*chartInstance->c17_is_c17_kaiguangai == c17_IN_MANUAL) {
...
static void ext_mode_exec_c17_kaiguangai(SFc17_kaiguangaiInstanceStruct
  *chartInstance)
{
  c17_update_debugger_state_c17_kaiguangai(chartInstance);
}
  ...
  (SFc17_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  c17_e_hoistedGlobal = *chartInstance->c17_is_active_c17_kaiguangai;
  c17_f_y = NULL;
  ...
  c17_l_hoistedGlobal = *chartInstance->c17_is_c17_kaiguangai;
  c17_m_y = NULL;
  ...
  *chartInstance, const mxArray *c17_st)
{
  ...
  *chartInstance->c17_is_active_c17_kaiguangai = c17_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c17_kaiguangai", c17_u,
       4)), "is_active_c17_kaiguangai");
  ...
  *chartInstance->c17_is_active_jiesuo = c17_b_emlrt_marshallIn(chartInstance,
    ...
    "is_active_jiesuo");
  *chartInstance->c17_is_c17_kaiguangai = c17_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c17_kaiguangai", c17_u, 11)),
    "is_c17_kaiguangai");
  ...
  (SFc17_kaiguangaiInstanceStruct *chartInstance)
{
  if (chartInstance->c17_doSetSimStateSideEffects != 0) {
    if ((*chartInstance->c17_is_c17_kaiguangai == c17_IN_on1) && (sf_mex_sub
  ...
  *chartInstance)
{
  ...
  boolean_T c17_temp;
  boolean_T c17_b_out;
  c17_set_sim_state_side_effects_c17_kaiguangai(chartInstance);
  ...
  *chartInstance->c17_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c17_is_active_c17_kaiguangai == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 16U,
                 *chartInstance->c17_sfEvent);
    *chartInstance->c17_is_active_c17_kaiguangai = 1U;
    ...
    *chartInstance->c17_is_c17_kaiguangai = c17_IN_off1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 20U, *chartInstance->c17_sfEvent);
  } else {
    switch (*chartInstance->c17_is_c17_kaiguangai) {
     case c17_IN_MANUAL:
     ...
     case c17_IN_off1:
      ...
      if (c17_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 20U, *chartInstance->c17_sfEvent);
        *chartInstance->c17_is_c17_kaiguangai = c17_IN_on1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 21U, *chartInstance->c17_sfEvent);
        *chartInstance->c17_temporalCounter_i1 = 0U;
        *chartInstance->c17_skhx = 0.0;
     ...
     case c17_IN_on1:
      ...
      if (c17_b_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 21U, *chartInstance->c17_sfEvent);
        *chartInstance->c17_is_c17_kaiguangai = c17_IN_MANUAL;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c17_sfEvent);
...
static void c17_MANUAL(SFc17_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (c17_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c17_sfEvent);
    *chartInstance->c17_is_c17_kaiguangai = c17_IN_end;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 19U, *chartInstance->c17_sfEvent);
    *chartInstance->c17_skhx = 0.0;
...
const mxArray *sf_c17_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *c17_inData)
{
  ...
  const mxArray *c17_y = NULL;
  SFc17_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc17_kaiguangaiInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance)
{
  ...
  chartInstance->c17_is_active_c17_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c17_is_c17_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c17_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c17_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c17_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c17_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c17_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c17_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c17_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c17_kaiguangai(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[258],T\"gghx\",},{M[1],M[259],T\"kghx\",},{M[1],M[260],T\"skhx\",},{M[1],M[261],T\"yjhx\",},{M[8],M[0],T\"is_active_c17_kaiguangai\",},{M[8],M[7],T\"is_active_kaigai\",},{M[8],M[202],T\"is_active_guangai\",},{M[8],M[208],T\"is_active_songkai\",},{M[8],M[214],T\"is_active_yajin\",},{M[8],M[243],T\"is_active_suoding\",}}",
    "100 S1x9'type','srcId','name','auxInfo'{{M[8],M[246],T\"is_active_jiesuo\",},{M[9],M[0],T\"is_c17_kaiguangai\",},{M[9],M[7],T\"is_kaigai\",},{M[9],M[202],T\"is_guangai\",},{M[9],M[208],T\"is_songkai\",},{M[9],M[214],T\"is_yajin\",},{M[9],M[243],T\"is_suoding\",},{M[9],M[246],T\"is_jiesuo\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M[1],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 19, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c17_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc17_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc17_kaiguangaiInstanceStruct *chartInstance =
      (SFc17_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c17_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc17_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S);
  chart_debug_initialization(((SFc17_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c17_kaiguangai((SFc17_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c17_kaiguangai((SFc17_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c17_kaiguangai(void *chartInstanceVar)
{
  enable_c17_kaiguangai((SFc17_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c17_kaiguangai(void *chartInstanceVar)
{
  disable_c17_kaiguangai((SFc17_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c17_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c17_kaiguangai((SFc17_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c17_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c17_kaiguangai((SFc17_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c17_kaiguangai(SimStruct* S)
{
  return get_sim_state_c17_kaiguangai((SFc17_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c17_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c17_kaiguangai((SFc17_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c17_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc17_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c17_kaiguangai((SFc17_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc17_kaiguangai((SFc17_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c17_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c17_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c17_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c17_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c17_kaiguangai(SimStruct *S)
{
  SFc17_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc17_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc17_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc17_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c17_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c17_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c17_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c17_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c17_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c17_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c17_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c17_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c17_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c17_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c17_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c17_kaiguangai;
  ...
  mdl_start_c17_kaiguangai(chartInstance);
}

void c17_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c17_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c17_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c17_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c17_kaiguangai_method_dispatcher.\n"
