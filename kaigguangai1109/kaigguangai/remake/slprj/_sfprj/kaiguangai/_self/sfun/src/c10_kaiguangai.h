#ifndef __c10_kaiguangai_h__
#define __c10_kaiguangai_h__
...
/* Type Definitions */
#ifndef typedef_SFc10_kaiguangaiInstanceStruct
#define typedef_SFc10_kaiguangaiInstanceStruct
...
typedef struct {
  ...
  int32_T *c10_sfEvent;
  uint8_T *c10_is_active_c10_kaiguangai;
  uint8_T *c10_is_c10_kaiguangai;
...
#endif                                 /*typedef_SFc10_kaiguangaiInstanceStruct*/
...
extern const mxArray *sf_c10_kaiguangai_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c10_kaiguangai_get_check_sum(mxArray *plhs[]);
extern void c10_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void
  *data);
