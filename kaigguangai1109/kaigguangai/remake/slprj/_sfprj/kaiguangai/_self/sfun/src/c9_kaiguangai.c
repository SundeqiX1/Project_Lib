...
static void initialize_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void disable_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_update_debugger_state_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct
  *chartInstance);
static void ext_mode_exec_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct *
  chartInstance);
static void set_sim_state_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c9_st);
static void c9_set_sim_state_side_effects_c9_kaiguangai
  (SFc9_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void sf_gateway_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_chartstep_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct
  *chartInstance);
static void initSimStructsc9_kaiguangai(SFc9_kaiguangaiInstanceStruct
  *chartInstance);
static void c9_off(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_exit_internal_shoudong(SFc9_kaiguangaiInstanceStruct
  *chartInstance);
static void c9_songkai(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_t(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_kaigai(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_enter_atomic_off(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_b_t(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_jiesuo(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_c_t(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_suoding(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_d_t(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_yajin(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_e_t(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_guangai(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_b_enter_atomic_off(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void c9_f_t(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber, uint32_T c9_instanceNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static real_T c9_emlrt_marshallIn(SFc9_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c9_nargout, const char_T *c9_identifier);
static real_T c9_b_emlrt_marshallIn(SFc9_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_b_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static boolean_T c9_c_emlrt_marshallIn(SFc9_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_d_emlrt_marshallIn(SFc9_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_d_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static uint8_T c9_e_emlrt_marshallIn(SFc9_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c9_b_is_songkai, const char_T *c9_identifier);
static uint8_T c9_f_emlrt_marshallIn(SFc9_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static void c9_g_emlrt_marshallIn(SFc9_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c9_b_dataWrittenToVector, const char_T *c9_identifier,
  boolean_T c9_y[20]);
static void c9_h_emlrt_marshallIn(SFc9_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId, boolean_T c9_y[20]);
static const mxArray *c9_i_emlrt_marshallIn(SFc9_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c9_b_setSimStateSideEffectsInfo, const char_T
  *c9_identifier);
static const mxArray *c9_j_emlrt_marshallIn(SFc9_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc9_kaiguangaiInstanceStruct
  *chartInstance, int32_T c9_ssid);
static void c9_init_sf_message_store_memory(SFc9_kaiguangaiInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc9_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc9_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc9_kaiguangai(chartInstance);
  ...
  *chartInstance->c9_is_active_c9_kaiguangai = 0U;
  *chartInstance->c9_is_c9_kaiguangai = c9_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c9_is_c9_kaiguangai == c9_IN_off1) {
...
static void ext_mode_exec_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct
  *chartInstance)
{
  c9_update_debugger_state_c9_kaiguangai(chartInstance);
}
  ...
  chartInstance)
{
  ...
  c9_u_hoistedGlobal = *chartInstance->c9_is_active_c9_kaiguangai;
  c9_v_y = NULL;
  ...
  c9_cb_hoistedGlobal = *chartInstance->c9_is_c9_kaiguangai;
  c9_db_y = NULL;
  ...
  *chartInstance, const mxArray *c9_st)
{
  ...
  *chartInstance->c9_is_active_c9_kaiguangai = c9_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c9_kaiguangai", c9_u,
       20)), "is_active_c9_kaiguangai");
  ...
  *chartInstance->c9_is_c9_kaiguangai = c9_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c9_kaiguangai", c9_u, 27)), "is_c9_kaiguangai");
...
static void sf_gateway_c9_kaiguangai(SFc9_kaiguangaiInstanceStruct
  *chartInstance)
{
  c9_set_sim_state_side_effects_c9_kaiguangai(chartInstance);
  ...
  *chartInstance->c9_sfEvent = CALL_EVENT;
  ...
  c9_chartstep_c9_kaiguangai(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c9_is_active_c9_kaiguangai == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 8U, *chartInstance->c9_sfEvent);
    *chartInstance->c9_is_active_c9_kaiguangai = 1U;
    ...
    *chartInstance->c9_is_c9_kaiguangai = c9_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c9_sfEvent);
    ...
    *chartInstance->c9_yjyichang = 0.0;
    ...
    switch (*chartInstance->c9_is_c9_kaiguangai) {
     case c9_IN_off:
      CV_CHART_EVAL(8, 0, 1);
     ...
     case c9_IN_shoudong:
      ...
      if (c9_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c9_sfEvent);
        *chartInstance->c9_is_c9_kaiguangai = c9_IN_off1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c9_sfEvent);
...
static void c9_off(SFc9_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (c9_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c9_sfEvent);
    *chartInstance->c9_is_c9_kaiguangai = c9_IN_shoudong;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c9_sfEvent);
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_y = NULL;
  SFc9_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc9_kaiguangaiInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c9_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c9_is_c9_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c9_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c9_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c9_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c9_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c9_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c9_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c9_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c9_kaiguangai(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c9_kaiguangai\",},{M[8],M[1],T\"is_active_songkai\",},{M[8],M[32],T\"is_active_kaigai\",},{M[8],M[53],T\"is_active_suoding\",},{M[8],M[63],T\"is_active_jiesuo\",},{M[8],M[86],T\"is_active_guangai\",},{M[8],M[87],T\"is_active_yajin\",},{M[9],M[0],T\"is_c9_kaiguangai\",},{M[9],M[1],T\"is_songkai\",},{M[9],M[32],T\"is_kaigai\",}}",
  ...
  sf_c9_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc9_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc9_kaiguangaiInstanceStruct *chartInstance =
      (SFc9_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c9_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc9_kaiguangaiInstanceStruct*) chartInstanceVar
    )->S);
  chart_debug_initialization(((SFc9_kaiguangaiInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c9_kaiguangai((SFc9_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c9_kaiguangai((SFc9_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c9_kaiguangai(void *chartInstanceVar)
{
  enable_c9_kaiguangai((SFc9_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c9_kaiguangai(void *chartInstanceVar)
{
  disable_c9_kaiguangai((SFc9_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c9_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c9_kaiguangai((SFc9_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c9_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c9_kaiguangai((SFc9_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c9_kaiguangai(SimStruct* S)
{
  return get_sim_state_c9_kaiguangai((SFc9_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c9_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c9_kaiguangai((SFc9_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c9_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c9_kaiguangai((SFc9_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc9_kaiguangai((SFc9_kaiguangaiInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c9_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c9_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c9_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_kaiguangai(SimStruct *S)
{
  SFc9_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc9_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc9_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc9_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c9_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c9_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c9_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c9_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c9_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c9_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c9_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c9_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c9_kaiguangai;
  ...
  mdl_start_c9_kaiguangai(chartInstance);
}

void c9_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_kaiguangai_method_dispatcher.\n"
