...
static void initialize_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct *chartInstance);
static void disable_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct *chartInstance);
static void c27_update_debugger_state_c27_kaiguangai
  (SFc27_kaiguangaiInstanceStruct *chartInstance);
static void ext_mode_exec_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c27_kaiguangai
  (SFc27_kaiguangaiInstanceStruct *chartInstance);
static void set_sim_state_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c27_st);
static void c27_set_sim_state_side_effects_c27_kaiguangai
  (SFc27_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct
  *chartInstance);
static void sf_gateway_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct
  *chartInstance);
static void c27_chartstep_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct
  *chartInstance);
static void initSimStructsc27_kaiguangai(SFc27_kaiguangaiInstanceStruct
  *chartInstance);
...
static const mxArray *c27_sf_marshallOut(void *chartInstanceVoid, void
  *c27_inData);
static real_T c27_emlrt_marshallIn(SFc27_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c27_nargout, const char_T *c27_identifier);
static real_T c27_b_emlrt_marshallIn(SFc27_kaiguangaiInstanceStruct
...
static const mxArray *c27_b_sf_marshallOut(void *chartInstanceVoid, void
  *c27_inData);
static boolean_T c27_c_emlrt_marshallIn(SFc27_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c27_u, const emlrtMsgIdentifier *c27_parentId);
...
static const mxArray *c27_c_sf_marshallOut(void *chartInstanceVoid, void
  *c27_inData);
static int32_T c27_d_emlrt_marshallIn(SFc27_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c27_u, const emlrtMsgIdentifier *c27_parentId);
static void c27_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c27_mxArrayInData, const char_T *c27_varName, void *c27_outData);
static uint8_T c27_e_emlrt_marshallIn(SFc27_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c27_b_is_active_c27_kaiguangai, const char_T
  *c27_identifier);
static uint8_T c27_f_emlrt_marshallIn(SFc27_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c27_u, const emlrtMsgIdentifier *c27_parentId);
static void c27_g_emlrt_marshallIn(SFc27_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c27_b_dataWrittenToVector, const char_T *c27_identifier,
  boolean_T c27_y[2]);
static void c27_h_emlrt_marshallIn(SFc27_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c27_u, const emlrtMsgIdentifier *c27_parentId, boolean_T c27_y
  [2]);
static const mxArray *c27_i_emlrt_marshallIn(SFc27_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c27_b_setSimStateSideEffectsInfo, const char_T *
  c27_identifier);
static const mxArray *c27_j_emlrt_marshallIn(SFc27_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c27_u, const emlrtMsgIdentifier *c27_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc27_kaiguangaiInstanceStruct
  *chartInstance, int32_T c27_ssid);
static void c27_init_sf_message_store_memory(SFc27_kaiguangaiInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc27_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc27_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc27_kaiguangai(chartInstance);
  ...
  *chartInstance->c27_is_active_c27_kaiguangai = 0U;
  *chartInstance->c27_is_c27_kaiguangai = c27_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc27_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c27_is_active_c27_kaiguangai == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 26U, *chartInstance->c27_sfEvent);
  }

  if (*chartInstance->c27_is_c27_kaiguangai == c27_IN_off) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c27_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c27_sfEvent);
  }

  if (*chartInstance->c27_is_c27_kaiguangai == c27_IN_on) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c27_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c27_sfEvent);
  }

  if (*chartInstance->c27_is_c27_kaiguangai == c27_IN_on1) {
...
static void ext_mode_exec_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct
  *chartInstance)
{
  c27_update_debugger_state_c27_kaiguangai(chartInstance);
}
  ...
  (SFc27_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  c27_c_hoistedGlobal = *chartInstance->c27_is_active_c27_kaiguangai;
  c27_d_y = NULL;
  sf_mex_assign(&c27_d_y, sf_mex_create("y", &c27_c_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c27_y, 2, c27_d_y);
  c27_d_hoistedGlobal = *chartInstance->c27_is_c27_kaiguangai;
  c27_e_y = NULL;
  ...
  *chartInstance, const mxArray *c27_st)
{
  ...
  *chartInstance->c27_is_active_c27_kaiguangai = c27_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c27_kaiguangai", c27_u,
       2)), "is_active_c27_kaiguangai");
  *chartInstance->c27_is_c27_kaiguangai = c27_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c27_kaiguangai", c27_u, 3)),
    "is_c27_kaiguangai");
...
static void sf_gateway_c27_kaiguangai(SFc27_kaiguangaiInstanceStruct
  *chartInstance)
{
  c27_set_sim_state_side_effects_c27_kaiguangai(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c27_guangaihuanchong, 1U, 1U, 0U,
                        *chartInstance->c27_sfEvent, false);
  *chartInstance->c27_sfEvent = CALL_EVENT;
  c27_chartstep_c27_kaiguangai(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c27_is_active_c27_kaiguangai == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 26U,
                 *chartInstance->c27_sfEvent);
    *chartInstance->c27_is_active_c27_kaiguangai = 1U;
    ...
    *chartInstance->c27_is_c27_kaiguangai = c27_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c27_sfEvent);
    ...
    *chartInstance->c27_t = 0.0;
    ...
    switch (*chartInstance->c27_is_c27_kaiguangai) {
     case c27_IN_off:
      ...
      if (c27_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c27_sfEvent);
        *chartInstance->c27_is_c27_kaiguangai = c27_IN_on;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c27_sfEvent);
      ...
      if (c27_b_out) {
        ...
        *chartInstance->c27_t += 0.002;
        ...
        if (c27_c_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c27_sfEvent);
          *chartInstance->c27_is_c27_kaiguangai = c27_IN_on1;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c27_sfEvent);
  ...
  *c27_inData)
{
  ...
  const mxArray *c27_y = NULL;
  SFc27_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc27_kaiguangaiInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c27_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *c27_identifier)
{
  ...
  c27_y = c27_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c27_b_is_active_c27_kaiguangai), &c27_thisId);
  sf_mex_destroy(&c27_b_is_active_c27_kaiguangai);
  return c27_y;
}
  ...
  *chartInstance)
{
  ...
  chartInstance->c27_is_active_c27_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c27_is_c27_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c27_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c27_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c27_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c27_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c27_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c27_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c27_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c27_kaiguangai(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[17],T\"guangaihuanchongyichang\",},{M[3],M[7],T\"t\",},{M[8],M[0],T\"is_active_c27_kaiguangai\",},{M[9],M[0],T\"is_c27_kaiguangai\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c27_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc27_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc27_kaiguangaiInstanceStruct *chartInstance =
      (SFc27_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c27_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc27_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S);
  chart_debug_initialization(((SFc27_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c27_kaiguangai((SFc27_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c27_kaiguangai((SFc27_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c27_kaiguangai(void *chartInstanceVar)
{
  enable_c27_kaiguangai((SFc27_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c27_kaiguangai(void *chartInstanceVar)
{
  disable_c27_kaiguangai((SFc27_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c27_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c27_kaiguangai((SFc27_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c27_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c27_kaiguangai((SFc27_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c27_kaiguangai(SimStruct* S)
{
  return get_sim_state_c27_kaiguangai((SFc27_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c27_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c27_kaiguangai((SFc27_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c27_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc27_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c27_kaiguangai((SFc27_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc27_kaiguangai((SFc27_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c27_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c27_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c27_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c27_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c27_kaiguangai(SimStruct *S)
{
  SFc27_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc27_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc27_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc27_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c27_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c27_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c27_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c27_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c27_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c27_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c27_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c27_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c27_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c27_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c27_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c27_kaiguangai;
  ...
  mdl_start_c27_kaiguangai(chartInstance);
}

void c27_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c27_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c27_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c27_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c27_kaiguangai_method_dispatcher.\n"
