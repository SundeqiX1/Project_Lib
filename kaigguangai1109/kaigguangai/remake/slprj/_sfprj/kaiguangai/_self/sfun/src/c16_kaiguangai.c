...
static void initialize_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void disable_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_update_debugger_state_c16_kaiguangai
  (SFc16_kaiguangaiInstanceStruct *chartInstance);
static void ext_mode_exec_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c16_kaiguangai
  (SFc16_kaiguangaiInstanceStruct *chartInstance);
static void set_sim_state_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c16_st);
static void c16_set_sim_state_side_effects_c16_kaiguangai
  (SFc16_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct
  *chartInstance);
static void sf_gateway_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct
  *chartInstance);
static void c16_chartstep_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct
  *chartInstance);
static void initSimStructsc16_kaiguangai(SFc16_kaiguangaiInstanceStruct
  *chartInstance);
static void c16_off(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_exit_internal_shoudong(SFc16_kaiguangaiInstanceStruct
  *chartInstance);
static void c16_songkai(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_t(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_kaigai(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_enter_atomic_off(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_b_t(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_jiesuo(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_c_t(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_suoding(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_d_t(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_yajin(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_e_t(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_guangai(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_b_enter_atomic_off(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void c16_f_t(SFc16_kaiguangaiInstanceStruct *chartInstance);
...
static const mxArray *c16_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static real_T c16_emlrt_marshallIn(SFc16_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c16_nargout, const char_T *c16_identifier);
static real_T c16_b_emlrt_marshallIn(SFc16_kaiguangaiInstanceStruct
...
static const mxArray *c16_b_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static boolean_T c16_c_emlrt_marshallIn(SFc16_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
...
static const mxArray *c16_c_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static int32_T c16_d_emlrt_marshallIn(SFc16_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
...
static const mxArray *c16_d_sf_marshallOut(void *chartInstanceVoid, void
  *c16_inData);
static uint8_T c16_e_emlrt_marshallIn(SFc16_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c16_b_is_songkai, const char_T *c16_identifier);
static uint8_T c16_f_emlrt_marshallIn(SFc16_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void c16_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c16_mxArrayInData, const char_T *c16_varName, void *c16_outData);
static void c16_g_emlrt_marshallIn(SFc16_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c16_b_dataWrittenToVector, const char_T *c16_identifier,
  boolean_T c16_y[20]);
static void c16_h_emlrt_marshallIn(SFc16_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId, boolean_T c16_y
  [20]);
static const mxArray *c16_i_emlrt_marshallIn(SFc16_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c16_b_setSimStateSideEffectsInfo, const char_T *
  c16_identifier);
static const mxArray *c16_j_emlrt_marshallIn(SFc16_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc16_kaiguangaiInstanceStruct
  *chartInstance, int32_T c16_ssid);
static void c16_init_sf_message_store_memory(SFc16_kaiguangaiInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc16_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc16_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc16_kaiguangai(chartInstance);
  ...
  *chartInstance->c16_is_active_c16_kaiguangai = 0U;
  *chartInstance->c16_is_c16_kaiguangai = c16_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc16_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c16_is_c16_kaiguangai == c16_IN_off1) {
...
static void ext_mode_exec_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct
  *chartInstance)
{
  c16_update_debugger_state_c16_kaiguangai(chartInstance);
}
  ...
  (SFc16_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  c16_u_hoistedGlobal = *chartInstance->c16_is_active_c16_kaiguangai;
  c16_v_y = NULL;
  ...
  c16_cb_hoistedGlobal = *chartInstance->c16_is_c16_kaiguangai;
  c16_db_y = NULL;
  ...
  *chartInstance, const mxArray *c16_st)
{
  ...
  *chartInstance->c16_is_active_c16_kaiguangai = c16_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c16_kaiguangai", c16_u,
       20)), "is_active_c16_kaiguangai");
  ...
  *chartInstance->c16_is_c16_kaiguangai = c16_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c16_kaiguangai", c16_u, 27)),
    "is_c16_kaiguangai");
...
static void sf_gateway_c16_kaiguangai(SFc16_kaiguangaiInstanceStruct
  *chartInstance)
{
  c16_set_sim_state_side_effects_c16_kaiguangai(chartInstance);
  ...
  *chartInstance->c16_sfEvent = CALL_EVENT;
  ...
  c16_chartstep_c16_kaiguangai(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c16_is_active_c16_kaiguangai == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 15U,
                 *chartInstance->c16_sfEvent);
    *chartInstance->c16_is_active_c16_kaiguangai = 1U;
    ...
    *chartInstance->c16_is_c16_kaiguangai = c16_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c16_sfEvent);
    ...
    *chartInstance->c16_yjyichang = 0.0;
    ...
    switch (*chartInstance->c16_is_c16_kaiguangai) {
     case c16_IN_off:
     ...
     case c16_IN_shoudong:
      ...
      if (c16_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c16_sfEvent);
        *chartInstance->c16_is_c16_kaiguangai = c16_IN_off1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c16_sfEvent);
...
static void c16_off(SFc16_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (c16_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c16_sfEvent);
    *chartInstance->c16_is_c16_kaiguangai = c16_IN_shoudong;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c16_sfEvent);
  ...
  *c16_inData)
{
  ...
  const mxArray *c16_y = NULL;
  SFc16_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc16_kaiguangaiInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c16_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c16_is_c16_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c16_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c16_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c16_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c16_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c16_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c16_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c16_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c16_kaiguangai(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c16_kaiguangai\",},{M[8],M[1],T\"is_active_songkai\",},{M[8],M[32],T\"is_active_kaigai\",},{M[8],M[53],T\"is_active_suoding\",},{M[8],M[63],T\"is_active_jiesuo\",},{M[8],M[86],T\"is_active_guangai\",},{M[8],M[87],T\"is_active_yajin\",},{M[9],M[0],T\"is_c16_kaiguangai\",},{M[9],M[1],T\"is_songkai\",},{M[9],M[32],T\"is_kaigai\",}}",
  ...
  sf_c16_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc16_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc16_kaiguangaiInstanceStruct *chartInstance =
      (SFc16_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c16_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc16_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S);
  chart_debug_initialization(((SFc16_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c16_kaiguangai((SFc16_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c16_kaiguangai((SFc16_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c16_kaiguangai(void *chartInstanceVar)
{
  enable_c16_kaiguangai((SFc16_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c16_kaiguangai(void *chartInstanceVar)
{
  disable_c16_kaiguangai((SFc16_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c16_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c16_kaiguangai((SFc16_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c16_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c16_kaiguangai((SFc16_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c16_kaiguangai(SimStruct* S)
{
  return get_sim_state_c16_kaiguangai((SFc16_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c16_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c16_kaiguangai((SFc16_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c16_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c16_kaiguangai((SFc16_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc16_kaiguangai((SFc16_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c16_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c16_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c16_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c16_kaiguangai(SimStruct *S)
{
  SFc16_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc16_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc16_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc16_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c16_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c16_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c16_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c16_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c16_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c16_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c16_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c16_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c16_kaiguangai;
  ...
  mdl_start_c16_kaiguangai(chartInstance);
}

void c16_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_kaiguangai_method_dispatcher.\n"
