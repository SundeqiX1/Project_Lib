...
static void initialize_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct *chartInstance);
static void disable_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct *chartInstance);
static void c25_update_debugger_state_c25_kaiguangai
  (SFc25_kaiguangaiInstanceStruct *chartInstance);
static void ext_mode_exec_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c25_kaiguangai
  (SFc25_kaiguangaiInstanceStruct *chartInstance);
static void set_sim_state_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c25_st);
static void c25_set_sim_state_side_effects_c25_kaiguangai
  (SFc25_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct
  *chartInstance);
static void sf_gateway_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct
  *chartInstance);
static void c25_chartstep_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct
  *chartInstance);
static void initSimStructsc25_kaiguangai(SFc25_kaiguangaiInstanceStruct
  *chartInstance);
...
static const mxArray *c25_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static real_T c25_emlrt_marshallIn(SFc25_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c25_nargout, const char_T *c25_identifier);
static real_T c25_b_emlrt_marshallIn(SFc25_kaiguangaiInstanceStruct
...
static const mxArray *c25_b_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static boolean_T c25_c_emlrt_marshallIn(SFc25_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
...
static const mxArray *c25_c_sf_marshallOut(void *chartInstanceVoid, void
  *c25_inData);
static int32_T c25_d_emlrt_marshallIn(SFc25_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
static void c25_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c25_mxArrayInData, const char_T *c25_varName, void *c25_outData);
static uint8_T c25_e_emlrt_marshallIn(SFc25_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c25_b_is_active_c25_kaiguangai, const char_T
  *c25_identifier);
static uint8_T c25_f_emlrt_marshallIn(SFc25_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
static void c25_g_emlrt_marshallIn(SFc25_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c25_b_dataWrittenToVector, const char_T *c25_identifier,
  boolean_T c25_y[2]);
static void c25_h_emlrt_marshallIn(SFc25_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId, boolean_T c25_y
  [2]);
static const mxArray *c25_i_emlrt_marshallIn(SFc25_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c25_b_setSimStateSideEffectsInfo, const char_T *
  c25_identifier);
static const mxArray *c25_j_emlrt_marshallIn(SFc25_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c25_u, const emlrtMsgIdentifier *c25_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc25_kaiguangaiInstanceStruct
  *chartInstance, int32_T c25_ssid);
static void c25_init_sf_message_store_memory(SFc25_kaiguangaiInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc25_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc25_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc25_kaiguangai(chartInstance);
  ...
  *chartInstance->c25_is_active_c25_kaiguangai = 0U;
  *chartInstance->c25_is_c25_kaiguangai = c25_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc25_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c25_is_active_c25_kaiguangai == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 24U, *chartInstance->c25_sfEvent);
  }

  if (*chartInstance->c25_is_c25_kaiguangai == c25_IN_off) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c25_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c25_sfEvent);
  }

  if (*chartInstance->c25_is_c25_kaiguangai == c25_IN_on) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c25_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c25_sfEvent);
  }

  if (*chartInstance->c25_is_c25_kaiguangai == c25_IN_on1) {
...
static void ext_mode_exec_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct
  *chartInstance)
{
  c25_update_debugger_state_c25_kaiguangai(chartInstance);
}
  ...
  (SFc25_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  c25_c_hoistedGlobal = *chartInstance->c25_is_active_c25_kaiguangai;
  c25_d_y = NULL;
  sf_mex_assign(&c25_d_y, sf_mex_create("y", &c25_c_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c25_y, 2, c25_d_y);
  c25_d_hoistedGlobal = *chartInstance->c25_is_c25_kaiguangai;
  c25_e_y = NULL;
  ...
  *chartInstance, const mxArray *c25_st)
{
  ...
  *chartInstance->c25_is_active_c25_kaiguangai = c25_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c25_kaiguangai", c25_u,
       2)), "is_active_c25_kaiguangai");
  *chartInstance->c25_is_c25_kaiguangai = c25_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c25_kaiguangai", c25_u, 3)),
    "is_c25_kaiguangai");
...
static void sf_gateway_c25_kaiguangai(SFc25_kaiguangaiInstanceStruct
  *chartInstance)
{
  c25_set_sim_state_side_effects_c25_kaiguangai(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c25_kaigaihuanchong, 1U, 1U, 0U,
                        *chartInstance->c25_sfEvent, false);
  *chartInstance->c25_sfEvent = CALL_EVENT;
  c25_chartstep_c25_kaiguangai(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c25_is_active_c25_kaiguangai == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 24U,
                 *chartInstance->c25_sfEvent);
    *chartInstance->c25_is_active_c25_kaiguangai = 1U;
    ...
    *chartInstance->c25_is_c25_kaiguangai = c25_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c25_sfEvent);
    ...
    *chartInstance->c25_t = 0.0;
    ...
    switch (*chartInstance->c25_is_c25_kaiguangai) {
     case c25_IN_off:
      ...
      if (c25_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c25_sfEvent);
        *chartInstance->c25_is_c25_kaiguangai = c25_IN_on;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c25_sfEvent);
      ...
      if (c25_b_out) {
        ...
        *chartInstance->c25_t += 0.002;
        ...
        if (c25_c_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *chartInstance->c25_sfEvent);
          *chartInstance->c25_is_c25_kaiguangai = c25_IN_on1;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c25_sfEvent);
  ...
  *c25_inData)
{
  ...
  const mxArray *c25_y = NULL;
  SFc25_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc25_kaiguangaiInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c25_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *c25_identifier)
{
  ...
  c25_y = c25_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c25_b_is_active_c25_kaiguangai), &c25_thisId);
  sf_mex_destroy(&c25_b_is_active_c25_kaiguangai);
  return c25_y;
}
  ...
  *chartInstance)
{
  ...
  chartInstance->c25_is_active_c25_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c25_is_c25_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c25_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c25_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c25_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c25_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c25_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c25_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c25_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c25_kaiguangai(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[8],T\"kaigaihuanchongyichang\",},{M[3],M[7],T\"t\",},{M[8],M[0],T\"is_active_c25_kaiguangai\",},{M[9],M[0],T\"is_c25_kaiguangai\",},{M[15],M[0],T\"dataWrittenToVector\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c25_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc25_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc25_kaiguangaiInstanceStruct *chartInstance =
      (SFc25_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c25_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc25_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S);
  chart_debug_initialization(((SFc25_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c25_kaiguangai((SFc25_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c25_kaiguangai((SFc25_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c25_kaiguangai(void *chartInstanceVar)
{
  enable_c25_kaiguangai((SFc25_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c25_kaiguangai(void *chartInstanceVar)
{
  disable_c25_kaiguangai((SFc25_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c25_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c25_kaiguangai((SFc25_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c25_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c25_kaiguangai((SFc25_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c25_kaiguangai(SimStruct* S)
{
  return get_sim_state_c25_kaiguangai((SFc25_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c25_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c25_kaiguangai((SFc25_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c25_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc25_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c25_kaiguangai((SFc25_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc25_kaiguangai((SFc25_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c25_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c25_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c25_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c25_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c25_kaiguangai(SimStruct *S)
{
  SFc25_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc25_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc25_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc25_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c25_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c25_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c25_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c25_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c25_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c25_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c25_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c25_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c25_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c25_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c25_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c25_kaiguangai;
  ...
  mdl_start_c25_kaiguangai(chartInstance);
}

void c25_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c25_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c25_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c25_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c25_kaiguangai_method_dispatcher.\n"
