...
static void initialize_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void disable_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_update_debugger_state_c12_kaiguangai
  (SFc12_kaiguangaiInstanceStruct *chartInstance);
static void ext_mode_exec_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c12_kaiguangai
  (SFc12_kaiguangaiInstanceStruct *chartInstance);
static void set_sim_state_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c12_st);
static void c12_set_sim_state_side_effects_c12_kaiguangai
  (SFc12_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct
  *chartInstance);
static void sf_gateway_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct
  *chartInstance);
static void c12_chartstep_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct
  *chartInstance);
static void initSimStructsc12_kaiguangai(SFc12_kaiguangaiInstanceStruct
  *chartInstance);
static void c12_off(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_exit_internal_shoudong(SFc12_kaiguangaiInstanceStruct
  *chartInstance);
static void c12_songkai(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_t(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_kaigai(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_enter_atomic_off(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_b_t(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_jiesuo(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_c_t(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_suoding(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_d_t(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_yajin(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_e_t(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_guangai(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_b_enter_atomic_off(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void c12_f_t(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c12_machineNumber, uint32_T
  c12_chartNumber, uint32_T c12_instanceNumber);
static const mxArray *c12_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static real_T c12_emlrt_marshallIn(SFc12_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c12_nargout, const char_T *c12_identifier);
static real_T c12_b_emlrt_marshallIn(SFc12_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_b_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static boolean_T c12_c_emlrt_marshallIn(SFc12_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static const mxArray *c12_c_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static int32_T c12_d_emlrt_marshallIn(SFc12_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
...
static const mxArray *c12_d_sf_marshallOut(void *chartInstanceVoid, void
  *c12_inData);
static uint8_T c12_e_emlrt_marshallIn(SFc12_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c12_b_is_songkai, const char_T *c12_identifier);
static uint8_T c12_f_emlrt_marshallIn(SFc12_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static void c12_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c12_mxArrayInData, const char_T *c12_varName, void *c12_outData);
static void c12_g_emlrt_marshallIn(SFc12_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c12_b_dataWrittenToVector, const char_T *c12_identifier,
  boolean_T c12_y[20]);
static void c12_h_emlrt_marshallIn(SFc12_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId, boolean_T c12_y
  [20]);
static const mxArray *c12_i_emlrt_marshallIn(SFc12_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c12_b_setSimStateSideEffectsInfo, const char_T *
  c12_identifier);
static const mxArray *c12_j_emlrt_marshallIn(SFc12_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c12_u, const emlrtMsgIdentifier *c12_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc12_kaiguangaiInstanceStruct
  *chartInstance, int32_T c12_ssid);
static void c12_init_sf_message_store_memory(SFc12_kaiguangaiInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc12_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc12_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc12_kaiguangai(chartInstance);
  ...
  *chartInstance->c12_is_active_c12_kaiguangai = 0U;
  *chartInstance->c12_is_c12_kaiguangai = c12_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc12_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c12_is_c12_kaiguangai == c12_IN_off1) {
...
static void ext_mode_exec_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct
  *chartInstance)
{
  c12_update_debugger_state_c12_kaiguangai(chartInstance);
}
  ...
  (SFc12_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  c12_u_hoistedGlobal = *chartInstance->c12_is_active_c12_kaiguangai;
  c12_v_y = NULL;
  ...
  c12_cb_hoistedGlobal = *chartInstance->c12_is_c12_kaiguangai;
  c12_db_y = NULL;
  ...
  *chartInstance, const mxArray *c12_st)
{
  ...
  *chartInstance->c12_is_active_c12_kaiguangai = c12_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c12_kaiguangai", c12_u,
       20)), "is_active_c12_kaiguangai");
  ...
  *chartInstance->c12_is_c12_kaiguangai = c12_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c12_kaiguangai", c12_u, 27)),
    "is_c12_kaiguangai");
...
static void sf_gateway_c12_kaiguangai(SFc12_kaiguangaiInstanceStruct
  *chartInstance)
{
  c12_set_sim_state_side_effects_c12_kaiguangai(chartInstance);
  ...
  *chartInstance->c12_sfEvent = CALL_EVENT;
  ...
  c12_chartstep_c12_kaiguangai(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c12_is_active_c12_kaiguangai == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 11U,
                 *chartInstance->c12_sfEvent);
    *chartInstance->c12_is_active_c12_kaiguangai = 1U;
    ...
    *chartInstance->c12_is_c12_kaiguangai = c12_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c12_sfEvent);
    ...
    *chartInstance->c12_yjyichang = 0.0;
    ...
    switch (*chartInstance->c12_is_c12_kaiguangai) {
     case c12_IN_off:
     ...
     case c12_IN_shoudong:
      ...
      if (c12_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c12_sfEvent);
        *chartInstance->c12_is_c12_kaiguangai = c12_IN_off1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c12_sfEvent);
...
static void c12_off(SFc12_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (c12_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c12_sfEvent);
    *chartInstance->c12_is_c12_kaiguangai = c12_IN_shoudong;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c12_sfEvent);
  ...
  *c12_inData)
{
  ...
  const mxArray *c12_y = NULL;
  SFc12_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc12_kaiguangaiInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c12_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c12_is_active_c12_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c12_is_c12_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c12_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c12_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c12_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c12_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c12_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c12_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c12_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c12_kaiguangai(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c12_kaiguangai\",},{M[8],M[1],T\"is_active_songkai\",},{M[8],M[32],T\"is_active_kaigai\",},{M[8],M[53],T\"is_active_suoding\",},{M[8],M[63],T\"is_active_jiesuo\",},{M[8],M[86],T\"is_active_guangai\",},{M[8],M[87],T\"is_active_yajin\",},{M[9],M[0],T\"is_c12_kaiguangai\",},{M[9],M[1],T\"is_songkai\",},{M[9],M[32],T\"is_kaigai\",}}",
  ...
  sf_c12_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc12_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc12_kaiguangaiInstanceStruct *chartInstance =
      (SFc12_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c12_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc12_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S);
  chart_debug_initialization(((SFc12_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c12_kaiguangai((SFc12_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c12_kaiguangai((SFc12_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c12_kaiguangai(void *chartInstanceVar)
{
  enable_c12_kaiguangai((SFc12_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c12_kaiguangai(void *chartInstanceVar)
{
  disable_c12_kaiguangai((SFc12_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c12_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c12_kaiguangai((SFc12_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c12_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c12_kaiguangai((SFc12_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c12_kaiguangai(SimStruct* S)
{
  return get_sim_state_c12_kaiguangai((SFc12_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c12_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c12_kaiguangai((SFc12_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c12_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc12_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c12_kaiguangai((SFc12_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc12_kaiguangai((SFc12_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c12_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c12_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c12_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c12_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c12_kaiguangai(SimStruct *S)
{
  SFc12_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc12_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc12_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc12_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c12_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c12_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c12_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c12_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c12_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c12_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c12_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c12_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c12_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c12_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c12_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c12_kaiguangai;
  ...
  mdl_start_c12_kaiguangai(chartInstance);
}

void c12_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c12_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c12_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c12_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c12_kaiguangai_method_dispatcher.\n"
