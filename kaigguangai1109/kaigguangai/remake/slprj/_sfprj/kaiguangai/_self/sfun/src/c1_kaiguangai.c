...
static void initialize_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void disable_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct
  *chartInstance);
static void ext_mode_exec_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct *
  chartInstance);
static void set_sim_state_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_kaiguangai
  (SFc1_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void sf_gateway_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void initSimStructsc1_kaiguangai(SFc1_kaiguangaiInstanceStruct
  *chartInstance);
static void c1_zidong(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_enter_atomic_chushihua(SFc1_kaiguangaiInstanceStruct
  *chartInstance);
static void c1_songkaishijian(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_start(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on10(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_songkaishijian1(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_yanchishijian1(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_tguiling(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_enter_atomic_on2(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on2(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_kaigaishijian(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_songkaishijian2(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on11(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_yanchishijian2(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_t2guiling(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_enter_atomic_on3(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on3(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_suodingshijian(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on7(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_songkaishijian3(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on12(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_yanchishijian3(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_t4guiling(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_enter_atomic_off(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on4(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_jiesuoshijian(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_songkaishijian4(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on14(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_yanchishijian4(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_t6guiling(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_enter_atomic_on5(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on5(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_guangaishijian(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_songkaishijian5(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on16(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_yanchishijian5(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_t8guiling(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_yanchishijian6(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_t10guiling(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_enter_atomic_on6(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on6(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_yajinshijian(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_songkaishijian6(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void c1_on18(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c1_nargout, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static boolean_T c1_c_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c1_b_is_zidong, const char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint16_T c1_g_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c1_b_temporalCounter_i1, const char_T
  *c1_identifier);
static uint16_T c1_h_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_i_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c1_b_dataWrittenToVector, const char_T *c1_identifier,
  boolean_T c1_y[27]);
static void c1_j_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, boolean_T c1_y[27]);
static const mxArray *c1_k_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c1_b_setSimStateSideEffectsInfo, const char_T
  *c1_identifier);
static const mxArray *c1_l_emlrt_marshallIn(SFc1_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc1_kaiguangaiInstanceStruct
  *chartInstance, int32_T c1_ssid);
static void c1_init_sf_message_store_memory(SFc1_kaiguangaiInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc1_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc1_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc1_kaiguangai(chartInstance);
  ...
  *chartInstance->c1_temporalCounter_i1 = 0U;
  *chartInstance->c1_temporalCounter_i1 = 0U;
  *chartInstance->c1_is_active_c1_kaiguangai = 0U;
  *chartInstance->c1_is_c1_kaiguangai = c1_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c1_is_active_c1_kaiguangai == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, *chartInstance->c1_sfEvent);
  }

  if (*chartInstance->c1_is_c1_kaiguangai == c1_IN_zidong) {
...
static void ext_mode_exec_c1_kaiguangai(SFc1_kaiguangaiInstanceStruct
  *chartInstance)
{
  c1_update_debugger_state_c1_kaiguangai(chartInstance);
}
  ...
  chartInstance)
{
  ...
  c1_cb_hoistedGlobal = *chartInstance->c1_is_active_c1_kaiguangai;
  c1_db_y = NULL;
  sf_mex_assign(&c1_db_y, sf_mex_create("y", &c1_cb_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c1_y, 27, c1_db_y);
  c1_db_hoistedGlobal = *chartInstance->c1_is_c1_kaiguangai;
  c1_eb_y = NULL;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *chartInstance->c1_is_active_c1_kaiguangai = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c1_kaiguangai", c1_u,
       27)), "is_active_c1_kaiguangai");
  *chartInstance->c1_is_c1_kaiguangai = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c1_kaiguangai", c1_u, 28)), "is_c1_kaiguangai");
  ...
  *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_kaiguangai(chartInstance);
  ...
  *chartInstance->c1_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c1_is_active_c1_kaiguangai == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_active_c1_kaiguangai = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, *chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 60U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_kaiguangai = c1_IN_zidong;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c1_sfEvent);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc1_kaiguangaiInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c1_is_c1_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c1_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c1_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c1_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c1_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c1_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_kaiguangai(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[373],T\"yjyichang\",},{M[3],M[59],T\"t\",},{M[3],M[344],T\"t10\",},{M[3],M[74],T\"t2\",},{M[3],M[104],T\"t4\",},{M[3],M[124],T\"t6\",},{M[3],M[168],T\"t8\",},{M[8],M[0],T\"is_active_c1_kaiguangai\",},{M[9],M[0],T\"is_c1_kaiguangai\",},{M[9],M[374],T\"is_zidong\",}}",
  ...
  sf_c1_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc1_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_kaiguangaiInstanceStruct *chartInstance =
      (SFc1_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c1_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc1_kaiguangaiInstanceStruct*) chartInstanceVar
    )->S);
  chart_debug_initialization(((SFc1_kaiguangaiInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c1_kaiguangai((SFc1_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c1_kaiguangai((SFc1_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_kaiguangai(void *chartInstanceVar)
{
  enable_c1_kaiguangai((SFc1_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_kaiguangai(void *chartInstanceVar)
{
  disable_c1_kaiguangai((SFc1_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c1_kaiguangai((SFc1_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c1_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c1_kaiguangai((SFc1_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_kaiguangai(SimStruct* S)
{
  return get_sim_state_c1_kaiguangai((SFc1_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c1_kaiguangai((SFc1_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c1_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c1_kaiguangai((SFc1_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_kaiguangai((SFc1_kaiguangaiInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c1_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c1_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c1_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_kaiguangai(SimStruct *S)
{
  SFc1_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc1_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc1_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc1_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c1_kaiguangai;
  ...
  mdl_start_c1_kaiguangai(chartInstance);
}

void c1_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_kaiguangai_method_dispatcher.\n"
