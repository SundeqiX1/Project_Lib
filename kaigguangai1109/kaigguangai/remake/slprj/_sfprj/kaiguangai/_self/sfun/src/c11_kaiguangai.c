...
static void initialize_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void disable_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_update_debugger_state_c11_kaiguangai
  (SFc11_kaiguangaiInstanceStruct *chartInstance);
static void ext_mode_exec_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c11_kaiguangai
  (SFc11_kaiguangaiInstanceStruct *chartInstance);
static void set_sim_state_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c11_st);
static void c11_set_sim_state_side_effects_c11_kaiguangai
  (SFc11_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct
  *chartInstance);
static void sf_gateway_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct
  *chartInstance);
static void c11_chartstep_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct
  *chartInstance);
static void initSimStructsc11_kaiguangai(SFc11_kaiguangaiInstanceStruct
  *chartInstance);
static void c11_off(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_exit_internal_shoudong(SFc11_kaiguangaiInstanceStruct
  *chartInstance);
static void c11_songkai(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_t(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_kaigai(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_enter_atomic_off(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_b_t(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_jiesuo(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_c_t(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_suoding(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_d_t(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_yajin(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_e_t(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_guangai(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_b_enter_atomic_off(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void c11_f_t(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c11_machineNumber, uint32_T
  c11_chartNumber, uint32_T c11_instanceNumber);
static const mxArray *c11_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static real_T c11_emlrt_marshallIn(SFc11_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c11_nargout, const char_T *c11_identifier);
static real_T c11_b_emlrt_marshallIn(SFc11_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static const mxArray *c11_b_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static boolean_T c11_c_emlrt_marshallIn(SFc11_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static const mxArray *c11_c_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static int32_T c11_d_emlrt_marshallIn(SFc11_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
...
static const mxArray *c11_d_sf_marshallOut(void *chartInstanceVoid, void
  *c11_inData);
static uint8_T c11_e_emlrt_marshallIn(SFc11_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c11_b_is_songkai, const char_T *c11_identifier);
static uint8_T c11_f_emlrt_marshallIn(SFc11_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static void c11_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c11_mxArrayInData, const char_T *c11_varName, void *c11_outData);
static void c11_g_emlrt_marshallIn(SFc11_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c11_b_dataWrittenToVector, const char_T *c11_identifier,
  boolean_T c11_y[20]);
static void c11_h_emlrt_marshallIn(SFc11_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId, boolean_T c11_y
  [20]);
static const mxArray *c11_i_emlrt_marshallIn(SFc11_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c11_b_setSimStateSideEffectsInfo, const char_T *
  c11_identifier);
static const mxArray *c11_j_emlrt_marshallIn(SFc11_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc11_kaiguangaiInstanceStruct
  *chartInstance, int32_T c11_ssid);
static void c11_init_sf_message_store_memory(SFc11_kaiguangaiInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc11_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc11_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc11_kaiguangai(chartInstance);
  ...
  *chartInstance->c11_is_active_c11_kaiguangai = 0U;
  *chartInstance->c11_is_c11_kaiguangai = c11_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc11_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c11_is_c11_kaiguangai == c11_IN_off1) {
...
static void ext_mode_exec_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct
  *chartInstance)
{
  c11_update_debugger_state_c11_kaiguangai(chartInstance);
}
  ...
  (SFc11_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  c11_u_hoistedGlobal = *chartInstance->c11_is_active_c11_kaiguangai;
  c11_v_y = NULL;
  ...
  c11_cb_hoistedGlobal = *chartInstance->c11_is_c11_kaiguangai;
  c11_db_y = NULL;
  ...
  *chartInstance, const mxArray *c11_st)
{
  ...
  *chartInstance->c11_is_active_c11_kaiguangai = c11_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c11_kaiguangai", c11_u,
       20)), "is_active_c11_kaiguangai");
  ...
  *chartInstance->c11_is_c11_kaiguangai = c11_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c11_kaiguangai", c11_u, 27)),
    "is_c11_kaiguangai");
...
static void sf_gateway_c11_kaiguangai(SFc11_kaiguangaiInstanceStruct
  *chartInstance)
{
  c11_set_sim_state_side_effects_c11_kaiguangai(chartInstance);
  ...
  *chartInstance->c11_sfEvent = CALL_EVENT;
  ...
  c11_chartstep_c11_kaiguangai(chartInstance);
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c11_is_active_c11_kaiguangai == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 10U,
                 *chartInstance->c11_sfEvent);
    *chartInstance->c11_is_active_c11_kaiguangai = 1U;
    ...
    *chartInstance->c11_is_c11_kaiguangai = c11_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c11_sfEvent);
    ...
    *chartInstance->c11_yjyichang = 0.0;
    ...
    switch (*chartInstance->c11_is_c11_kaiguangai) {
     case c11_IN_off:
     ...
     case c11_IN_shoudong:
      ...
      if (c11_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c11_sfEvent);
        *chartInstance->c11_is_c11_kaiguangai = c11_IN_off1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c11_sfEvent);
...
static void c11_off(SFc11_kaiguangaiInstanceStruct *chartInstance)
{
  ...
  if (c11_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c11_sfEvent);
    *chartInstance->c11_is_c11_kaiguangai = c11_IN_shoudong;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c11_sfEvent);
  ...
  *c11_inData)
{
  ...
  const mxArray *c11_y = NULL;
  SFc11_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc11_kaiguangaiInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c11_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c11_is_active_c11_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c11_is_c11_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c11_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c11_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c11_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c11_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c11_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c11_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c11_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c11_kaiguangai(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c11_kaiguangai\",},{M[8],M[1],T\"is_active_songkai\",},{M[8],M[32],T\"is_active_kaigai\",},{M[8],M[53],T\"is_active_suoding\",},{M[8],M[63],T\"is_active_jiesuo\",},{M[8],M[86],T\"is_active_guangai\",},{M[8],M[87],T\"is_active_yajin\",},{M[9],M[0],T\"is_c11_kaiguangai\",},{M[9],M[1],T\"is_songkai\",},{M[9],M[32],T\"is_kaigai\",}}",
  ...
  sf_c11_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc11_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc11_kaiguangaiInstanceStruct *chartInstance =
      (SFc11_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c11_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc11_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S);
  chart_debug_initialization(((SFc11_kaiguangaiInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c11_kaiguangai((SFc11_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c11_kaiguangai((SFc11_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c11_kaiguangai(void *chartInstanceVar)
{
  enable_c11_kaiguangai((SFc11_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c11_kaiguangai(void *chartInstanceVar)
{
  disable_c11_kaiguangai((SFc11_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c11_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c11_kaiguangai((SFc11_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c11_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c11_kaiguangai((SFc11_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c11_kaiguangai(SimStruct* S)
{
  return get_sim_state_c11_kaiguangai((SFc11_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c11_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c11_kaiguangai((SFc11_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c11_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc11_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c11_kaiguangai((SFc11_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc11_kaiguangai((SFc11_kaiguangaiInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c11_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c11_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c11_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c11_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c11_kaiguangai(SimStruct *S)
{
  SFc11_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc11_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc11_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc11_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c11_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c11_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c11_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c11_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c11_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c11_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c11_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c11_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c11_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c11_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c11_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c11_kaiguangai;
  ...
  mdl_start_c11_kaiguangai(chartInstance);
}

void c11_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c11_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c11_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c11_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c11_kaiguangai_method_dispatcher.\n"
