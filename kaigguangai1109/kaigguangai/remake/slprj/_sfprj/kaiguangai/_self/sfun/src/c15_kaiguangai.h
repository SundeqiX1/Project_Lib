#ifndef __c15_kaiguangai_h__
#define __c15_kaiguangai_h__
...
/* Type Definitions */
#ifndef typedef_SFc15_kaiguangaiInstanceStruct
#define typedef_SFc15_kaiguangaiInstanceStruct
...
typedef struct {
  ...
  int32_T *c15_sfEvent;
  uint8_T *c15_is_active_c15_kaiguangai;
  uint8_T *c15_is_c15_kaiguangai;
  uint8_T *c15_is_songkai;
  uint8_T *c15_is_active_songkai;
  uint8_T *c15_is_kaigai;
  uint8_T *c15_is_active_kaigai;
  uint8_T *c15_is_jiesuo;
  uint8_T *c15_is_active_jiesuo;
  uint8_T *c15_is_suoding;
  uint8_T *c15_is_active_suoding;
...
#endif                                 /*typedef_SFc15_kaiguangaiInstanceStruct*/
...
extern const mxArray *sf_c15_kaiguangai_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c15_kaiguangai_get_check_sum(mxArray *plhs[]);
extern void c15_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void
  *data);
