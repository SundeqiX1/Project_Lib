...
static void initialize_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct
  *chartInstance);
static void initialize_params_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct
  *chartInstance);
static void enable_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void disable_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct
  *chartInstance);
static void ext_mode_exec_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct *
  chartInstance);
static void set_sim_state_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c7_st);
static void c7_set_sim_state_side_effects_c7_kaiguangai
  (SFc7_kaiguangaiInstanceStruct *chartInstance);
static void finalize_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void sf_gateway_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct
  *chartInstance);
static void mdl_start_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void initSimStructsc7_kaiguangai(SFc7_kaiguangaiInstanceStruct
  *chartInstance);
static void c7_zidong(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_enter_atomic_chushihua(SFc7_kaiguangaiInstanceStruct
  *chartInstance);
static void c7_songkaishijian(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_start(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on10(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_songkaishijian1(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_yanchishijian1(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_tguiling(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_enter_atomic_on2(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on2(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_kaigaishijian(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_songkaishijian2(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on11(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_yanchishijian2(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_t2guiling(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_enter_atomic_on3(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on3(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_suodingshijian(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on7(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_songkaishijian3(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on12(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_yanchishijian3(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_t4guiling(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_enter_atomic_off(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on4(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_jiesuoshijian(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_songkaishijian4(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on14(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_yanchishijian4(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_t6guiling(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_enter_atomic_on5(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on5(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_guangaishijian(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_songkaishijian5(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on16(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_yanchishijian5(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_t8guiling(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_yanchishijian6(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_t10guiling(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_enter_atomic_on6(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on6(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_yajinshijian(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_songkaishijian6(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void c7_on18(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber, uint32_T c7_instanceNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c7_nargout, const char_T *c7_identifier);
static real_T c7_b_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static boolean_T c7_c_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_c_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_d_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static uint8_T c7_e_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c7_b_is_zidong, const char_T *c7_identifier);
static uint8_T c7_f_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint16_T c7_g_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c7_b_temporalCounter_i1, const char_T
  *c7_identifier);
static uint16_T c7_h_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_i_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c7_b_dataWrittenToVector, const char_T *c7_identifier,
  boolean_T c7_y[27]);
static void c7_j_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct *chartInstance,
  const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId, boolean_T c7_y[27]);
static const mxArray *c7_k_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c7_b_setSimStateSideEffectsInfo, const char_T
  *c7_identifier);
static const mxArray *c7_l_emlrt_marshallIn(SFc7_kaiguangaiInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc7_kaiguangaiInstanceStruct
  *chartInstance, int32_T c7_ssid);
static void c7_init_sf_message_store_memory(SFc7_kaiguangaiInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc7_kaiguangaiInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc7_kaiguangaiInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc7_kaiguangai(chartInstance);
  ...
  *chartInstance->c7_temporalCounter_i1 = 0U;
  *chartInstance->c7_temporalCounter_i1 = 0U;
  *chartInstance->c7_is_active_c7_kaiguangai = 0U;
  *chartInstance->c7_is_c7_kaiguangai = c7_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c7_is_active_c7_kaiguangai == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 6U, *chartInstance->c7_sfEvent);
  }

  if (*chartInstance->c7_is_c7_kaiguangai == c7_IN_zidong) {
...
static void ext_mode_exec_c7_kaiguangai(SFc7_kaiguangaiInstanceStruct
  *chartInstance)
{
  c7_update_debugger_state_c7_kaiguangai(chartInstance);
}
  ...
  chartInstance)
{
  ...
  c7_cb_hoistedGlobal = *chartInstance->c7_is_active_c7_kaiguangai;
  c7_db_y = NULL;
  sf_mex_assign(&c7_db_y, sf_mex_create("y", &c7_cb_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c7_y, 27, c7_db_y);
  c7_db_hoistedGlobal = *chartInstance->c7_is_c7_kaiguangai;
  c7_eb_y = NULL;
  ...
  *chartInstance, const mxArray *c7_st)
{
  ...
  *chartInstance->c7_is_active_c7_kaiguangai = c7_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c7_kaiguangai", c7_u,
       27)), "is_active_c7_kaiguangai");
  *chartInstance->c7_is_c7_kaiguangai = c7_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c7_kaiguangai", c7_u, 28)), "is_c7_kaiguangai");
  ...
  *chartInstance)
{
  ...
  c7_set_sim_state_side_effects_c7_kaiguangai(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc7_kaiguangaiInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_kaiguangai_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c7_is_c7_kaiguangai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c7_kaiguangai_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c7_kaiguangai_get_post_codegen_info(void);
mxArray *sf_c7_kaiguangai_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c7_kaiguangai_get_post_codegen_info();
...
mxArray *sf_c7_kaiguangai_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_kaiguangai_jit_fallback_info(void)
{
...
mxArray *sf_c7_kaiguangai_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_kaiguangai(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[373],T\"yjyichang\",},{M[3],M[59],T\"t\",},{M[3],M[344],T\"t10\",},{M[3],M[74],T\"t2\",},{M[3],M[104],T\"t4\",},{M[3],M[124],T\"t6\",},{M[3],M[168],T\"t8\",},{M[8],M[0],T\"is_active_c7_kaiguangai\",},{M[9],M[0],T\"is_c7_kaiguangai\",},{M[9],M[374],T\"is_zidong\",}}",
  ...
  sf_c7_kaiguangai_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc7_kaiguangaiInstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc7_kaiguangaiInstanceStruct *chartInstance =
      (SFc7_kaiguangaiInstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c7_kaiguangai(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc7_kaiguangaiInstanceStruct*) chartInstanceVar
    )->S);
  chart_debug_initialization(((SFc7_kaiguangaiInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c7_kaiguangai((SFc7_kaiguangaiInstanceStruct*)
    chartInstanceVar);
  initialize_c7_kaiguangai((SFc7_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c7_kaiguangai(void *chartInstanceVar)
{
  enable_c7_kaiguangai((SFc7_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c7_kaiguangai(void *chartInstanceVar)
{
  disable_c7_kaiguangai((SFc7_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c7_kaiguangai(void *chartInstanceVar)
{
  sf_gateway_c7_kaiguangai((SFc7_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c7_kaiguangai(void *chartInstanceVar)
{
  ext_mode_exec_c7_kaiguangai((SFc7_kaiguangaiInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c7_kaiguangai(SimStruct* S)
{
  return get_sim_state_c7_kaiguangai((SFc7_kaiguangaiInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c7_kaiguangai(SimStruct* S, const mxArray
  *st)
{
  set_sim_state_c7_kaiguangai((SFc7_kaiguangaiInstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c7_kaiguangai(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_kaiguangaiInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai_optimization_info();
    }

    finalize_c7_kaiguangai((SFc7_kaiguangaiInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc7_kaiguangai((SFc7_kaiguangaiInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_kaiguangai(SimStruct *S)
{
  int i;
...
mxArray *sf_c7_kaiguangai_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c7_kaiguangai(SimStruct *S)
{
...
static void mdlRTW_c7_kaiguangai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_kaiguangai(SimStruct *S)
{
  SFc7_kaiguangaiInstanceStruct *chartInstance;
  chartInstance = (SFc7_kaiguangaiInstanceStruct *)utMalloc(sizeof
    (SFc7_kaiguangaiInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc7_kaiguangaiInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c7_kaiguangai;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c7_kaiguangai;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c7_kaiguangai;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_kaiguangai;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_kaiguangai;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c7_kaiguangai;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c7_kaiguangai;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c7_kaiguangai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_kaiguangai;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_kaiguangai;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c7_kaiguangai;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c7_kaiguangai;
  ...
  mdl_start_c7_kaiguangai(chartInstance);
}

void c7_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_kaiguangai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_kaiguangai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_kaiguangai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_kaiguangai_method_dispatcher.\n"
