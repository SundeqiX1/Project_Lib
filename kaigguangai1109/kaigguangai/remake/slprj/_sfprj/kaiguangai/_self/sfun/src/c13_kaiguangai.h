#ifndef __c13_kaiguangai_h__
#define __c13_kaiguangai_h__
...
/* Type Definitions */
#ifndef typedef_SFc13_kaiguangaiInstanceStruct
#define typedef_SFc13_kaiguangaiInstanceStruct
...
typedef struct {
  ...
  int32_T *c13_sfEvent;
  uint8_T *c13_is_active_c13_kaiguangai;
  uint8_T *c13_is_c13_kaiguangai;
  uint8_T *c13_is_songkai;
  uint8_T *c13_is_active_songkai;
  uint8_T *c13_is_kaigai;
  uint8_T *c13_is_active_kaigai;
  uint8_T *c13_is_jiesuo;
  uint8_T *c13_is_active_jiesuo;
  uint8_T *c13_is_suoding;
  uint8_T *c13_is_active_suoding;
...
#endif                                 /*typedef_SFc13_kaiguangaiInstanceStruct*/
...
extern const mxArray *sf_c13_kaiguangai_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c13_kaiguangai_get_check_sum(mxArray *plhs[]);
extern void c13_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void
  *data);
