#ifndef __c24_kaiguangai_h__
#define __c24_kaiguangai_h__
...
/* Type Definitions */
#ifndef typedef_SFc24_kaiguangaiInstanceStruct
#define typedef_SFc24_kaiguangaiInstanceStruct
...
typedef struct {
  ...
  int32_T *c24_sfEvent;
  uint8_T *c24_is_active_c24_kaiguangai;
  uint8_T *c24_is_c24_kaiguangai;
...
#endif                                 /*typedef_SFc24_kaiguangaiInstanceStruct*/
...
extern const mxArray *sf_c24_kaiguangai_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c24_kaiguangai_get_check_sum(mxArray *plhs[]);
extern void c24_kaiguangai_method_dispatcher(SimStruct *S, int_T method, void
  *data);
