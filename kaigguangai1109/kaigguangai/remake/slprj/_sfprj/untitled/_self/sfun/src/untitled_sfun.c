  ...
  chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==25) {
    c25_untitled_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (!strcmp(machineName, "untitled")) {
    ...
    switch (chartFileNumber) {
     case 25:
      {
        extern mxArray *sf_c25_untitled_get_testpoint_info(void);
        plhs[0] = sf_c25_untitled_get_testpoint_info();
        break;
      }
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
       ...
       case 25:
        {
          ...
          sf_c25_untitled_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4063437492U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1248806897U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2956590142U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2308020270U);
  }
     ...
     case 25:
      {
        if (strcmp(aiChksum, "7aXoMmjEjklrUYuYq69FIG") == 0) {
          extern mxArray *sf_c25_untitled_get_autoinheritance_info(void);
          plhs[0] = sf_c25_untitled_get_autoinheritance_info();
          break;
        }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 25:
      {
        extern const mxArray *sf_c25_untitled_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c25_untitled_get_eml_resolved_functions_info();
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 25:
      {
        if (strcmp(tpChksum, "sWIcLOdzMDu52IuoLUv2VjH") == 0) {
          extern mxArray *sf_c25_untitled_third_party_uses_info(void);
          plhs[0] = sf_c25_untitled_third_party_uses_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 25:
      {
        if (strcmp(tpChksum, "sWIcLOdzMDu52IuoLUv2VjH") == 0) {
          extern mxArray *sf_c25_untitled_jit_fallback_info(void);
          plhs[0] = sf_c25_untitled_jit_fallback_info();
          break;
        }
      }
...

  {
    ...
    switch (chartFileNumber) {
     case 25:
      {
        if (strcmp(tpChksum, "sWIcLOdzMDu52IuoLUv2VjH") == 0) {
          extern mxArray *sf_c25_untitled_updateBuildInfo_args_info(void);
          plhs[0] = sf_c25_untitled_updateBuildInfo_args_info();
          break;
        }
      }
