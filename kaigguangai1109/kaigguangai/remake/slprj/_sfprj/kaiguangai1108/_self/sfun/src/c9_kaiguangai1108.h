#ifndef __c9_kaiguangai1108_h__
#define __c9_kaiguangai1108_h__
...
/* Type Definitions */
#ifndef typedef_SFc9_kaiguangai1108InstanceStruct
#define typedef_SFc9_kaiguangai1108InstanceStruct
...
typedef struct {
  ...
  int32_T *c9_sfEvent;
  uint8_T *c9_is_active_c9_kaiguangai1108;
  uint8_T *c9_is_c9_kaiguangai1108;
  uint8_T *c9_is_songkai;
  uint8_T *c9_is_active_songkai;
  uint8_T *c9_is_kaigai;
  uint8_T *c9_is_active_kaigai;
  uint8_T *c9_is_jiesuo_songkai;
  uint8_T *c9_is_active_jiesuo_songkai;
  uint8_T *c9_is_suoding_yajin;
  uint8_T *c9_is_active_suoding_yajin;
  uint8_T *c9_is_yajin;
...
#endif                                 /*typedef_SFc9_kaiguangai1108InstanceStruct*/
...
extern const mxArray *sf_c9_kaiguangai1108_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c9_kaiguangai1108_get_check_sum(mxArray *plhs[]);
extern void c9_kaiguangai1108_method_dispatcher(SimStruct *S, int_T method, void
  *data);
