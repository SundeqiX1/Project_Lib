...
static void initialize_c24_kaiguangai1108(SFc24_kaiguangai1108InstanceStruct
  *chartInstance);
static void initialize_params_c24_kaiguangai1108
  (SFc24_kaiguangai1108InstanceStruct *chartInstance);
static void enable_c24_kaiguangai1108(SFc24_kaiguangai1108InstanceStruct
  *chartInstance);
static void disable_c24_kaiguangai1108(SFc24_kaiguangai1108InstanceStruct
  *chartInstance);
static void c24_update_debugger_state_c24_kaiguangai1108
  (SFc24_kaiguangai1108InstanceStruct *chartInstance);
static void ext_mode_exec_c24_kaiguangai1108(SFc24_kaiguangai1108InstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c24_kaiguangai1108
  (SFc24_kaiguangai1108InstanceStruct *chartInstance);
static void set_sim_state_c24_kaiguangai1108(SFc24_kaiguangai1108InstanceStruct *
  chartInstance, const mxArray *c24_st);
static void c24_set_sim_state_side_effects_c24_kaiguangai1108
  (SFc24_kaiguangai1108InstanceStruct *chartInstance);
static void finalize_c24_kaiguangai1108(SFc24_kaiguangai1108InstanceStruct
  *chartInstance);
static void sf_gateway_c24_kaiguangai1108(SFc24_kaiguangai1108InstanceStruct
  *chartInstance);
static void mdl_start_c24_kaiguangai1108(SFc24_kaiguangai1108InstanceStruct
  *chartInstance);
static void initSimStructsc24_kaiguangai1108(SFc24_kaiguangai1108InstanceStruct *
  chartInstance);
static void c24_MANUAL(SFc24_kaiguangai1108InstanceStruct *chartInstance);
static void c24_exit_internal_MANUAL(SFc24_kaiguangai1108InstanceStruct
  *chartInstance);
...
static const mxArray *c24_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static int32_T c24_emlrt_marshallIn(SFc24_kaiguangai1108InstanceStruct
...
static const mxArray *c24_b_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static uint8_T c24_b_emlrt_marshallIn(SFc24_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c24_b_is_kaigai, const char_T *c24_identifier);
static uint8_T c24_c_emlrt_marshallIn(SFc24_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
...
static const mxArray *c24_c_sf_marshallOut(void *chartInstanceVoid, void
  *c24_inData);
static real_T c24_d_emlrt_marshallIn(SFc24_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c24_b_skhx, const char_T *c24_identifier);
static real_T c24_e_emlrt_marshallIn(SFc24_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static void c24_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c24_mxArrayInData, const char_T *c24_varName, void *c24_outData);
static uint16_T c24_f_emlrt_marshallIn(SFc24_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c24_b_temporalCounter_i1, const char_T
  *c24_identifier);
static uint16_T c24_g_emlrt_marshallIn(SFc24_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static const mxArray *c24_h_emlrt_marshallIn(SFc24_kaiguangai1108InstanceStruct *
  chartInstance, const mxArray *c24_b_setSimStateSideEffectsInfo, const char_T
  *c24_identifier);
static const mxArray *c24_i_emlrt_marshallIn(SFc24_kaiguangai1108InstanceStruct *
  chartInstance, const mxArray *c24_u, const emlrtMsgIdentifier *c24_parentId);
static const mxArray *sf_get_hover_data_for_msg
  (SFc24_kaiguangai1108InstanceStruct *chartInstance, int32_T c24_ssid);
static void c24_init_sf_message_store_memory(SFc24_kaiguangai1108InstanceStruct *
  chartInstance);
static uint16_T c24__u16_s32_(SFc24_kaiguangai1108InstanceStruct *chartInstance,
  int32_T c24_b, uint32_T c24_ssid_src_loc, int32_T c24_offset_src_loc, int32_T
  c24_length_src_loc);
static void init_dsm_address_info(SFc24_kaiguangai1108InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc24_kaiguangai1108InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc24_kaiguangai1108(chartInstance);
  ...
  *chartInstance->c24_is_active_c24_kaiguangai1108 = 0U;
  *chartInstance->c24_is_c24_kaiguangai1108 = c24_IN_NO_ACTIVE_CHILD;
  ...
  (SFc24_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c24_is_active_c24_kaiguangai1108 == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 23U, *chartInstance->c24_sfEvent);
  }

  if (*chartInstance->c24_is_c24_kaiguangai1108 == c24_IN_MANUAL) {
...
static void ext_mode_exec_c24_kaiguangai1108(SFc24_kaiguangai1108InstanceStruct *
  chartInstance)
{
  c24_update_debugger_state_c24_kaiguangai1108(chartInstance);
}
  ...
  (SFc24_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  c24_e_hoistedGlobal = *chartInstance->c24_is_active_c24_kaiguangai1108;
  c24_f_y = NULL;
  ...
  c24_l_hoistedGlobal = *chartInstance->c24_is_c24_kaiguangai1108;
  c24_m_y = NULL;
  ...
  chartInstance, const mxArray *c24_st)
{
  ...
  *chartInstance->c24_is_active_c24_kaiguangai1108 = c24_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c24_kaiguangai1108",
       c24_u, 4)), "is_active_c24_kaiguangai1108");
  ...
  *chartInstance->c24_is_active_jiesuo = c24_b_emlrt_marshallIn(chartInstance,
    ...
    "is_active_jiesuo");
  *chartInstance->c24_is_c24_kaiguangai1108 = c24_b_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_c24_kaiguangai1108", c24_u, 11)),
     "is_c24_kaiguangai1108");
  ...
  (SFc24_kaiguangai1108InstanceStruct *chartInstance)
{
  if (chartInstance->c24_doSetSimStateSideEffects != 0) {
    if ((*chartInstance->c24_is_c24_kaiguangai1108 == c24_IN_on1) && (sf_mex_sub
  ...
  *chartInstance)
{
  ...
  boolean_T c24_temp;
  boolean_T c24_b_out;
  c24_set_sim_state_side_effects_c24_kaiguangai1108(chartInstance);
  ...
  *chartInstance->c24_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c24_is_active_c24_kaiguangai1108 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 23U,
                 *chartInstance->c24_sfEvent);
    *chartInstance->c24_is_active_c24_kaiguangai1108 = 1U;
    ...
    *chartInstance->c24_is_c24_kaiguangai1108 = c24_IN_off1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 20U, *chartInstance->c24_sfEvent);
  } else {
    switch (*chartInstance->c24_is_c24_kaiguangai1108) {
     case c24_IN_MANUAL:
     ...
     case c24_IN_off1:
      ...
      if (c24_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 20U, *chartInstance->c24_sfEvent);
        *chartInstance->c24_is_c24_kaiguangai1108 = c24_IN_on1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 21U, *chartInstance->c24_sfEvent);
        *chartInstance->c24_temporalCounter_i1 = 0U;
        *chartInstance->c24_skhx = 0.0;
     ...
     case c24_IN_on1:
      ...
      if (c24_b_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 21U, *chartInstance->c24_sfEvent);
        *chartInstance->c24_is_c24_kaiguangai1108 = c24_IN_MANUAL;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c24_sfEvent);
...
static void c24_MANUAL(SFc24_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  if (c24_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c24_sfEvent);
    *chartInstance->c24_is_c24_kaiguangai1108 = c24_IN_end;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 19U, *chartInstance->c24_sfEvent);
    *chartInstance->c24_skhx = 0.0;
...
const mxArray *sf_c24_kaiguangai1108_get_eml_resolved_functions_info(void)
{
  ...
  *c24_inData)
{
  ...
  const mxArray *c24_y = NULL;
  SFc24_kaiguangai1108InstanceStruct *chartInstance;
  chartInstance = (SFc24_kaiguangai1108InstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance)
{
  ...
  chartInstance->c24_is_active_c24_kaiguangai1108 = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 1);
  chartInstance->c24_is_c24_kaiguangai1108 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c24_kaiguangai1108_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c24_kaiguangai1108_get_post_codegen_info(void);
mxArray *sf_c24_kaiguangai1108_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c24_kaiguangai1108_get_post_codegen_info();
...
mxArray *sf_c24_kaiguangai1108_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c24_kaiguangai1108_jit_fallback_info(void)
{
...
mxArray *sf_c24_kaiguangai1108_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c24_kaiguangai1108(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[258],T\"gghx\",},{M[1],M[259],T\"kghx\",},{M[1],M[260],T\"skhx\",},{M[1],M[261],T\"yjhx\",},{M[8],M[0],T\"is_active_c24_kaiguangai1108\",},{M[8],M[7],T\"is_active_kaigai\",},{M[8],M[202],T\"is_active_guangai\",},{M[8],M[208],T\"is_active_songkai\",},{M[8],M[214],T\"is_active_yajin\",},{M[8],M[243],T\"is_active_suoding\",}}",
    "100 S1x9'type','srcId','name','auxInfo'{{M[8],M[246],T\"is_active_jiesuo\",},{M[9],M[0],T\"is_c24_kaiguangai1108\",},{M[9],M[7],T\"is_kaigai\",},{M[9],M[202],T\"is_guangai\",},{M[9],M[208],T\"is_songkai\",},{M[9],M[214],T\"is_yajin\",},{M[9],M[243],T\"is_suoding\",},{M[9],M[246],T\"is_jiesuo\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M[1],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 19, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c24_kaiguangai1108_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc24_kaiguangai1108InstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc24_kaiguangai1108InstanceStruct *chartInstance =
      (SFc24_kaiguangai1108InstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c24_kaiguangai1108(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc24_kaiguangai1108InstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc24_kaiguangai1108InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c24_kaiguangai1108((SFc24_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
  initialize_c24_kaiguangai1108((SFc24_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c24_kaiguangai1108(void *chartInstanceVar)
{
  enable_c24_kaiguangai1108((SFc24_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c24_kaiguangai1108(void *chartInstanceVar)
{
  disable_c24_kaiguangai1108((SFc24_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c24_kaiguangai1108(void *chartInstanceVar)
{
  sf_gateway_c24_kaiguangai1108((SFc24_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c24_kaiguangai1108(void *chartInstanceVar)
{
  ext_mode_exec_c24_kaiguangai1108((SFc24_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c24_kaiguangai1108(SimStruct* S)
{
  return get_sim_state_c24_kaiguangai1108((SFc24_kaiguangai1108InstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c24_kaiguangai1108(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c24_kaiguangai1108((SFc24_kaiguangai1108InstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c24_kaiguangai1108(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc24_kaiguangai1108InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai1108_optimization_info();
    }

    finalize_c24_kaiguangai1108((SFc24_kaiguangai1108InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc24_kaiguangai1108((SFc24_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c24_kaiguangai1108(SimStruct *S)
{
  int i;
...
mxArray *sf_c24_kaiguangai1108_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c24_kaiguangai1108(SimStruct *S)
{
...
static void mdlRTW_c24_kaiguangai1108(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c24_kaiguangai1108(SimStruct *S)
{
  SFc24_kaiguangai1108InstanceStruct *chartInstance;
  chartInstance = (SFc24_kaiguangai1108InstanceStruct *)utMalloc(sizeof
    (SFc24_kaiguangai1108InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc24_kaiguangai1108InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c24_kaiguangai1108;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c24_kaiguangai1108;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c24_kaiguangai1108;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c24_kaiguangai1108;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c24_kaiguangai1108;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c24_kaiguangai1108;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c24_kaiguangai1108;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c24_kaiguangai1108;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c24_kaiguangai1108;
  chartInstance->chartInfo.mdlStart = mdlStart_c24_kaiguangai1108;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c24_kaiguangai1108;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c24_kaiguangai1108;
  ...
  mdl_start_c24_kaiguangai1108(chartInstance);
}

void c24_kaiguangai1108_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c24_kaiguangai1108(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c24_kaiguangai1108(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c24_kaiguangai1108(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c24_kaiguangai1108_method_dispatcher.\n"
