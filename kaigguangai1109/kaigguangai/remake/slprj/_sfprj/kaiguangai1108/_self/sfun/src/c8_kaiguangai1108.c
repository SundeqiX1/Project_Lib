...
static void initialize_c8_kaiguangai1108(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
static void initialize_params_c8_kaiguangai1108
  (SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void enable_c8_kaiguangai1108(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
static void disable_c8_kaiguangai1108(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
static void c8_update_debugger_state_c8_kaiguangai1108
  (SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void ext_mode_exec_c8_kaiguangai1108(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c8_kaiguangai1108
  (SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void set_sim_state_c8_kaiguangai1108(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_st);
static void c8_set_sim_state_side_effects_c8_kaiguangai1108
  (SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void finalize_c8_kaiguangai1108(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
static void sf_gateway_c8_kaiguangai1108(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
static void mdl_start_c8_kaiguangai1108(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
static void initSimStructsc8_kaiguangai1108(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
static void c8_zidong(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_enter_atomic_chushihua(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
static void c8_songkaishijian(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_start(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on10(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_songkaishijian1(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_yanchishijian1(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_tguiling(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_enter_atomic_on2(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on2(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_kaigaishijian(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_songkaishijian2(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on11(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_yanchishijian2(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_t2guiling(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_enter_atomic_on3(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on3(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_suodingshijian(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on7(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_songkaishijian3(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on12(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_yanchishijian3(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_t4guiling(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_enter_atomic_off(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on4(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_jiesuoshijian(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_songkaishijian4(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on14(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_yanchishijian4(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_t6guiling(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_enter_atomic_on5(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on5(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_guangaishijian(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_songkaishijian5(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on16(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_yanchishijian5(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_t8guiling(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_yanchishijian6(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_t10guiling(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_enter_atomic_on6(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on6(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_yajinshijian(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_songkaishijian6(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void c8_on18(SFc8_kaiguangai1108InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber, uint32_T c8_instanceNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_nargout, const char_T *c8_identifier);
static real_T c8_b_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static boolean_T c8_c_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_d_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static uint8_T c8_e_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_b_is_zidong, const char_T *c8_identifier);
static uint8_T c8_f_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint16_T c8_g_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_b_temporalCounter_i1, const char_T
  *c8_identifier);
static uint16_T c8_h_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_i_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_b_dataWrittenToVector, const char_T
  *c8_identifier, boolean_T c8_y[27]);
static void c8_j_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  boolean_T c8_y[27]);
static const mxArray *c8_k_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_b_setSimStateSideEffectsInfo, const char_T
  *c8_identifier);
static const mxArray *c8_l_emlrt_marshallIn(SFc8_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static const mxArray *sf_get_hover_data_for_msg
  (SFc8_kaiguangai1108InstanceStruct *chartInstance, int32_T c8_ssid);
static void c8_init_sf_message_store_memory(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc8_kaiguangai1108InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc8_kaiguangai1108(chartInstance);
  ...
  *chartInstance->c8_temporalCounter_i1 = 0U;
  *chartInstance->c8_temporalCounter_i1 = 0U;
  *chartInstance->c8_is_active_c8_kaiguangai1108 = 0U;
  *chartInstance->c8_is_c8_kaiguangai1108 = c8_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc8_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c8_is_active_c8_kaiguangai1108 == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 7U, *chartInstance->c8_sfEvent);
  }

  if (*chartInstance->c8_is_c8_kaiguangai1108 == c8_IN_zidong) {
...
static void ext_mode_exec_c8_kaiguangai1108(SFc8_kaiguangai1108InstanceStruct
  *chartInstance)
{
  c8_update_debugger_state_c8_kaiguangai1108(chartInstance);
}
  ...
  (SFc8_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  c8_cb_hoistedGlobal = *chartInstance->c8_is_active_c8_kaiguangai1108;
  c8_db_y = NULL;
  sf_mex_assign(&c8_db_y, sf_mex_create("y", &c8_cb_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c8_y, 27, c8_db_y);
  c8_db_hoistedGlobal = *chartInstance->c8_is_c8_kaiguangai1108;
  c8_eb_y = NULL;
  ...
  *chartInstance, const mxArray *c8_st)
{
  ...
  *chartInstance->c8_is_active_c8_kaiguangai1108 = c8_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c8_kaiguangai1108",
       c8_u, 27)), "is_active_c8_kaiguangai1108");
  *chartInstance->c8_is_c8_kaiguangai1108 = c8_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c8_kaiguangai1108", c8_u, 28)),
    "is_c8_kaiguangai1108");
  ...
  *chartInstance)
{
  ...
  c8_set_sim_state_side_effects_c8_kaiguangai1108(chartInstance);
  ...
  *chartInstance->c8_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c8_is_active_c8_kaiguangai1108 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 7U, *chartInstance->c8_sfEvent);
    *chartInstance->c8_is_active_c8_kaiguangai1108 = 1U;
    ...
    *chartInstance->c8_is_c8_kaiguangai1108 = c8_IN_zidong;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c8_sfEvent);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_kaiguangai1108InstanceStruct *chartInstance;
  chartInstance = (SFc8_kaiguangai1108InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_kaiguangai1108_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_kaiguangai1108 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c8_is_c8_kaiguangai1108 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
...
void sf_c8_kaiguangai1108_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c8_kaiguangai1108_get_post_codegen_info(void);
mxArray *sf_c8_kaiguangai1108_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c8_kaiguangai1108_get_post_codegen_info();
...
mxArray *sf_c8_kaiguangai1108_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c8_kaiguangai1108_jit_fallback_info(void)
{
...
mxArray *sf_c8_kaiguangai1108_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_kaiguangai1108(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[373],T\"yjyichang\",},{M[3],M[59],T\"t\",},{M[3],M[344],T\"t10\",},{M[3],M[74],T\"t2\",},{M[3],M[104],T\"t4\",},{M[3],M[124],T\"t6\",},{M[3],M[168],T\"t8\",},{M[8],M[0],T\"is_active_c8_kaiguangai1108\",},{M[9],M[0],T\"is_c8_kaiguangai1108\",},{M[9],M[374],T\"is_zidong\",}}",
  ...
  sf_c8_kaiguangai1108_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc8_kaiguangai1108InstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_kaiguangai1108InstanceStruct *chartInstance =
      (SFc8_kaiguangai1108InstanceStruct *)sf_get_chart_instance_ptr(S);
...
static void sf_opaque_initialize_c8_kaiguangai1108(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc8_kaiguangai1108InstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc8_kaiguangai1108InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_kaiguangai1108((SFc8_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
  initialize_c8_kaiguangai1108((SFc8_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_kaiguangai1108(void *chartInstanceVar)
{
  enable_c8_kaiguangai1108((SFc8_kaiguangai1108InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c8_kaiguangai1108(void *chartInstanceVar)
{
  disable_c8_kaiguangai1108((SFc8_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_kaiguangai1108(void *chartInstanceVar)
{
  sf_gateway_c8_kaiguangai1108((SFc8_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c8_kaiguangai1108(void *chartInstanceVar)
{
  ext_mode_exec_c8_kaiguangai1108((SFc8_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c8_kaiguangai1108(SimStruct* S)
{
  return get_sim_state_c8_kaiguangai1108((SFc8_kaiguangai1108InstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c8_kaiguangai1108(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c8_kaiguangai1108((SFc8_kaiguangai1108InstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c8_kaiguangai1108(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_kaiguangai1108InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai1108_optimization_info();
    }

    finalize_c8_kaiguangai1108((SFc8_kaiguangai1108InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_kaiguangai1108((SFc8_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_kaiguangai1108(SimStruct *S)
{
  int i;
...
mxArray *sf_c8_kaiguangai1108_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c8_kaiguangai1108(SimStruct *S)
{
...
static void mdlRTW_c8_kaiguangai1108(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_kaiguangai1108(SimStruct *S)
{
  SFc8_kaiguangai1108InstanceStruct *chartInstance;
  chartInstance = (SFc8_kaiguangai1108InstanceStruct *)utMalloc(sizeof
    (SFc8_kaiguangai1108InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc8_kaiguangai1108InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_kaiguangai1108;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_kaiguangai1108;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_kaiguangai1108;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_kaiguangai1108;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_kaiguangai1108;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_kaiguangai1108;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_kaiguangai1108;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_kaiguangai1108;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_kaiguangai1108;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_kaiguangai1108;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c8_kaiguangai1108;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c8_kaiguangai1108;
  ...
  mdl_start_c8_kaiguangai1108(chartInstance);
}

void c8_kaiguangai1108_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_kaiguangai1108(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_kaiguangai1108(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_kaiguangai1108(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_kaiguangai1108_method_dispatcher.\n"
