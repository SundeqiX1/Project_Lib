...
static void initialize_c1_kaiguangai1108(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
static void initialize_params_c1_kaiguangai1108
  (SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void enable_c1_kaiguangai1108(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
static void disable_c1_kaiguangai1108(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_kaiguangai1108
  (SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void ext_mode_exec_c1_kaiguangai1108(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_kaiguangai1108
  (SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void set_sim_state_c1_kaiguangai1108(SFc1_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_kaiguangai1108
  (SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void finalize_c1_kaiguangai1108(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
static void sf_gateway_c1_kaiguangai1108(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
static void mdl_start_c1_kaiguangai1108(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
static void initSimStructsc1_kaiguangai1108(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
static void c1_zidong(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_enter_atomic_chushihua(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
static void c1_songkaishijian(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_start(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on10(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_songkaishijian1(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_yanchishijian1(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_tguiling(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_enter_atomic_on2(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on2(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_kaigaishijian(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_songkaishijian2(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on11(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_yanchishijian2(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_t2guiling(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_enter_atomic_on3(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on3(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_suodingshijian(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on7(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_songkaishijian3(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on12(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_yanchishijian3(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_t4guiling(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_enter_atomic_off(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on4(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_jiesuoshijian(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_songkaishijian4(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on14(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_yanchishijian4(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_t6guiling(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_enter_atomic_on5(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on5(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_guangaishijian(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_songkaishijian5(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on16(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_yanchishijian5(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_t8guiling(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_yanchishijian6(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_enter_atomic_on6(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on6(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_yajinshijian(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_songkaishijian6(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_on18(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void c1_t10guiling(SFc1_kaiguangai1108InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c1_nargout, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static boolean_T c1_c_emlrt_marshallIn(SFc1_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c1_b_is_zidong, const char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_g_emlrt_marshallIn(SFc1_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c1_b_dataWrittenToVector, const char_T
  *c1_identifier, boolean_T c1_y[27]);
static void c1_h_emlrt_marshallIn(SFc1_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  boolean_T c1_y[27]);
static const mxArray *c1_i_emlrt_marshallIn(SFc1_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c1_b_setSimStateSideEffectsInfo, const char_T
  *c1_identifier);
static const mxArray *c1_j_emlrt_marshallIn(SFc1_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static const mxArray *sf_get_hover_data_for_msg
  (SFc1_kaiguangai1108InstanceStruct *chartInstance, int32_T c1_ssid);
static void c1_init_sf_message_store_memory(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc1_kaiguangai1108InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc1_kaiguangai1108(chartInstance);
  ...
  *chartInstance->c1_temporalCounter_i1 = 0U;
  *chartInstance->c1_temporalCounter_i1 = 0U;
  *chartInstance->c1_is_active_c1_kaiguangai1108 = 0U;
  *chartInstance->c1_is_c1_kaiguangai1108 = c1_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c1_is_active_c1_kaiguangai1108 == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, *chartInstance->c1_sfEvent);
  }

  if (*chartInstance->c1_is_c1_kaiguangai1108 == c1_IN_zidong) {
...
static void ext_mode_exec_c1_kaiguangai1108(SFc1_kaiguangai1108InstanceStruct
  *chartInstance)
{
  c1_update_debugger_state_c1_kaiguangai1108(chartInstance);
}
  ...
  (SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  c1_cb_hoistedGlobal = *chartInstance->c1_is_active_c1_kaiguangai1108;
  c1_db_y = NULL;
  sf_mex_assign(&c1_db_y, sf_mex_create("y", &c1_cb_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c1_y, 27, c1_db_y);
  c1_db_hoistedGlobal = *chartInstance->c1_is_c1_kaiguangai1108;
  c1_eb_y = NULL;
  ...
  c1_gb_y = NULL;
  sf_mex_assign(&c1_gb_y, sf_mex_create("y", &c1_fb_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *chartInstance->c1_is_active_c1_kaiguangai1108 = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c1_kaiguangai1108",
       c1_u, 27)), "is_active_c1_kaiguangai1108");
  *chartInstance->c1_is_c1_kaiguangai1108 = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c1_kaiguangai1108", c1_u, 28)),
    "is_c1_kaiguangai1108");
  ...
  *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_kaiguangai1108(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c1_t1, 17U, 1U, 0U,
                        *chartInstance->c1_sfEvent, false);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c1_skdw, 16U, 1U, 0U,
                        *chartInstance->c1_sfEvent, false);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c1_yjdw, 15U, 1U, 0U,
                        *chartInstance->c1_sfEvent, false);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c1_jsdw, 14U, 1U, 0U,
                        *chartInstance->c1_sfEvent, false);
  ...
  *chartInstance->c1_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c1_is_active_c1_kaiguangai1108 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_active_c1_kaiguangai1108 = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, *chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 60U, *chartInstance->c1_sfEvent);
    *chartInstance->c1_is_c1_kaiguangai1108 = c1_IN_zidong;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c1_sfEvent);
...
static void c1_songkaishijian(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  c1_out = CV_EML_IF(50, 0, 0, CV_RELATIONAL_EVAL(5U, 50U, 0,
    *chartInstance->c1_skt, 2000.0, -1, 3U, *chartInstance->c1_skt <= 2000.0));
  _SFD_SYMBOL_SCOPE_POP();
  guard1 = false;
  if (c1_out) {
  ...
  if (guard1) {
    ...
    c1_b_out = CV_EML_IF(51, 0, 0, CV_RELATIONAL_EVAL(5U, 51U, 0,
      *chartInstance->c1_skt, 2000.0, -1, 4U, *chartInstance->c1_skt > 2000.0));
    _SFD_SYMBOL_SCOPE_POP();
    if (c1_b_out) {
...
static void c1_yanchishijian1(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_out, 2U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  c1_out = CV_EML_IF(5, 0, 0, *chartInstance->c1_temporalCounter_i1 >= 1);
  _SFD_SYMBOL_SCOPE_POP();
  guard1 = false;
  if (c1_out) {
...
static void c1_kaigaishijian(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  c1_out = CV_EML_IF(58, 0, 0, CV_RELATIONAL_EVAL(5U, 58U, 0,
    *chartInstance->c1_kgt, 12000.0, -1, 4U, *chartInstance->c1_kgt > 12000.0));
  _SFD_SYMBOL_SCOPE_POP();
  if (c1_out) {
    ...
    *chartInstance->c1_kgyichang = 1.0;
    ...
    c1_b_out = CV_EML_IF(54, 0, 0, CV_RELATIONAL_EVAL(5U, 54U, 0,
      *chartInstance->c1_kgt, 12000.0, -1, 3U, *chartInstance->c1_kgt <= 12000.0));
    _SFD_SYMBOL_SCOPE_POP();
    guard1 = false;
    if (c1_b_out) {
...
static void c1_yanchishijian2(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_out, 2U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  c1_out = CV_EML_IF(8, 0, 0, *chartInstance->c1_temporalCounter_i1 >= 1);
  _SFD_SYMBOL_SCOPE_POP();
  guard1 = false;
  if (c1_out) {
...
static void c1_suodingshijian(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  c1_out = CV_EML_IF(67, 0, 0, CV_RELATIONAL_EVAL(5U, 67U, 0,
    *chartInstance->c1_sdt, 2000.0, -1, 4U, *chartInstance->c1_sdt > 2000.0));
  _SFD_SYMBOL_SCOPE_POP();
  if (c1_out) {
    ...
    *chartInstance->c1_sdyichang = 1.0;
    ...
    c1_b_out = CV_EML_IF(62, 0, 0, CV_RELATIONAL_EVAL(5U, 62U, 0,
      *chartInstance->c1_sdt, 2000.0, -1, 3U, *chartInstance->c1_sdt <= 2000.0));
    _SFD_SYMBOL_SCOPE_POP();
    guard1 = false;
    if (c1_b_out) {
...
static void c1_yanchishijian3(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_out, 2U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  c1_out = CV_EML_IF(15, 0, 0, *chartInstance->c1_temporalCounter_i1 >= 1);
  _SFD_SYMBOL_SCOPE_POP();
  guard1 = false;
  if (c1_out) {
...
static void c1_jiesuoshijian(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  c1_out = CV_EML_IF(69, 0, 0, CV_RELATIONAL_EVAL(5U, 69U, 0,
    *chartInstance->c1_jst, 2000.0, -1, 4U, *chartInstance->c1_jst > 2000.0));
  _SFD_SYMBOL_SCOPE_POP();
  if (c1_out) {
    ...
    *chartInstance->c1_jsyichang = 1.0;
    ...
    c1_b_out = CV_EML_IF(73, 0, 0, CV_RELATIONAL_EVAL(5U, 73U, 0,
      *chartInstance->c1_jst, 2000.0, -1, 3U, *chartInstance->c1_jst <= 2000.0));
    _SFD_SYMBOL_SCOPE_POP();
    guard1 = false;
    if (c1_b_out) {
...
static void c1_yanchishijian4(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_out, 2U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  c1_out = CV_EML_IF(25, 0, 0, *chartInstance->c1_temporalCounter_i1 >= 1);
  _SFD_SYMBOL_SCOPE_POP();
  guard1 = false;
  if (c1_out) {
...
static void c1_guangaishijian(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  c1_out = CV_EML_IF(77, 0, 0, CV_RELATIONAL_EVAL(5U, 77U, 0,
    *chartInstance->c1_ggt, 12000.0, -1, 4U, *chartInstance->c1_ggt > 12000.0));
  _SFD_SYMBOL_SCOPE_POP();
  if (c1_out) {
    ...
    *chartInstance->c1_ggyichang = 1.0;
    ...
    c1_b_out = CV_EML_IF(75, 0, 0, CV_RELATIONAL_EVAL(5U, 75U, 0,
      *chartInstance->c1_ggt, 12000.0, -1, 3U, *chartInstance->c1_ggt <= 12000.0));
    _SFD_SYMBOL_SCOPE_POP();
    guard1 = false;
    if (c1_b_out) {
...
static void c1_yanchishijian5(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_out, 2U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  c1_out = CV_EML_IF(32, 0, 0, *chartInstance->c1_temporalCounter_i1 >= 1);
  _SFD_SYMBOL_SCOPE_POP();
  guard1 = false;
  if (c1_out) {
...
static void c1_yanchishijian6(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_out, 2U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  c1_out = CV_EML_IF(48, 0, 0, *chartInstance->c1_temporalCounter_i1 >= 1);
  _SFD_SYMBOL_SCOPE_POP();
  guard1 = false;
  if (c1_out) {
...
static void c1_yajinshijian(SFc1_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  c1_out = CV_EML_IF(84, 0, 0, CV_RELATIONAL_EVAL(5U, 84U, 0,
    *chartInstance->c1_yjt, 2000.0, -1, 4U, *chartInstance->c1_yjt > 2000.0));
  _SFD_SYMBOL_SCOPE_POP();
  if (c1_out) {
    ...
    *chartInstance->c1_ggyichang = 1.0;
    ...
    c1_b_out = CV_EML_IF(85, 0, 0, CV_RELATIONAL_EVAL(5U, 85U, 0,
      *chartInstance->c1_yjt, 2000.0, -1, 3U, *chartInstance->c1_yjt <= 2000.0));
    _SFD_SYMBOL_SCOPE_POP();
    guard1 = false;
    if (c1_b_out) {
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_kaiguangai1108InstanceStruct *chartInstance;
  chartInstance = (SFc1_kaiguangai1108InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_kaiguangai1108_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_kaiguangai1108 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c1_is_c1_kaiguangai1108 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
  ...
  chartInstance->c1_yjyichang = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 21);
  chartInstance->c1_temporalCounter_i1 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 10);
}
...
void sf_c1_kaiguangai1108_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2408280301U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1444249834U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4059938126U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(391449040U);
}

mxArray* sf_c1_kaiguangai1108_get_post_codegen_info(void);
mxArray *sf_c1_kaiguangai1108_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Z1JOiPfgDmxNeGamMeLOsH");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_kaiguangai1108_get_post_codegen_info();
...
mxArray *sf_c1_kaiguangai1108_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_kaiguangai1108_jit_fallback_info(void)
{
...
mxArray *sf_c1_kaiguangai1108_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_kaiguangai1108(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[373],T\"yjyichang\",},{M[3],M[59],T\"t\",},{M[3],M[344],T\"t10\",},{M[3],M[74],T\"t2\",},{M[3],M[104],T\"t4\",},{M[3],M[124],T\"t6\",},{M[3],M[168],T\"t8\",},{M[8],M[0],T\"is_active_c1_kaiguangai1108\",},{M[9],M[0],T\"is_c1_kaiguangai1108\",},{M[9],M[374],T\"is_zidong\",}}",
  ...
  sf_c1_kaiguangai1108_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc1_kaiguangai1108InstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_kaiguangai1108InstanceStruct *chartInstance =
      (SFc1_kaiguangai1108InstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(14,1,1,0,"jsdw");
          _SFD_SET_DATA_PROPS(15,1,1,0,"yjdw");
          _SFD_SET_DATA_PROPS(16,1,1,0,"skdw");
        ...
        _SFD_CV_INIT_EML_RELATIONAL(50,0,0,1,10,-1,3);
        ...
        _SFD_CV_INIT_EML_IF(51,0,0,1,9,1,9);
        _SFD_CV_INIT_EML_RELATIONAL(51,0,0,1,9,-1,4);
        ...
        _SFD_CV_INIT_EML_IF(54,0,0,1,11,1,11);
        _SFD_CV_INIT_EML_RELATIONAL(54,0,0,1,11,-1,3);
        ...
        _SFD_CV_INIT_EML_IF(58,0,0,1,10,1,10);
        _SFD_CV_INIT_EML_RELATIONAL(58,0,0,1,10,-1,4);
        ...
        _SFD_CV_INIT_EML_IF(62,0,0,1,10,1,10);
        _SFD_CV_INIT_EML_RELATIONAL(62,0,0,1,10,-1,3);
        ...
        _SFD_CV_INIT_EML_IF(67,0,0,1,9,1,9);
        _SFD_CV_INIT_EML_RELATIONAL(67,0,0,1,9,-1,4);
        ...
        _SFD_CV_INIT_EML_IF(73,0,0,1,10,1,10);
        _SFD_CV_INIT_EML_RELATIONAL(73,0,0,1,10,-1,3);
        ...
        _SFD_CV_INIT_EML_IF(69,0,0,1,9,1,9);
        _SFD_CV_INIT_EML_RELATIONAL(69,0,0,1,9,-1,4);
        ...
        _SFD_CV_INIT_EML_IF(75,0,0,1,11,1,11);
        _SFD_CV_INIT_EML_RELATIONAL(75,0,0,1,11,-1,3);
        ...
        _SFD_CV_INIT_EML_IF(77,0,0,1,10,1,10);
        _SFD_CV_INIT_EML_RELATIONAL(77,0,0,1,10,-1,4);
        ...
        _SFD_CV_INIT_EML_IF(85,0,0,1,10,1,10);
        _SFD_CV_INIT_EML_RELATIONAL(85,0,0,1,10,-1,3);
        ...
        _SFD_CV_INIT_EML_IF(84,0,0,1,9,1,9);
        _SFD_CV_INIT_EML_RELATIONAL(84,0,0,1,9,-1,4);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      /* do this only if simulation is starting and after we know the addresses of all data */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(14U, chartInstance->c1_jsdw);
        _SFD_SET_DATA_VALUE_PTR(15U, chartInstance->c1_yjdw);
        _SFD_SET_DATA_VALUE_PTR(16U, chartInstance->c1_skdw);
...
{
  return "sHTWIqHd2QU2KdYDf63SsXF";
}
...
static void sf_opaque_initialize_c1_kaiguangai1108(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc1_kaiguangai1108InstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc1_kaiguangai1108InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_kaiguangai1108((SFc1_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
  initialize_c1_kaiguangai1108((SFc1_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_kaiguangai1108(void *chartInstanceVar)
{
  enable_c1_kaiguangai1108((SFc1_kaiguangai1108InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_kaiguangai1108(void *chartInstanceVar)
{
  disable_c1_kaiguangai1108((SFc1_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_kaiguangai1108(void *chartInstanceVar)
{
  sf_gateway_c1_kaiguangai1108((SFc1_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c1_kaiguangai1108(void *chartInstanceVar)
{
  ext_mode_exec_c1_kaiguangai1108((SFc1_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_kaiguangai1108(SimStruct* S)
{
  return get_sim_state_c1_kaiguangai1108((SFc1_kaiguangai1108InstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_kaiguangai1108(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c1_kaiguangai1108((SFc1_kaiguangai1108InstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c1_kaiguangai1108(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_kaiguangai1108InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai1108_optimization_info();
    }

    finalize_c1_kaiguangai1108((SFc1_kaiguangai1108InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_kaiguangai1108((SFc1_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_kaiguangai1108(SimStruct *S)
{
  int i;
...
mxArray *sf_c1_kaiguangai1108_get_testpoint_info(void)
{
  return NULL;
}
...
{
  static uint32_T checksum[4] = { 2942383659U, 3571026280U, 4247563030U,
    592169987U };

  return checksum;
}

static void mdlSetWorkWidths_c1_kaiguangai1108(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(894661061U));
  ssSetChecksum1(S,(85346357U));
  ssSetChecksum2(S,(3192605816U));
  ssSetChecksum3(S,(2736718354U));
...
static void mdlRTW_c1_kaiguangai1108(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_kaiguangai1108(SimStruct *S)
{
  SFc1_kaiguangai1108InstanceStruct *chartInstance;
  chartInstance = (SFc1_kaiguangai1108InstanceStruct *)utMalloc(sizeof
    (SFc1_kaiguangai1108InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc1_kaiguangai1108InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_kaiguangai1108;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_kaiguangai1108;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_kaiguangai1108;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_kaiguangai1108;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_kaiguangai1108;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_kaiguangai1108;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_kaiguangai1108;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_kaiguangai1108;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_kaiguangai1108;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_kaiguangai1108;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_kaiguangai1108;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c1_kaiguangai1108;
  ...
  mdl_start_c1_kaiguangai1108(chartInstance);
}

void c1_kaiguangai1108_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_kaiguangai1108(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_kaiguangai1108(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_kaiguangai1108(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_kaiguangai1108_method_dispatcher.\n"
