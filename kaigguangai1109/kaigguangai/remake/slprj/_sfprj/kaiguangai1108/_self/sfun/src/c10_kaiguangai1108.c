...
#define c10_IN_t2                      ((uint8_T)5U)
#define c10_b_IN_t2                    ((uint8_T)4U)
...
static const char * c10_ad_debug_family_names[3] = { "nargin", "nargout",
  "sf_internal_predicateOutput" };

/* Function Declarations */
static void initialize_c10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct
  *chartInstance);
static void initialize_params_c10_kaiguangai1108
  (SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void enable_c10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct
  *chartInstance);
static void disable_c10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct
  *chartInstance);
static void c10_update_debugger_state_c10_kaiguangai1108
  (SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void ext_mode_exec_c10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c10_kaiguangai1108
  (SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void set_sim_state_c10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct *
  chartInstance, const mxArray *c10_st);
static void c10_set_sim_state_side_effects_c10_kaiguangai1108
  (SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void finalize_c10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct
  *chartInstance);
static void sf_gateway_c10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct
  *chartInstance);
static void mdl_start_c10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct
  *chartInstance);
static void c10_chartstep_c10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct *
  chartInstance);
static void initSimStructsc10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct *
  chartInstance);
static void c10_off(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_exit_internal_shoudong(SFc10_kaiguangai1108InstanceStruct
  *chartInstance);
static void c10_songkai(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_t(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_kaigai(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_enter_atomic_off(SFc10_kaiguangai1108InstanceStruct
  *chartInstance);
static void c10_b_t(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_jiesuo_songkai(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_c_t(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_suoding_yajin(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_d_t(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_yajin(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_e_t(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_guangai(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void c10_b_enter_atomic_off(SFc10_kaiguangai1108InstanceStruct
  *chartInstance);
static void c10_f_t(SFc10_kaiguangai1108InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_emlrt_marshallIn(SFc10_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c10_nargout, const char_T *c10_identifier);
static real_T c10_b_emlrt_marshallIn(SFc10_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static boolean_T c10_c_emlrt_marshallIn(SFc10_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_d_emlrt_marshallIn(SFc10_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static uint8_T c10_e_emlrt_marshallIn(SFc10_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c10_b_is_songkai, const char_T *c10_identifier);
static uint8_T c10_f_emlrt_marshallIn(SFc10_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static void c10_g_emlrt_marshallIn(SFc10_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c10_b_dataWrittenToVector, const char_T
  *c10_identifier, boolean_T c10_y[20]);
static void c10_h_emlrt_marshallIn(SFc10_kaiguangai1108InstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId,
  boolean_T c10_y[20]);
static const mxArray *c10_i_emlrt_marshallIn(SFc10_kaiguangai1108InstanceStruct *
  chartInstance, const mxArray *c10_b_setSimStateSideEffectsInfo, const char_T
  *c10_identifier);
static const mxArray *c10_j_emlrt_marshallIn(SFc10_kaiguangai1108InstanceStruct *
  chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static const mxArray *sf_get_hover_data_for_msg
  (SFc10_kaiguangai1108InstanceStruct *chartInstance, int32_T c10_ssid);
static void c10_init_sf_message_store_memory(SFc10_kaiguangai1108InstanceStruct *
  chartInstance);
static void init_dsm_address_info(SFc10_kaiguangai1108InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc10_kaiguangai1108InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc10_kaiguangai1108(chartInstance);
  ...
  *chartInstance->c10_is_active_jiesuo_songkai = 0U;
  *chartInstance->c10_is_jiesuo_songkai = c10_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance->c10_is_active_suoding_yajin = 0U;
  *chartInstance->c10_is_suoding_yajin = c10_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance->c10_is_active_c10_kaiguangai1108 = 0U;
  *chartInstance->c10_is_c10_kaiguangai1108 = c10_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc10_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c10_is_songkai == c10_IN_t1) {
  ...
  if (*chartInstance->c10_is_yajin == c10_IN_t3) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 38U, *chartInstance->c10_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 38U, *chartInstance->c10_sfEvent);
  }

  if (*chartInstance->c10_is_yajin == c10_b_IN_t2) {
  ...
  if (*chartInstance->c10_is_guangai == c10_IN_t2) {
  ...
  if (*chartInstance->c10_is_c10_kaiguangai1108 == c10_IN_off1) {
...
static void ext_mode_exec_c10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct *
  chartInstance)
{
  c10_update_debugger_state_c10_kaiguangai1108(chartInstance);
}
  ...
  (SFc10_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  c10_u_hoistedGlobal = *chartInstance->c10_is_active_c10_kaiguangai1108;
  c10_v_y = NULL;
  ...
  c10_x_hoistedGlobal = *chartInstance->c10_is_active_suoding_yajin;
  c10_y_y = NULL;
  sf_mex_assign(&c10_y_y, sf_mex_create("y", &c10_x_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c10_y, 23, c10_y_y);
  c10_y_hoistedGlobal = *chartInstance->c10_is_active_jiesuo_songkai;
  c10_ab_y = NULL;
  ...
  c10_cb_hoistedGlobal = *chartInstance->c10_is_c10_kaiguangai1108;
  c10_db_y = NULL;
  ...
  c10_fb_hoistedGlobal = *chartInstance->c10_is_suoding_yajin;
  c10_gb_y = NULL;
  sf_mex_assign(&c10_gb_y, sf_mex_create("y", &c10_fb_hoistedGlobal, 3, 0U, 0U,
    0U, 0), false);
  sf_mex_setcell(c10_y, 30, c10_gb_y);
  c10_gb_hoistedGlobal = *chartInstance->c10_is_jiesuo_songkai;
  c10_hb_y = NULL;
  ...
  chartInstance, const mxArray *c10_st)
{
  ...
  *chartInstance->c10_is_active_c10_kaiguangai1108 = c10_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_c10_kaiguangai1108",
       c10_u, 20)), "is_active_c10_kaiguangai1108");
  ...
  *chartInstance->c10_is_active_kaigai = c10_e_emlrt_marshallIn(chartInstance,
    ...
    "is_active_kaigai");
  *chartInstance->c10_is_active_suoding_yajin = c10_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_suoding_yajin", c10_u,
       23)), "is_active_suoding_yajin");
  *chartInstance->c10_is_active_jiesuo_songkai = c10_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_active_jiesuo_songkai", c10_u,
  ...
  *chartInstance->c10_is_c10_kaiguangai1108 = c10_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell("is_c10_kaiguangai1108", c10_u, 27)),
     "is_c10_kaiguangai1108");
  ...
  *chartInstance->c10_is_suoding_yajin = c10_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_suoding_yajin", c10_u, 30)),
    "is_suoding_yajin");
  *chartInstance->c10_is_jiesuo_songkai = c10_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_jiesuo_songkai", c10_u, 31)),
    "is_jiesuo_songkai");
  ...
  (SFc10_kaiguangai1108InstanceStruct *chartInstance)
{
  if (chartInstance->c10_doSetSimStateSideEffects != 0) {
    ...
    if ((*chartInstance->c10_is_suoding_yajin == c10_IN_t) && (sf_mex_sub
         (chartInstance->c10_setSimStateSideEffectsInfo,
          "setSimStateSideEffectsInfo", 1, 20) == 0.0)) {
      *chartInstance->c10_temporalCounter_i4 = 0U;
    }

    if ((*chartInstance->c10_is_jiesuo_songkai == c10_IN_t) && (sf_mex_sub
         (chartInstance->c10_setSimStateSideEffectsInfo,
...
static void sf_gateway_c10_kaiguangai1108(SFc10_kaiguangai1108InstanceStruct
  *chartInstance)
{
  c10_set_sim_state_side_effects_c10_kaiguangai1108(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c10_b_guangai, 13U, 1U, 0U,
                        *chartInstance->c10_sfEvent, false);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c10_jiesuo, 12U, 1U, 0U,
                        *chartInstance->c10_sfEvent, false);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c10_suoding, 11U, 1U, 0U,
                        *chartInstance->c10_sfEvent, false);
  ...
  *chartInstance->c10_sfEvent = CALL_EVENT;
  ...
  c10_chartstep_c10_kaiguangai1108(chartInstance);
  ...
  chartInstance)
{
  ...
  if (*chartInstance->c10_is_active_c10_kaiguangai1108 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 9U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_active_c10_kaiguangai1108 = 1U;
    ...
    *chartInstance->c10_is_c10_kaiguangai1108 = c10_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c10_sfEvent);
    ...
    *chartInstance->c10_yjyichang = 0.0;
    ...
    switch (*chartInstance->c10_is_c10_kaiguangai1108) {
     case c10_IN_off:
      CV_CHART_EVAL(9, 0, 1);
     ...
     case c10_IN_shoudong:
      ...
      _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 38U,
                   *chartInstance->c10_sfEvent);
      _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 3U, 3U, c10_ad_debug_family_names,
      ...
      if (c10_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c10_sfEvent);
        *chartInstance->c10_is_c10_kaiguangai1108 = c10_IN_off1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c10_sfEvent);
        ...
        *chartInstance->c10_ggzhiling2 = 0.0;
        ...
        c10_suoding_yajin(chartInstance);
        c10_jiesuo_songkai(chartInstance);
...
static void c10_off(SFc10_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  if (c10_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_c10_kaiguangai1108 = c10_IN_shoudong;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c10_sfEvent);
    ...
    *chartInstance->c10_is_active_suoding_yajin = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 27U, *chartInstance->c10_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 12U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_suoding_yajin = c10_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 28U, *chartInstance->c10_sfEvent);
    ...
    *chartInstance->c10_yjhx = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c10_yjhx, 18U, 4U, 28U,
                          *chartInstance->c10_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
    *chartInstance->c10_is_active_jiesuo_songkai = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, *chartInstance->c10_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 18U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_jiesuo_songkai = c10_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 10U, *chartInstance->c10_sfEvent);
  ...
  *chartInstance)
{
  ...
  *chartInstance->c10_is_active_guangai = 0U;
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, *chartInstance->c10_sfEvent);
  switch (*chartInstance->c10_is_jiesuo_songkai) {
   case c10_IN_off:
    CV_STATE_EVAL(9, 1, 1);
    *chartInstance->c10_is_jiesuo_songkai = c10_IN_NO_ACTIVE_CHILD;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 10U, *chartInstance->c10_sfEvent);
  ...
  *chartInstance->c10_is_active_jiesuo_songkai = 0U;
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 9U, *chartInstance->c10_sfEvent);
  switch (*chartInstance->c10_is_suoding_yajin) {
   case c10_IN_off:
...
static void c10_songkai(SFc10_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  switch (*chartInstance->c10_is_songkai) {
   ...
   case c10_IN_on:
          ...
          *chartInstance->c10_skdw, 0.0, -1, 0U, *chartInstance->c10_skdw == 0.0)))
    {
      if (CV_EML_COND(3, 0, 1, CV_RELATIONAL_EVAL(5U, 3U, 1,
            *chartInstance->c10_skt, 2.0, -1, 3U, *chartInstance->c10_skt <= 2.0)))
      {
      ...
      *chartInstance->c10_skt += 0.002;
      ...
      if (CV_EML_COND(4, 0, 0, CV_RELATIONAL_EVAL(5U, 4U, 0,
        ...
        if (CV_EML_COND(4, 0, 1, CV_RELATIONAL_EVAL(5U, 4U, 1,
              *chartInstance->c10_skt, 2.0, -1, 3U, *chartInstance->c10_skt <=
              2.0))) {
    ...
    *chartInstance->c10_skt += 0.002;
    chartInstance->c10_dataWrittenToVector[8U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c10_skt, 24U, 4U, 26U,
                          *chartInstance->c10_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
   ...
   case c10_IN_t2:
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_b_out, 2U, c10_b_sf_marshallOut,
      c10_b_sf_marshallIn);
    c10_b_out = CV_EML_IF(41, 0, 0, CV_RELATIONAL_EVAL(5U, 41U, 0,
      *chartInstance->c10_skdw, 0.0, -1, 0U, *chartInstance->c10_skdw == 0.0));
    _SFD_SYMBOL_SCOPE_POP();
    if (c10_b_out) {
      ...
      *chartInstance->c10_skt += 0.002;
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_out, 2U, c10_b_sf_marshallOut,
        c10_b_sf_marshallIn);
      c10_d_out = CV_EML_IF(42, 0, 0, CV_RELATIONAL_EVAL(5U, 42U, 0,
...
static void c10_t(SFc10_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG, 5U, *chartInstance->c10_sfEvent);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_out, 2U, c10_b_sf_marshallOut,
    c10_b_sf_marshallIn);
  c10_out = CV_EML_IF(5, 0, 0, *chartInstance->c10_temporalCounter_i1 >= 1);
  _SFD_SYMBOL_SCOPE_POP();
  guard1 = false;
  if (c10_out) {
      ...
      *chartInstance->c10_skt += 0.002;
      ...
      if (c10_c_out) {
        ...
        *chartInstance->c10_skhx = 0.0;
        ...
        c10_d_out = CV_EML_IF(39, 0, 0, CV_RELATIONAL_EVAL(5U, 39U, 0,
          *chartInstance->c10_skt, 2.0, -1, 4U, *chartInstance->c10_skt > 2.0));
        _SFD_SYMBOL_SCOPE_POP();
        if (c10_d_out) {
          _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 39U, *chartInstance->c10_sfEvent);
...
static void c10_kaigai(SFc10_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  switch (*chartInstance->c10_is_kaigai) {
   ...
   case c10_IN_on:
    ...
    if (CV_EML_COND(10, 0, 0, CV_RELATIONAL_EVAL(5U, 10U, 0,
      ...
      if (CV_EML_COND(10, 0, 2, CV_RELATIONAL_EVAL(5U, 10U, 2,
            *chartInstance->c10_kgt, 12.0, -1, 3U, *chartInstance->c10_kgt <=
            12.0))) {
      ...
      *chartInstance->c10_kgt += 0.002;
      ...
      if (c10_e_out) {
        ...
        *chartInstance->c10_is_kaigai = c10_IN_off;
        ...
        c10_f_out = CV_EML_IF(44, 0, 0, CV_RELATIONAL_EVAL(5U, 44U, 0,
   ...
   case c10_IN_t1:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 19U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_kaigai = c10_IN_t2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 20U, *chartInstance->c10_sfEvent);
      ...
      *chartInstance->c10_kgt += 0.002;
      ...
      if (c10_c_out) {
        ...
        *chartInstance->c10_is_kaigai = c10_IN_off;
        ...
        c10_d_out = CV_EML_IF(44, 0, 0, CV_RELATIONAL_EVAL(5U, 44U, 0,
          *chartInstance->c10_kgt, 12.0, -1, 4U, *chartInstance->c10_kgt > 12.0));
        _SFD_SYMBOL_SCOPE_POP();
        if (c10_d_out) {
          _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 44U, *chartInstance->c10_sfEvent);
  ...
  switch (*chartInstance->c10_is_jiesuo_songkai) {
   case c10_IN_off:
    ...
    if (CV_EML_COND(22, 0, 0, CV_RELATIONAL_EVAL(5U, 22U, 0,
          *chartInstance->c10_jiesuo, 1.0, -1, 0U, *chartInstance->c10_jiesuo ==
          1.0)) && CV_EML_COND(22, 0, 1, CV_RELATIONAL_EVAL(5U, 22U, 1,
          *chartInstance->c10_sddw, 1.0, -1, 0U, *chartInstance->c10_sddw == 1.0)))
    {
    ...
    if (c10_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 10U, *chartInstance->c10_sfEvent);
      *chartInstance->c10_is_jiesuo_songkai = c10_IN_on;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 11U, *chartInstance->c10_sfEvent);
   ...
   case c10_IN_on:
          ...
          *chartInstance->c10_jsdw, 0.0, -1, 0U, *chartInstance->c10_jsdw == 0.0)))
    {
      if (CV_EML_COND(23, 0, 1, CV_RELATIONAL_EVAL(5U, 23U, 1,
            *chartInstance->c10_jst, 2.0, -1, 3U, *chartInstance->c10_jst <= 2.0)))
      {
    ...
    if (c10_c_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 11U, *chartInstance->c10_sfEvent);
      *chartInstance->c10_is_jiesuo_songkai = c10_IN_t;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 12U, *chartInstance->c10_sfEvent);
      *chartInstance->c10_temporalCounter_i3 = 0U;
      ...
      *chartInstance->c10_jst += 0.002;
      ...
      if (CV_EML_COND(19, 0, 0, CV_RELATIONAL_EVAL(5U, 19U, 0,
        ...
        if (CV_EML_COND(19, 0, 1, CV_RELATIONAL_EVAL(5U, 19U, 1,
              *chartInstance->c10_jst, 2.0, -1, 3U, *chartInstance->c10_jst <=
              2.0))) {
      ...
      if (c10_e_out) {
        ...
        *chartInstance->c10_skhx = 0.0;
        ...
        c10_f_out = CV_EML_IF(51, 0, 0, CV_RELATIONAL_EVAL(5U, 51U, 0,
          *chartInstance->c10_jst, 2.0, -1, 4U, *chartInstance->c10_jst > 2.0));
        _SFD_SYMBOL_SCOPE_POP();
        if (c10_f_out) {
          _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 51U, *chartInstance->c10_sfEvent);
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 11U, *chartInstance->c10_sfEvent);
          *chartInstance->c10_is_jiesuo_songkai = c10_IN_t1;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 13U, *chartInstance->c10_sfEvent);
   ...
   case c10_IN_t1:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 13U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_jiesuo_songkai = c10_IN_t2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 14U, *chartInstance->c10_sfEvent);
   ...
   case c10_IN_t2:
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_b_out, 2U, c10_b_sf_marshallOut,
      c10_b_sf_marshallIn);
    c10_b_out = CV_EML_IF(53, 0, 0, CV_RELATIONAL_EVAL(5U, 53U, 0,
      *chartInstance->c10_jsdw, 0.0, -1, 0U, *chartInstance->c10_jsdw == 0.0));
    _SFD_SYMBOL_SCOPE_POP();
    if (c10_b_out) {
      ...
      *chartInstance->c10_jst += 0.002;
      ...
      if (c10_c_out) {
        ...
        *chartInstance->c10_skhx = 0.0;
        ...
        c10_d_out = CV_EML_IF(51, 0, 0, CV_RELATIONAL_EVAL(5U, 51U, 0,
          *chartInstance->c10_jst, 2.0, -1, 4U, *chartInstance->c10_jst > 2.0));
        _SFD_SYMBOL_SCOPE_POP();
        if (c10_d_out) {
          _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 51U, *chartInstance->c10_sfEvent);
...
static void c10_suoding_yajin(SFc10_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  boolean_T guard1 = false;
  boolean_T guard2 = false;
  _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 27U, *chartInstance->c10_sfEvent);
  switch (*chartInstance->c10_is_suoding_yajin) {
   case c10_IN_off:
    ...
    if (CV_EML_COND(14, 0, 0, CV_RELATIONAL_EVAL(5U, 14U, 0,
          *chartInstance->c10_suoding, 1.0, -1, 0U, *chartInstance->c10_suoding ==
    ...
    if (c10_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 28U, *chartInstance->c10_sfEvent);
      *chartInstance->c10_is_suoding_yajin = c10_IN_on;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 29U, *chartInstance->c10_sfEvent);
      ...
      *chartInstance->c10_yjhx = 1.0;
      chartInstance->c10_dataWrittenToVector[2U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c10_yjhx, 18U, 4U, 29U,
                            *chartInstance->c10_sfEvent, false);
      *chartInstance->c10_sdyichang = 0.0;
      chartInstance->c10_dataWrittenToVector[16U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c10_sdyichang, 32U, 4U, 29U,
                            *chartInstance->c10_sfEvent, false);
      *chartInstance->c10_sdt = 0.0;
      chartInstance->c10_dataWrittenToVector[10U] = true;
   ...
   case c10_IN_on:
          ...
          *chartInstance->c10_sddw, 0.0, -1, 0U, *chartInstance->c10_sddw == 0.0)))
    {
      if (CV_EML_COND(15, 0, 1, CV_RELATIONAL_EVAL(5U, 15U, 1,
            *chartInstance->c10_sdt, 2.0, -1, 3U, *chartInstance->c10_sdt <= 2.0)))
      {
    ...
    if (c10_c_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 29U, *chartInstance->c10_sfEvent);
      *chartInstance->c10_is_suoding_yajin = c10_IN_t;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 30U, *chartInstance->c10_sfEvent);
      *chartInstance->c10_temporalCounter_i4 = 0U;
      ...
      *chartInstance->c10_sdt += 0.002;
      chartInstance->c10_dataWrittenToVector[10U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c10_sdt, 26U, 4U, 30U,
                            *chartInstance->c10_sfEvent, false);
      _SFD_SYMBOL_SCOPE_POP();
    } else {
      ...
      if (CV_EML_COND(13, 0, 0, CV_RELATIONAL_EVAL(5U, 13U, 0,
        ...
        if (CV_EML_COND(13, 0, 1, CV_RELATIONAL_EVAL(5U, 13U, 1,
              *chartInstance->c10_sdt, 2.0, -1, 3U, *chartInstance->c10_sdt <=
              2.0))) {
        ...
        *chartInstance->c10_yjhx = 0.0;
        ...
        if (c10_f_out) {
          ...
          *chartInstance->c10_sdyichang = 1.0;
          chartInstance->c10_dataWrittenToVector[16U] = true;
          _SFD_DATA_RANGE_CHECK(*chartInstance->c10_sdyichang, 32U, 4U, 31U,
                                *chartInstance->c10_sfEvent, false);
          _SFD_SYMBOL_SCOPE_POP();
        } else {
   ...
   case c10_IN_t1:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 31U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_suoding_yajin = c10_IN_t2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 32U, *chartInstance->c10_sfEvent);
    ...
    *chartInstance->c10_sdt += 0.002;
    chartInstance->c10_dataWrittenToVector[10U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c10_sdt, 26U, 4U, 32U,
                          *chartInstance->c10_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
   ...
   case c10_IN_t2:
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_b_out, 2U, c10_b_sf_marshallOut,
      c10_b_sf_marshallIn);
    c10_b_out = CV_EML_IF(47, 0, 0, CV_RELATIONAL_EVAL(5U, 47U, 0,
      *chartInstance->c10_sddw, 0.0, -1, 0U, *chartInstance->c10_sddw == 0.0));
    _SFD_SYMBOL_SCOPE_POP();
    if (c10_b_out) {
      ...
      *chartInstance->c10_sdt += 0.002;
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_out, 2U, c10_b_sf_marshallOut,
        c10_b_sf_marshallIn);
      c10_d_out = CV_EML_IF(49, 0, 0, CV_RELATIONAL_EVAL(5U, 49U, 0,
        *chartInstance->c10_sddw, 1.0, -1, 0U, *chartInstance->c10_sddw == 1.0));
      _SFD_SYMBOL_SCOPE_POP();
      if (c10_d_out) {
      ...
      *chartInstance->c10_sdt += 0.002;
      ...
      if (c10_c_out) {
        ...
        *chartInstance->c10_yjhx = 0.0;
        ...
        c10_d_out = CV_EML_IF(48, 0, 0, CV_RELATIONAL_EVAL(5U, 48U, 0,
          *chartInstance->c10_sdt, 2.0, -1, 4U, *chartInstance->c10_sdt > 2.0));
        _SFD_SYMBOL_SCOPE_POP();
        if (c10_d_out) {
          _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 48U, *chartInstance->c10_sfEvent);
...
static void c10_yajin(SFc10_kaiguangai1108InstanceStruct *chartInstance)
{
  ...
  boolean_T guard1 = false;
  boolean_T guard2 = false;
  _SFD_CS_CALL(STATE_ENTER_DURING_FUNCTION_TAG, 33U, *chartInstance->c10_sfEvent);
  switch (*chartInstance->c10_is_yajin) {
   case c10_IN_off:
    ...
    if (c10_out) {
      ...
      *chartInstance->c10_yjhx = 1.0;
      chartInstance->c10_dataWrittenToVector[2U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c10_yjhx, 18U, 4U, 35U,
                            *chartInstance->c10_sfEvent, false);
      *chartInstance->c10_yjyichang = 0.0;
      chartInstance->c10_dataWrittenToVector[19U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c10_yjyichang, 35U, 4U, 35U,
                            *chartInstance->c10_sfEvent, false);
      *chartInstance->c10_yjt = 0.0;
      chartInstance->c10_dataWrittenToVector[13U] = true;
   ...
   case c10_IN_on:
          ...
          *chartInstance->c10_yjdw, 0.0, -1, 0U, *chartInstance->c10_yjdw == 0.0)))
    {
      if (CV_EML_COND(34, 0, 1, CV_RELATIONAL_EVAL(5U, 34U, 1,
            *chartInstance->c10_yjt, 2.0, -1, 3U, *chartInstance->c10_yjt <= 2.0)))
      {
      ...
      *chartInstance->c10_yjt += 0.002;
      ...
      if (CV_EML_COND(31, 0, 0, CV_RELATIONAL_EVAL(5U, 31U, 0,
        ...
        if (CV_EML_COND(31, 0, 1, CV_RELATIONAL_EVAL(5U, 31U, 1,
          ...
          if (CV_EML_COND(31, 0, 2, CV_RELATIONAL_EVAL(5U, 31U, 2,
                *chartInstance->c10_yjt, 2.0, -1, 3U, *chartInstance->c10_yjt <=
                2.0))) {
      ...
      if (c10_e_out) {
        ...
        *chartInstance->c10_yjhx = 0.0;
        ...
        c10_f_out = CV_EML_IF(59, 0, 0, CV_RELATIONAL_EVAL(5U, 59U, 0,
          *chartInstance->c10_yjt, 2.0, -1, 4U, *chartInstance->c10_yjt > 2.0));
        _SFD_SYMBOL_SCOPE_POP();
        if (c10_f_out) {
          ...
          *chartInstance->c10_yjyichang = 1.0;
          chartInstance->c10_dataWrittenToVector[19U] = true;
          _SFD_DATA_RANGE_CHECK(*chartInstance->c10_yjyichang, 35U, 4U, 38U,
                                *chartInstance->c10_sfEvent, false);
          _SFD_SYMBOL_SCOPE_POP();
        } else {
   ...
   case c10_b_IN_t2:
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_b_out, 2U, c10_b_sf_marshallOut,
      c10_b_sf_marshallIn);
    c10_b_out = CV_EML_IF(61, 0, 0, CV_RELATIONAL_EVAL(5U, 61U, 0,
      *chartInstance->c10_yjdw, 0.0, -1, 0U, *chartInstance->c10_yjdw == 0.0));
    _SFD_SYMBOL_SCOPE_POP();
    if (c10_b_out) {
      _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 61U, *chartInstance->c10_sfEvent);
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 37U, *chartInstance->c10_sfEvent);
      *chartInstance->c10_is_yajin = c10_b_IN_t2;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 37U, *chartInstance->c10_sfEvent);
      ...
      *chartInstance->c10_yjt += 0.002;
      chartInstance->c10_dataWrittenToVector[13U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c10_yjt, 29U, 4U, 37U,
                            *chartInstance->c10_sfEvent, false);
      _SFD_SYMBOL_SCOPE_POP();
    } else {
      ...
      _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_out, 2U, c10_b_sf_marshallOut,
        c10_b_sf_marshallIn);
      c10_d_out = CV_EML_IF(62, 0, 0, CV_RELATIONAL_EVAL(5U, 62U, 0,
        *chartInstance->c10_yjdw, 1.0, -1, 0U, *chartInstance->c10_yjdw == 1.0));
      _SFD_SYMBOL_SCOPE_POP();
      if (c10_d_out) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 62U, *chartInstance->c10_sfEvent);
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 37U, *chartInstance->c10_sfEvent);
        *chartInstance->c10_is_yajin = c10_IN_off;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 34U, *chartInstance->c10_sfEvent);
        _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 2U, 2U, c10_v_debug_family_names,
    ...
    *chartInstance->c10_yjt += 0.002;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c10_yjt, 29U, 4U, 37U,
                          *chartInstance->c10_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
    _SFD_CS_CALL(EXIT_OUT_OF_FUNCTION_TAG, 38U, *chartInstance->c10_sfEvent);
    break;
      ...
      *chartInstance->c10_yjt += 0.002;
      ...
      if (c10_c_out) {
        ...
        *chartInstance->c10_yjhx = 0.0;
        ...
        c10_d_out = CV_EML_IF(59, 0, 0, CV_RELATIONAL_EVAL(5U, 59U, 0,
          *chartInstance->c10_yjt, 2.0, -1, 4U, *chartInstance->c10_yjt > 2.0));
        _SFD_SYMBOL_SCOPE_POP();
        if (c10_d_out) {
          _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 59U, *chartInstance->c10_sfEvent);
  ...
  switch (*chartInstance->c10_is_guangai) {
   case c10_IN_off:
    ...
    if (CV_EML_COND(26, 0, 0, CV_RELATIONAL_EVAL(5U, 26U, 0,
         ...
         CV_RELATIONAL_EVAL(5U, 26U, 1, *chartInstance->c10_kgdw1, 1.0, -1, 0U, *
                            chartInstance->c10_kgdw1 == 1.0)) && CV_EML_COND(26,
         0, 2, CV_RELATIONAL_EVAL(5U, 26U, 2, *chartInstance->c10_kgdw2, 1.0, -1,
   ...
   case c10_IN_on:
    ...
    if (CV_EML_COND(27, 0, 0, CV_RELATIONAL_EVAL(5U, 27U, 0,
      ...
      if (CV_EML_COND(27, 0, 2, CV_RELATIONAL_EVAL(5U, 27U, 2,
            *chartInstance->c10_ggt, 12.0, -1, 3U, *chartInstance->c10_ggt <=
            12.0))) {
      ...
      *chartInstance->c10_ggt += 0.002;
      ...
      if (c10_e_out) {
        ...
        *chartInstance->c10_is_guangai = c10_IN_off;
        ...
        c10_f_out = CV_EML_IF(55, 0, 0, CV_RELATIONAL_EVAL(5U, 55U, 0,
   ...
   case c10_IN_t1:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 7U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_guangai = c10_IN_t2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 8U, *chartInstance->c10_sfEvent);
      ...
      *chartInstance->c10_ggt += 0.002;
      ...
      if (c10_c_out) {
        ...
        *chartInstance->c10_is_guangai = c10_IN_off;
        ...
        c10_d_out = CV_EML_IF(55, 0, 0, CV_RELATIONAL_EVAL(5U, 55U, 0,
          *chartInstance->c10_ggt, 12.0, -1, 4U, *chartInstance->c10_ggt > 12.0));
        _SFD_SYMBOL_SCOPE_POP();
        if (c10_d_out) {
          _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 55U, *chartInstance->c10_sfEvent);
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_kaiguangai1108InstanceStruct *chartInstance;
  chartInstance = (SFc10_kaiguangai1108InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c10_kaiguangai1108_get_eml_resolved_functions_info(void)
{
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_kaiguangai1108 = (uint8_T *)
    ssGetDWork_wrapper(chartInstance->S, 1);
  chartInstance->c10_is_c10_kaiguangai1108 = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 2);
  ...
  chartInstance->c10_is_active_kaigai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 6);
  chartInstance->c10_is_jiesuo_songkai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 7);
  chartInstance->c10_is_active_jiesuo_songkai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 8);
  chartInstance->c10_is_suoding_yajin = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 9);
  chartInstance->c10_is_active_suoding_yajin = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 10);
  ...
  chartInstance->c10_b_kaigai = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 10);
  chartInstance->c10_suoding = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 11);
  chartInstance->c10_jiesuo = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 12);
...
void sf_c10_kaiguangai1108_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c10_kaiguangai1108_get_post_codegen_info(void);
mxArray *sf_c10_kaiguangai1108_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c10_kaiguangai1108_get_post_codegen_info();
...
mxArray *sf_c10_kaiguangai1108_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_kaiguangai1108_jit_fallback_info(void)
{
...
mxArray *sf_c10_kaiguangai1108_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c10_kaiguangai1108(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c10_kaiguangai1108\",},{M[8],M[1],T\"is_active_songkai\",},{M[8],M[32],T\"is_active_kaigai\",},{M[8],M[53],T\"is_active_suoding_yajin\",},{M[8],M[63],T\"is_active_jiesuo_songkai\",},{M[8],M[86],T\"is_active_guangai\",},{M[8],M[87],T\"is_active_yajin\",},{M[9],M[0],T\"is_c10_kaiguangai1108\",},{M[9],M[1],T\"is_songkai\",},{M[9],M[32],T\"is_kaigai\",}}",
  ...
  sf_c10_kaiguangai1108_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc10_kaiguangai1108InstanceStruct *)
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc10_kaiguangai1108InstanceStruct *chartInstance =
      (SFc10_kaiguangai1108InstanceStruct *)sf_get_chart_instance_ptr(S);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      /* do this only if simulation is starting and after we know the addresses of all data */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(11U, chartInstance->c10_suoding);
        _SFD_SET_DATA_VALUE_PTR(12U, chartInstance->c10_jiesuo);
...
static void sf_opaque_initialize_c10_kaiguangai1108(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc10_kaiguangai1108InstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc10_kaiguangai1108InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_kaiguangai1108((SFc10_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
  initialize_c10_kaiguangai1108((SFc10_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c10_kaiguangai1108(void *chartInstanceVar)
{
  enable_c10_kaiguangai1108((SFc10_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c10_kaiguangai1108(void *chartInstanceVar)
{
  disable_c10_kaiguangai1108((SFc10_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c10_kaiguangai1108(void *chartInstanceVar)
{
  sf_gateway_c10_kaiguangai1108((SFc10_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c10_kaiguangai1108(void *chartInstanceVar)
{
  ext_mode_exec_c10_kaiguangai1108((SFc10_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c10_kaiguangai1108(SimStruct* S)
{
  return get_sim_state_c10_kaiguangai1108((SFc10_kaiguangai1108InstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c10_kaiguangai1108(SimStruct* S, const
  mxArray *st)
{
  set_sim_state_c10_kaiguangai1108((SFc10_kaiguangai1108InstanceStruct*)
    sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c10_kaiguangai1108(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_kaiguangai1108InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_kaiguangai1108_optimization_info();
    }

    finalize_c10_kaiguangai1108((SFc10_kaiguangai1108InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc10_kaiguangai1108((SFc10_kaiguangai1108InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_kaiguangai1108(SimStruct *S)
{
  int i;
...
mxArray *sf_c10_kaiguangai1108_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c10_kaiguangai1108(SimStruct *S)
{
...
static void mdlRTW_c10_kaiguangai1108(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_kaiguangai1108(SimStruct *S)
{
  SFc10_kaiguangai1108InstanceStruct *chartInstance;
  chartInstance = (SFc10_kaiguangai1108InstanceStruct *)utMalloc(sizeof
    (SFc10_kaiguangai1108InstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc10_kaiguangai1108InstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_kaiguangai1108;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_kaiguangai1108;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_kaiguangai1108;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_kaiguangai1108;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_kaiguangai1108;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_kaiguangai1108;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_kaiguangai1108;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_kaiguangai1108;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_kaiguangai1108;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_kaiguangai1108;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c10_kaiguangai1108;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c10_kaiguangai1108;
  ...
  mdl_start_c10_kaiguangai1108(chartInstance);
}

void c10_kaiguangai1108_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_kaiguangai1108(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_kaiguangai1108(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_kaiguangai1108(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_kaiguangai1108_method_dispatcher.\n"
