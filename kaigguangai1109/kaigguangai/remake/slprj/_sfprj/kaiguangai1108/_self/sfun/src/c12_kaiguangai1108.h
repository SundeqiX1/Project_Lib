#ifndef __c12_kaiguangai1108_h__
#define __c12_kaiguangai1108_h__
...
/* Type Definitions */
#ifndef typedef_SFc12_kaiguangai1108InstanceStruct
#define typedef_SFc12_kaiguangai1108InstanceStruct
...
typedef struct {
  ...
  int32_T *c12_sfEvent;
  uint8_T *c12_is_active_c12_kaiguangai1108;
  uint8_T *c12_is_c12_kaiguangai1108;
  uint8_T *c12_is_songkai;
  uint8_T *c12_is_active_songkai;
  uint8_T *c12_is_kaigai;
  uint8_T *c12_is_active_kaigai;
  uint8_T *c12_is_jiesuo_songkai;
  uint8_T *c12_is_active_jiesuo_songkai;
  uint8_T *c12_is_suoding_yajin;
  uint8_T *c12_is_active_suoding_yajin;
...
#endif                                 /*typedef_SFc12_kaiguangai1108InstanceStruct*/
...
extern const mxArray *sf_c12_kaiguangai1108_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c12_kaiguangai1108_get_check_sum(mxArray *plhs[]);
extern void c12_kaiguangai1108_method_dispatcher(SimStruct *S, int_T method,
  void *data);
