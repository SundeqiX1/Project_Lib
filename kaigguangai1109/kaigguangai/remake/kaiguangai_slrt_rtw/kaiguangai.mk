...
MODEL           = kaiguangai
MODULES         = kaiguangai_capi.c kaiguangai_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = kaiguangai.mk
...
MODELLIB                  = kaiguangailib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = kaiguangai_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\kaiguangai_slrt_rtw
