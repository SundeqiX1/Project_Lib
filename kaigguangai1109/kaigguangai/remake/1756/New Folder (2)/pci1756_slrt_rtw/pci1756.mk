...
MODEL           = pci1756
MODULES         = pci1756_capi.c pci1756_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = pci1756.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = F:\矿大\项目组1\发射井地面总装联调\remake\1756\New Folder (2)
...
MODELLIB                  = pci1756lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = pci1756_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\pci1756_slrt_rtw
