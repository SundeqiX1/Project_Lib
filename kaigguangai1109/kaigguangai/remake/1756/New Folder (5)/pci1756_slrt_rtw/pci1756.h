...
#ifndef RTW_HEADER_pci1756_h_
#define RTW_HEADER_pci1756_h_
#include <stddef.h>
#include <string.h>
#include "rtw_modelmap.h"
#ifndef pci1756_COMMON_INCLUDES_
# define pci1756_COMMON_INCLUDES_
...
#endif                                 /* pci1756_COMMON_INCLUDES_ */

#include "pci1756_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_pci1756                RT_MODEL_pci1756_T

/* Definition for use in the target main file */
#define pci1756_rtModel                RT_MODEL_pci1756_T
...
typedef struct {
  ...
  real_T constant17;                   /* '<Root>/constant17' */
  real_T constant25;                   /* '<Root>/constant25' */
  real_T constant26;                   /* '<Root>/constant26' */
  real_T constant27;                   /* '<Root>/constant27' */
  real_T constant28;                   /* '<Root>/constant28' */
  real_T constant29;                   /* '<Root>/constant29' */
  real_T constant30;                   /* '<Root>/constant30' */
  real_T constant31;                   /* '<Root>/constant31' */
  real_T constant32;                   /* '<Root>/constant32' */
  real_T constant18;                   /* '<Root>/constant18' */
  real_T constant19;                   /* '<Root>/constant19' */
  real_T constant20;                   /* '<Root>/constant20' */
  real_T constant21;                   /* '<Root>/constant21' */
  real_T constant22;                   /* '<Root>/constant22' */
  real_T constant23;                   /* '<Root>/constant23' */
  real_T constant24;                   /* '<Root>/constant24' */
  real_T PCI1_o1[16];                  /* '<Root>/PCI1' */
  real_T PCI1_o2[16];                  /* '<Root>/PCI1' */
} B_pci1756_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  int_T PCI1_IWORK[6];                 /* '<Root>/PCI1' */
} DW_pci1756_T;

/* Backward compatible GRT Identifiers */
#define rtB                            pci1756_B
#define BlockIO                        B_pci1756_T
#define rtP                            pci1756_P
#define Parameters                     P_pci1756_T
#define rtDWork                        pci1756_DW
#define D_Work                         DW_pci1756_T
...
extern P_pci1756_T pci1756_P;

/* Block signals (auto storage) */
extern B_pci1756_T pci1756_B;

/* Block states (auto storage) */
extern DW_pci1756_T pci1756_DW;

/*====================*
 * External functions *
 *====================*/
extern pci1756_rtModel *pci1756(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  pci1756_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_pci1756_T *const pci1756_M;
