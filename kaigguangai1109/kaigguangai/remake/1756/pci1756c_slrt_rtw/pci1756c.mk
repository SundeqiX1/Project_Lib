...
MODEL           = pci1756c
MODULES         = pci1756c_capi.c pci1756c_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = pci1756c.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = F:\矿大\项目组1\发射井地面总装联调\remake\1756
S_FUNCTIONS     = pci1756DIO.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "C:\Users\Administrator\AppData\Roaming\MathWorks\MATLAB\R2016b\mex_C_win64.xml"
...
MODELLIB                  = pci1756clib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = pci1756c_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\pci1756c_slrt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\New Folder
