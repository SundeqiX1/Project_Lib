...
MODEL           = pci1756a
MODULES         = pci1756a_capi.c pci1756a_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = pci1756a.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = F:\矿大\项目组1\发射井地面总装联调\remake
S_FUNCTIONS     = pci1756.c
S_FUNCTIONS_LIB = 
NUMST           = 1
TID01EQ         = 0
NCSTATES        = 0
...
MODELLIB                  = pci1756alib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = pci1756a_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\pci1756a_slrt_rtw
