...
#ifndef RTW_HEADER_pci1756a_h_
#define RTW_HEADER_pci1756a_h_
#include <stddef.h>
#include <string.h>
#include "rtw_modelmap.h"
#ifndef pci1756a_COMMON_INCLUDES_
# define pci1756a_COMMON_INCLUDES_
...
#endif                                 /* pci1756a_COMMON_INCLUDES_ */

#include "pci1756a_types.h"
...
#define rtmGetRTWSolverInfo(rtm)       &((rtm)->solverInfo)
#define rtModel_pci1756a               RT_MODEL_pci1756a_T

/* Definition for use in the target main file */
#define pci1756a_rtModel               RT_MODEL_pci1756a_T
...
typedef struct {
  real_T TmpSignalConversionAtPCI1Inport[32];
  real_T PCI1[32];                     /* '<Root>/PCI1' */
} B_pci1756a_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  int_T PCI1_IWORK[2];                 /* '<Root>/PCI1' */
} DW_pci1756a_T;

/* Backward compatible GRT Identifiers */
#define rtB                            pci1756a_B
#define BlockIO                        B_pci1756a_T
#define rtP                            pci1756a_P
#define Parameters                     P_pci1756a_T
#define rtDWork                        pci1756a_DW
#define D_Work                         DW_pci1756a_T

/* Parameters (auto storage) */
struct P_pci1756a_T_ {
  ...
  real_T Constant26_Value;             /* Expression: 1
                                        ...
                                        */
  real_T Constant27_Value;             /* Expression: 1
  ...
  real_T PCI1_P1_Size[2];              /* Computed Parameter: PCI1_P1_Size
                                        ...
                                        */
  real_T PCI1_P1;                      /* Expression: BaseAddress
                                        * Referenced by: '<Root>/PCI1'
                                        */
  real_T PCI1_P2_Size[2];              /* Computed Parameter: PCI1_P2_Size
                                        * Referenced by: '<Root>/PCI1'
                                        */
  real_T PCI1_P2[2];                   /* Expression: [SampleTime SampleOffset]
                                        * Referenced by: '<Root>/PCI1'
                                        */
};

/* Real-time Model Data Structure */
struct tag_RTM_pci1756a_T {
  const char_T *path;
...
extern P_pci1756a_T pci1756a_P;

/* Block signals (auto storage) */
extern B_pci1756a_T pci1756a_B;

/* Block states (auto storage) */
extern DW_pci1756a_T pci1756a_DW;

/*====================*
 * External functions *
 *====================*/
extern pci1756a_rtModel *pci1756a(void);
...
extern const rtwCAPI_ModelMappingStaticInfo*
  pci1756a_GetCAPIStaticMap(void);

/* Real-time Model object */
extern RT_MODEL_pci1756a_T *const pci1756a_M;
