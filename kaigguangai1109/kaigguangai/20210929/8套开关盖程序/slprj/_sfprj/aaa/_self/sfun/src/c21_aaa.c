...
static void initialize_c21_aaa(SFc21_aaaInstanceStruct *chartInstance);
static void initialize_params_c21_aaa(SFc21_aaaInstanceStruct *chartInstance);
static void enable_c21_aaa(SFc21_aaaInstanceStruct *chartInstance);
static void disable_c21_aaa(SFc21_aaaInstanceStruct *chartInstance);
static void c21_update_debugger_state_c21_aaa(SFc21_aaaInstanceStruct
  *chartInstance);
static void ext_mode_exec_c21_aaa(SFc21_aaaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_aaa(SFc21_aaaInstanceStruct
  *chartInstance);
static void set_sim_state_c21_aaa(SFc21_aaaInstanceStruct *chartInstance, const
  mxArray *c21_st);
static void c21_set_sim_state_side_effects_c21_aaa(SFc21_aaaInstanceStruct
  *chartInstance);
static void finalize_c21_aaa(SFc21_aaaInstanceStruct *chartInstance);
static void sf_gateway_c21_aaa(SFc21_aaaInstanceStruct *chartInstance);
static void mdl_start_c21_aaa(SFc21_aaaInstanceStruct *chartInstance);
static void initSimStructsc21_aaa(SFc21_aaaInstanceStruct *chartInstance);
static void c21_MANUAL(SFc21_aaaInstanceStruct *chartInstance);
static void c21_exit_internal_MANUAL(SFc21_aaaInstanceStruct *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static int32_T c21_emlrt_marshallIn(SFc21_aaaInstanceStruct *chartInstance,
...
static const mxArray *c21_b_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static uint8_T c21_b_emlrt_marshallIn(SFc21_aaaInstanceStruct *chartInstance,
  const mxArray *c21_b_is_kaigai, const char_T *c21_identifier);
static uint8_T c21_c_emlrt_marshallIn(SFc21_aaaInstanceStruct *chartInstance,
  const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
...
static const mxArray *c21_c_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static real_T c21_d_emlrt_marshallIn(SFc21_aaaInstanceStruct *chartInstance,
  const mxArray *c21_b_skhx, const char_T *c21_identifier);
static real_T c21_e_emlrt_marshallIn(SFc21_aaaInstanceStruct *chartInstance,
  const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData);
static uint16_T c21_f_emlrt_marshallIn(SFc21_aaaInstanceStruct *chartInstance,
  const mxArray *c21_b_temporalCounter_i1, const char_T *c21_identifier);
static uint16_T c21_g_emlrt_marshallIn(SFc21_aaaInstanceStruct *chartInstance,
  const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static const mxArray *c21_h_emlrt_marshallIn(SFc21_aaaInstanceStruct
  *chartInstance, const mxArray *c21_b_setSimStateSideEffectsInfo, const char_T *
  c21_identifier);
static const mxArray *c21_i_emlrt_marshallIn(SFc21_aaaInstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc21_aaaInstanceStruct
  *chartInstance, int32_T c21_ssid);
static void c21_init_sf_message_store_memory(SFc21_aaaInstanceStruct
  *chartInstance);
static uint16_T c21__u16_s32_(SFc21_aaaInstanceStruct *chartInstance, int32_T
  c21_b, uint32_T c21_ssid_src_loc, int32_T c21_offset_src_loc, int32_T
  c21_length_src_loc);
static void init_dsm_address_info(SFc21_aaaInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc21_aaaInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c21_aaa(SFc21_aaaInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc21_aaa(chartInstance);
  ...
  *chartInstance->c21_is_active_c21_aaa = 0U;
  *chartInstance->c21_is_c21_aaa = c21_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c21_is_active_c21_aaa == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 20U, *chartInstance->c21_sfEvent);
  }

  if (*chartInstance->c21_is_c21_aaa == c21_IN_MANUAL) {
...
static void ext_mode_exec_c21_aaa(SFc21_aaaInstanceStruct *chartInstance)
{
  c21_update_debugger_state_c21_aaa(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  c21_e_hoistedGlobal = *chartInstance->c21_is_active_c21_aaa;
  c21_f_y = NULL;
  ...
  c21_l_hoistedGlobal = *chartInstance->c21_is_c21_aaa;
  c21_m_y = NULL;
  ...
  mxArray *c21_st)
{
  ...
  *chartInstance->c21_is_active_c21_aaa = c21_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c21_aaa", c21_u, 4)),
    "is_active_c21_aaa");
  ...
  *chartInstance->c21_is_active_jiesuo = c21_b_emlrt_marshallIn(chartInstance,
    ...
    "is_active_jiesuo");
  *chartInstance->c21_is_c21_aaa = c21_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c21_aaa", c21_u, 11)), "is_c21_aaa");
  ...
  *chartInstance)
{
  if (chartInstance->c21_doSetSimStateSideEffects != 0) {
    if ((*chartInstance->c21_is_c21_aaa == c21_IN_on1) && (sf_mex_sub
...
static void sf_gateway_c21_aaa(SFc21_aaaInstanceStruct *chartInstance)
{
  ...
  boolean_T c21_temp;
  boolean_T c21_b_out;
  c21_set_sim_state_side_effects_c21_aaa(chartInstance);
  ...
  *chartInstance->c21_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c21_is_active_c21_aaa == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 20U,
                 *chartInstance->c21_sfEvent);
    *chartInstance->c21_is_active_c21_aaa = 1U;
    ...
    *chartInstance->c21_is_c21_aaa = c21_IN_off1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 20U, *chartInstance->c21_sfEvent);
  } else {
    switch (*chartInstance->c21_is_c21_aaa) {
     case c21_IN_MANUAL:
     ...
     case c21_IN_off1:
      ...
      if (c21_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 20U, *chartInstance->c21_sfEvent);
        *chartInstance->c21_is_c21_aaa = c21_IN_on1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 21U, *chartInstance->c21_sfEvent);
        *chartInstance->c21_temporalCounter_i1 = 0U;
        *chartInstance->c21_skhx = 0.0;
     ...
     case c21_IN_on1:
      ...
      if (c21_b_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 21U, *chartInstance->c21_sfEvent);
        *chartInstance->c21_is_c21_aaa = c21_IN_MANUAL;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c21_sfEvent);
...
static void c21_MANUAL(SFc21_aaaInstanceStruct *chartInstance)
{
  ...
  if (c21_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c21_sfEvent);
    *chartInstance->c21_is_c21_aaa = c21_IN_end;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 19U, *chartInstance->c21_sfEvent);
    *chartInstance->c21_skhx = 0.0;
...
const mxArray *sf_c21_aaa_get_eml_resolved_functions_info(void)
{
  ...
  *c21_inData)
{
  ...
  int32_T c21_u;
  const mxArray *c21_y = NULL;
  SFc21_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc21_aaaInstanceStruct *)chartInstanceVoid;
...
static void init_simulink_io_address(SFc21_aaaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_aaa = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c21_is_c21_aaa = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    2);
...
void sf_c21_aaa_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c21_aaa_get_post_codegen_info(void);
mxArray *sf_c21_aaa_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c21_aaa_get_post_codegen_info();
...
mxArray *sf_c21_aaa_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c21_aaa_jit_fallback_info(void)
{
...
mxArray *sf_c21_aaa_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c21_aaa(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[258],T\"gghx\",},{M[1],M[259],T\"kghx\",},{M[1],M[260],T\"skhx\",},{M[1],M[261],T\"yjhx\",},{M[8],M[0],T\"is_active_c21_aaa\",},{M[8],M[7],T\"is_active_kaigai\",},{M[8],M[202],T\"is_active_guangai\",},{M[8],M[208],T\"is_active_songkai\",},{M[8],M[214],T\"is_active_yajin\",},{M[8],M[243],T\"is_active_suoding\",}}",
    "100 S1x9'type','srcId','name','auxInfo'{{M[8],M[246],T\"is_active_jiesuo\",},{M[9],M[0],T\"is_c21_aaa\",},{M[9],M[7],T\"is_kaigai\",},{M[9],M[202],T\"is_guangai\",},{M[9],M[208],T\"is_songkai\",},{M[9],M[214],T\"is_yajin\",},{M[9],M[243],T\"is_suoding\",},{M[9],M[246],T\"is_jiesuo\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M[1],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 19, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_aaa_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc21_aaaInstanceStruct *) chartInstance,
    msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc21_aaaInstanceStruct *chartInstance = (SFc21_aaaInstanceStruct *)
...
static void sf_opaque_initialize_c21_aaa(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc21_aaaInstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc21_aaaInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c21_aaa((SFc21_aaaInstanceStruct*) chartInstanceVar);
  initialize_c21_aaa((SFc21_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c21_aaa(void *chartInstanceVar)
{
  enable_c21_aaa((SFc21_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_aaa(void *chartInstanceVar)
{
  disable_c21_aaa((SFc21_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c21_aaa(void *chartInstanceVar)
{
  sf_gateway_c21_aaa((SFc21_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c21_aaa(void *chartInstanceVar)
{
  ext_mode_exec_c21_aaa((SFc21_aaaInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c21_aaa(SimStruct* S)
{
  return get_sim_state_c21_aaa((SFc21_aaaInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c21_aaa(SimStruct* S, const mxArray *st)
{
  set_sim_state_c21_aaa((SFc21_aaaInstanceStruct*)sf_get_chart_instance_ptr(S),
                        st);
}

static void sf_opaque_terminate_c21_aaa(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_aaaInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_aaa_optimization_info();
    }

    finalize_c21_aaa((SFc21_aaaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc21_aaa((SFc21_aaaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_aaa(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c21_aaa((SFc21_aaaInstanceStruct*)
      sf_get_chart_instance_ptr(S));
  }
}

mxArray *sf_c21_aaa_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c21_aaa(SimStruct *S)
{
...
static void mdlRTW_c21_aaa(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_aaa(SimStruct *S)
{
  SFc21_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc21_aaaInstanceStruct *)utMalloc(sizeof
    (SFc21_aaaInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc21_aaaInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c21_aaa;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c21_aaa;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c21_aaa;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c21_aaa;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c21_aaa;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c21_aaa;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c21_aaa;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c21_aaa;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_aaa;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_aaa;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c21_aaa;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c21_aaa;
  ...
  mdl_start_c21_aaa(chartInstance);
}

void c21_aaa_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_aaa(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_aaa(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_aaa_method_dispatcher.\n"
