...
static void initialize_c4_aaa(SFc4_aaaInstanceStruct *chartInstance);
static void initialize_params_c4_aaa(SFc4_aaaInstanceStruct *chartInstance);
static void enable_c4_aaa(SFc4_aaaInstanceStruct *chartInstance);
static void disable_c4_aaa(SFc4_aaaInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_aaa(SFc4_aaaInstanceStruct
  *chartInstance);
static void ext_mode_exec_c4_aaa(SFc4_aaaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_aaa(SFc4_aaaInstanceStruct *chartInstance);
static void set_sim_state_c4_aaa(SFc4_aaaInstanceStruct *chartInstance, const
  mxArray *c4_st);
static void c4_set_sim_state_side_effects_c4_aaa(SFc4_aaaInstanceStruct
  *chartInstance);
static void finalize_c4_aaa(SFc4_aaaInstanceStruct *chartInstance);
static void sf_gateway_c4_aaa(SFc4_aaaInstanceStruct *chartInstance);
static void mdl_start_c4_aaa(SFc4_aaaInstanceStruct *chartInstance);
static void initSimStructsc4_aaa(SFc4_aaaInstanceStruct *chartInstance);
static void c4_zidong(SFc4_aaaInstanceStruct *chartInstance);
static void c4_enter_atomic_chushihua(SFc4_aaaInstanceStruct *chartInstance);
static void c4_songkaishijian(SFc4_aaaInstanceStruct *chartInstance);
static void c4_start(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on10(SFc4_aaaInstanceStruct *chartInstance);
static void c4_songkaishijian1(SFc4_aaaInstanceStruct *chartInstance);
static void c4_yanchishijian1(SFc4_aaaInstanceStruct *chartInstance);
static void c4_tguiling(SFc4_aaaInstanceStruct *chartInstance);
static void c4_enter_atomic_on2(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on2(SFc4_aaaInstanceStruct *chartInstance);
static void c4_kaigaishijian(SFc4_aaaInstanceStruct *chartInstance);
static void c4_songkaishijian2(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on11(SFc4_aaaInstanceStruct *chartInstance);
static void c4_yanchishijian2(SFc4_aaaInstanceStruct *chartInstance);
static void c4_t2guiling(SFc4_aaaInstanceStruct *chartInstance);
static void c4_enter_atomic_on3(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on3(SFc4_aaaInstanceStruct *chartInstance);
static void c4_suodingshijian(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on7(SFc4_aaaInstanceStruct *chartInstance);
static void c4_songkaishijian3(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on12(SFc4_aaaInstanceStruct *chartInstance);
static void c4_yanchishijian3(SFc4_aaaInstanceStruct *chartInstance);
static void c4_t4guiling(SFc4_aaaInstanceStruct *chartInstance);
static void c4_enter_atomic_off(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on4(SFc4_aaaInstanceStruct *chartInstance);
static void c4_jiesuoshijian(SFc4_aaaInstanceStruct *chartInstance);
static void c4_songkaishijian4(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on14(SFc4_aaaInstanceStruct *chartInstance);
static void c4_yanchishijian4(SFc4_aaaInstanceStruct *chartInstance);
static void c4_t6guiling(SFc4_aaaInstanceStruct *chartInstance);
static void c4_enter_atomic_on5(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on5(SFc4_aaaInstanceStruct *chartInstance);
static void c4_guangaishijian(SFc4_aaaInstanceStruct *chartInstance);
static void c4_songkaishijian5(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on16(SFc4_aaaInstanceStruct *chartInstance);
static void c4_yanchishijian5(SFc4_aaaInstanceStruct *chartInstance);
static void c4_t8guiling(SFc4_aaaInstanceStruct *chartInstance);
static void c4_yanchishijian6(SFc4_aaaInstanceStruct *chartInstance);
static void c4_t10guiling(SFc4_aaaInstanceStruct *chartInstance);
static void c4_enter_atomic_on6(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on6(SFc4_aaaInstanceStruct *chartInstance);
static void c4_yajinshijian(SFc4_aaaInstanceStruct *chartInstance);
static void c4_songkaishijian6(SFc4_aaaInstanceStruct *chartInstance);
static void c4_on18(SFc4_aaaInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_aaaInstanceStruct *chartInstance, const
  mxArray *c4_nargout, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_aaaInstanceStruct *chartInstance, const
  mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static boolean_T c4_c_emlrt_marshallIn(SFc4_aaaInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_d_emlrt_marshallIn(SFc4_aaaInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static uint8_T c4_e_emlrt_marshallIn(SFc4_aaaInstanceStruct *chartInstance,
  const mxArray *c4_b_is_zidong, const char_T *c4_identifier);
static uint8_T c4_f_emlrt_marshallIn(SFc4_aaaInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint16_T c4_g_emlrt_marshallIn(SFc4_aaaInstanceStruct *chartInstance,
  const mxArray *c4_b_temporalCounter_i1, const char_T *c4_identifier);
static uint16_T c4_h_emlrt_marshallIn(SFc4_aaaInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_i_emlrt_marshallIn(SFc4_aaaInstanceStruct *chartInstance, const
  mxArray *c4_b_dataWrittenToVector, const char_T *c4_identifier, boolean_T
  c4_y[27]);
static void c4_j_emlrt_marshallIn(SFc4_aaaInstanceStruct *chartInstance, const
  mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, boolean_T c4_y[27]);
static const mxArray *c4_k_emlrt_marshallIn(SFc4_aaaInstanceStruct
  *chartInstance, const mxArray *c4_b_setSimStateSideEffectsInfo, const char_T
  *c4_identifier);
static const mxArray *c4_l_emlrt_marshallIn(SFc4_aaaInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc4_aaaInstanceStruct
  *chartInstance, int32_T c4_ssid);
static void c4_init_sf_message_store_memory(SFc4_aaaInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc4_aaaInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc4_aaaInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c4_aaa(SFc4_aaaInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc4_aaa(chartInstance);
  ...
  *chartInstance->c4_temporalCounter_i1 = 0U;
  *chartInstance->c4_temporalCounter_i1 = 0U;
  *chartInstance->c4_is_active_c4_aaa = 0U;
  *chartInstance->c4_is_c4_aaa = c4_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c4_is_active_c4_aaa == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 3U, *chartInstance->c4_sfEvent);
  }

  if (*chartInstance->c4_is_c4_aaa == c4_IN_zidong) {
...
static void ext_mode_exec_c4_aaa(SFc4_aaaInstanceStruct *chartInstance)
{
  c4_update_debugger_state_c4_aaa(chartInstance);
}
...
static const mxArray *get_sim_state_c4_aaa(SFc4_aaaInstanceStruct *chartInstance)
{
  ...
  c4_cb_hoistedGlobal = *chartInstance->c4_is_active_c4_aaa;
  c4_db_y = NULL;
  sf_mex_assign(&c4_db_y, sf_mex_create("y", &c4_cb_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c4_y, 27, c4_db_y);
  c4_db_hoistedGlobal = *chartInstance->c4_is_c4_aaa;
  c4_eb_y = NULL;
  ...
  mxArray *c4_st)
{
  ...
  *chartInstance->c4_is_active_c4_aaa = c4_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c4_aaa", c4_u, 27)), "is_active_c4_aaa");
  *chartInstance->c4_is_c4_aaa = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell("is_c4_aaa", c4_u, 28)), "is_c4_aaa");
...
static void sf_gateway_c4_aaa(SFc4_aaaInstanceStruct *chartInstance)
{
  ...
  c4_set_sim_state_side_effects_c4_aaa(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  real_T c4_u;
  const mxArray *c4_y = NULL;
  SFc4_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc4_aaaInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_aaa_get_eml_resolved_functions_info(void)
{
...
static void init_simulink_io_address(SFc4_aaaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_aaa = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c4_is_c4_aaa = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    2);
...
void sf_c4_aaa_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c4_aaa_get_post_codegen_info(void);
mxArray *sf_c4_aaa_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_aaa_get_post_codegen_info();
...
mxArray *sf_c4_aaa_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_aaa_jit_fallback_info(void)
{
...
mxArray *sf_c4_aaa_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_aaa(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[373],T\"yjyichang\",},{M[3],M[59],T\"t\",},{M[3],M[344],T\"t10\",},{M[3],M[74],T\"t2\",},{M[3],M[104],T\"t4\",},{M[3],M[124],T\"t6\",},{M[3],M[168],T\"t8\",},{M[8],M[0],T\"is_active_c4_aaa\",},{M[9],M[0],T\"is_c4_aaa\",},{M[9],M[374],T\"is_zidong\",}}",
  ...
  sf_c4_aaa_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc4_aaaInstanceStruct *) chartInstance,
    msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_aaaInstanceStruct *chartInstance = (SFc4_aaaInstanceStruct *)
...
static void sf_opaque_initialize_c4_aaa(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc4_aaaInstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc4_aaaInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c4_aaa((SFc4_aaaInstanceStruct*) chartInstanceVar);
  initialize_c4_aaa((SFc4_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_aaa(void *chartInstanceVar)
{
  enable_c4_aaa((SFc4_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_aaa(void *chartInstanceVar)
{
  disable_c4_aaa((SFc4_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_aaa(void *chartInstanceVar)
{
  sf_gateway_c4_aaa((SFc4_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c4_aaa(void *chartInstanceVar)
{
  ext_mode_exec_c4_aaa((SFc4_aaaInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_aaa(SimStruct* S)
{
  return get_sim_state_c4_aaa((SFc4_aaaInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_aaa(SimStruct* S, const mxArray *st)
{
  set_sim_state_c4_aaa((SFc4_aaaInstanceStruct*)sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c4_aaa(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_aaaInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_aaa_optimization_info();
    }

    finalize_c4_aaa((SFc4_aaaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_aaa((SFc4_aaaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_aaa(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_aaa((SFc4_aaaInstanceStruct*)sf_get_chart_instance_ptr
      (S));
  }
}

mxArray *sf_c4_aaa_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c4_aaa(SimStruct *S)
{
...
static void mdlRTW_c4_aaa(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_aaa(SimStruct *S)
{
  SFc4_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc4_aaaInstanceStruct *)utMalloc(sizeof
    (SFc4_aaaInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc4_aaaInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_aaa;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_aaa;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_aaa;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_aaa;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_aaa;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_aaa;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_aaa;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_aaa;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_aaa;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_aaa;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_aaa;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c4_aaa;
  ...
  mdl_start_c4_aaa(chartInstance);
}

void c4_aaa_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_aaa(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_aaa(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_aaa_method_dispatcher.\n"
