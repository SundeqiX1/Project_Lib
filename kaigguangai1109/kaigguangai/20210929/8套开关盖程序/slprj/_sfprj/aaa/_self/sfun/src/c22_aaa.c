...
static void initialize_c22_aaa(SFc22_aaaInstanceStruct *chartInstance);
static void initialize_params_c22_aaa(SFc22_aaaInstanceStruct *chartInstance);
static void enable_c22_aaa(SFc22_aaaInstanceStruct *chartInstance);
static void disable_c22_aaa(SFc22_aaaInstanceStruct *chartInstance);
static void c22_update_debugger_state_c22_aaa(SFc22_aaaInstanceStruct
  *chartInstance);
static void ext_mode_exec_c22_aaa(SFc22_aaaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c22_aaa(SFc22_aaaInstanceStruct
  *chartInstance);
static void set_sim_state_c22_aaa(SFc22_aaaInstanceStruct *chartInstance, const
  mxArray *c22_st);
static void c22_set_sim_state_side_effects_c22_aaa(SFc22_aaaInstanceStruct
  *chartInstance);
static void finalize_c22_aaa(SFc22_aaaInstanceStruct *chartInstance);
static void sf_gateway_c22_aaa(SFc22_aaaInstanceStruct *chartInstance);
static void mdl_start_c22_aaa(SFc22_aaaInstanceStruct *chartInstance);
static void initSimStructsc22_aaa(SFc22_aaaInstanceStruct *chartInstance);
static void c22_MANUAL(SFc22_aaaInstanceStruct *chartInstance);
static void c22_exit_internal_MANUAL(SFc22_aaaInstanceStruct *chartInstance);
...
static const mxArray *c22_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static int32_T c22_emlrt_marshallIn(SFc22_aaaInstanceStruct *chartInstance,
...
static const mxArray *c22_b_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static uint8_T c22_b_emlrt_marshallIn(SFc22_aaaInstanceStruct *chartInstance,
  const mxArray *c22_b_is_kaigai, const char_T *c22_identifier);
static uint8_T c22_c_emlrt_marshallIn(SFc22_aaaInstanceStruct *chartInstance,
  const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
...
static const mxArray *c22_c_sf_marshallOut(void *chartInstanceVoid, void
  *c22_inData);
static real_T c22_d_emlrt_marshallIn(SFc22_aaaInstanceStruct *chartInstance,
  const mxArray *c22_b_skhx, const char_T *c22_identifier);
static real_T c22_e_emlrt_marshallIn(SFc22_aaaInstanceStruct *chartInstance,
  const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static void c22_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c22_mxArrayInData, const char_T *c22_varName, void *c22_outData);
static uint16_T c22_f_emlrt_marshallIn(SFc22_aaaInstanceStruct *chartInstance,
  const mxArray *c22_b_temporalCounter_i1, const char_T *c22_identifier);
static uint16_T c22_g_emlrt_marshallIn(SFc22_aaaInstanceStruct *chartInstance,
  const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static const mxArray *c22_h_emlrt_marshallIn(SFc22_aaaInstanceStruct
  *chartInstance, const mxArray *c22_b_setSimStateSideEffectsInfo, const char_T *
  c22_identifier);
static const mxArray *c22_i_emlrt_marshallIn(SFc22_aaaInstanceStruct
  *chartInstance, const mxArray *c22_u, const emlrtMsgIdentifier *c22_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc22_aaaInstanceStruct
  *chartInstance, int32_T c22_ssid);
static void c22_init_sf_message_store_memory(SFc22_aaaInstanceStruct
  *chartInstance);
static uint16_T c22__u16_s32_(SFc22_aaaInstanceStruct *chartInstance, int32_T
  c22_b, uint32_T c22_ssid_src_loc, int32_T c22_offset_src_loc, int32_T
  c22_length_src_loc);
static void init_dsm_address_info(SFc22_aaaInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc22_aaaInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c22_aaa(SFc22_aaaInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc22_aaa(chartInstance);
  ...
  *chartInstance->c22_is_active_c22_aaa = 0U;
  *chartInstance->c22_is_c22_aaa = c22_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c22_is_active_c22_aaa == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 21U, *chartInstance->c22_sfEvent);
  }

  if (*chartInstance->c22_is_c22_aaa == c22_IN_MANUAL) {
...
static void ext_mode_exec_c22_aaa(SFc22_aaaInstanceStruct *chartInstance)
{
  c22_update_debugger_state_c22_aaa(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  c22_e_hoistedGlobal = *chartInstance->c22_is_active_c22_aaa;
  c22_f_y = NULL;
  ...
  c22_l_hoistedGlobal = *chartInstance->c22_is_c22_aaa;
  c22_m_y = NULL;
  ...
  mxArray *c22_st)
{
  ...
  *chartInstance->c22_is_active_c22_aaa = c22_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c22_aaa", c22_u, 4)),
    "is_active_c22_aaa");
  ...
  *chartInstance->c22_is_active_jiesuo = c22_b_emlrt_marshallIn(chartInstance,
    ...
    "is_active_jiesuo");
  *chartInstance->c22_is_c22_aaa = c22_b_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c22_aaa", c22_u, 11)), "is_c22_aaa");
  ...
  *chartInstance)
{
  if (chartInstance->c22_doSetSimStateSideEffects != 0) {
    if ((*chartInstance->c22_is_c22_aaa == c22_IN_on1) && (sf_mex_sub
...
static void sf_gateway_c22_aaa(SFc22_aaaInstanceStruct *chartInstance)
{
  ...
  boolean_T c22_temp;
  boolean_T c22_b_out;
  c22_set_sim_state_side_effects_c22_aaa(chartInstance);
  ...
  *chartInstance->c22_sfEvent = CALL_EVENT;
  ...
  if (*chartInstance->c22_is_active_c22_aaa == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 21U,
                 *chartInstance->c22_sfEvent);
    *chartInstance->c22_is_active_c22_aaa = 1U;
    ...
    *chartInstance->c22_is_c22_aaa = c22_IN_off1;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 20U, *chartInstance->c22_sfEvent);
  } else {
    switch (*chartInstance->c22_is_c22_aaa) {
     case c22_IN_MANUAL:
     ...
     case c22_IN_off1:
      ...
      if (c22_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 20U, *chartInstance->c22_sfEvent);
        *chartInstance->c22_is_c22_aaa = c22_IN_on1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 21U, *chartInstance->c22_sfEvent);
        *chartInstance->c22_temporalCounter_i1 = 0U;
        *chartInstance->c22_skhx = 0.0;
     ...
     case c22_IN_on1:
      ...
      if (c22_b_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 21U, *chartInstance->c22_sfEvent);
        *chartInstance->c22_is_c22_aaa = c22_IN_MANUAL;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c22_sfEvent);
...
static void c22_MANUAL(SFc22_aaaInstanceStruct *chartInstance)
{
  ...
  if (c22_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c22_sfEvent);
    *chartInstance->c22_is_c22_aaa = c22_IN_end;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 19U, *chartInstance->c22_sfEvent);
    *chartInstance->c22_skhx = 0.0;
...
const mxArray *sf_c22_aaa_get_eml_resolved_functions_info(void)
{
  ...
  *c22_inData)
{
  ...
  int32_T c22_u;
  const mxArray *c22_y = NULL;
  SFc22_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc22_aaaInstanceStruct *)chartInstanceVoid;
...
static void init_simulink_io_address(SFc22_aaaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c22_is_active_c22_aaa = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c22_is_c22_aaa = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    2);
...
void sf_c22_aaa_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c22_aaa_get_post_codegen_info(void);
mxArray *sf_c22_aaa_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c22_aaa_get_post_codegen_info();
...
mxArray *sf_c22_aaa_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c22_aaa_jit_fallback_info(void)
{
...
mxArray *sf_c22_aaa_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c22_aaa(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[258],T\"gghx\",},{M[1],M[259],T\"kghx\",},{M[1],M[260],T\"skhx\",},{M[1],M[261],T\"yjhx\",},{M[8],M[0],T\"is_active_c22_aaa\",},{M[8],M[7],T\"is_active_kaigai\",},{M[8],M[202],T\"is_active_guangai\",},{M[8],M[208],T\"is_active_songkai\",},{M[8],M[214],T\"is_active_yajin\",},{M[8],M[243],T\"is_active_suoding\",}}",
    "100 S1x9'type','srcId','name','auxInfo'{{M[8],M[246],T\"is_active_jiesuo\",},{M[9],M[0],T\"is_c22_aaa\",},{M[9],M[7],T\"is_kaigai\",},{M[9],M[202],T\"is_guangai\",},{M[9],M[208],T\"is_songkai\",},{M[9],M[214],T\"is_yajin\",},{M[9],M[243],T\"is_suoding\",},{M[9],M[246],T\"is_jiesuo\",},{M[11],M[0],T\"temporalCounter_i1\",S'et','os','ct'{{T\"wu\",M[1],M[1]}}}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 19, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c22_aaa_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc22_aaaInstanceStruct *) chartInstance,
    msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc22_aaaInstanceStruct *chartInstance = (SFc22_aaaInstanceStruct *)
...
static void sf_opaque_initialize_c22_aaa(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc22_aaaInstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc22_aaaInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c22_aaa((SFc22_aaaInstanceStruct*) chartInstanceVar);
  initialize_c22_aaa((SFc22_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c22_aaa(void *chartInstanceVar)
{
  enable_c22_aaa((SFc22_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c22_aaa(void *chartInstanceVar)
{
  disable_c22_aaa((SFc22_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c22_aaa(void *chartInstanceVar)
{
  sf_gateway_c22_aaa((SFc22_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c22_aaa(void *chartInstanceVar)
{
  ext_mode_exec_c22_aaa((SFc22_aaaInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c22_aaa(SimStruct* S)
{
  return get_sim_state_c22_aaa((SFc22_aaaInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c22_aaa(SimStruct* S, const mxArray *st)
{
  set_sim_state_c22_aaa((SFc22_aaaInstanceStruct*)sf_get_chart_instance_ptr(S),
                        st);
}

static void sf_opaque_terminate_c22_aaa(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc22_aaaInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_aaa_optimization_info();
    }

    finalize_c22_aaa((SFc22_aaaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc22_aaa((SFc22_aaaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c22_aaa(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c22_aaa((SFc22_aaaInstanceStruct*)
      sf_get_chart_instance_ptr(S));
  }
}

mxArray *sf_c22_aaa_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c22_aaa(SimStruct *S)
{
...
static void mdlRTW_c22_aaa(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c22_aaa(SimStruct *S)
{
  SFc22_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc22_aaaInstanceStruct *)utMalloc(sizeof
    (SFc22_aaaInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc22_aaaInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c22_aaa;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c22_aaa;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c22_aaa;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c22_aaa;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c22_aaa;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c22_aaa;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c22_aaa;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c22_aaa;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c22_aaa;
  chartInstance->chartInfo.mdlStart = mdlStart_c22_aaa;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c22_aaa;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c22_aaa;
  ...
  mdl_start_c22_aaa(chartInstance);
}

void c22_aaa_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c22_aaa(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c22_aaa(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c22_aaa_method_dispatcher.\n"
