...
/* Type Definitions */
#ifndef typedef_SFc9_aaaInstanceStruct
#define typedef_SFc9_aaaInstanceStruct
...
typedef struct {
  ...
  int32_T *c9_sfEvent;
  uint8_T *c9_is_active_c9_aaa;
  uint8_T *c9_is_c9_aaa;
...
#endif                                 /*typedef_SFc9_aaaInstanceStruct*/
...
extern void c9_aaa_method_dispatcher(SimStruct *S, int_T method, void *data);
