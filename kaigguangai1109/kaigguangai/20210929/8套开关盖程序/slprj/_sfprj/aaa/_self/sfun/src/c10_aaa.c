...
static void initialize_c10_aaa(SFc10_aaaInstanceStruct *chartInstance);
static void initialize_params_c10_aaa(SFc10_aaaInstanceStruct *chartInstance);
static void enable_c10_aaa(SFc10_aaaInstanceStruct *chartInstance);
static void disable_c10_aaa(SFc10_aaaInstanceStruct *chartInstance);
static void c10_update_debugger_state_c10_aaa(SFc10_aaaInstanceStruct
  *chartInstance);
static void ext_mode_exec_c10_aaa(SFc10_aaaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_aaa(SFc10_aaaInstanceStruct
  *chartInstance);
static void set_sim_state_c10_aaa(SFc10_aaaInstanceStruct *chartInstance, const
  mxArray *c10_st);
static void c10_set_sim_state_side_effects_c10_aaa(SFc10_aaaInstanceStruct
  *chartInstance);
static void finalize_c10_aaa(SFc10_aaaInstanceStruct *chartInstance);
static void sf_gateway_c10_aaa(SFc10_aaaInstanceStruct *chartInstance);
static void mdl_start_c10_aaa(SFc10_aaaInstanceStruct *chartInstance);
static void c10_chartstep_c10_aaa(SFc10_aaaInstanceStruct *chartInstance);
static void initSimStructsc10_aaa(SFc10_aaaInstanceStruct *chartInstance);
static void c10_off(SFc10_aaaInstanceStruct *chartInstance);
static void c10_exit_internal_shoudong(SFc10_aaaInstanceStruct *chartInstance);
static void c10_songkai(SFc10_aaaInstanceStruct *chartInstance);
static void c10_t(SFc10_aaaInstanceStruct *chartInstance);
static void c10_kaigai(SFc10_aaaInstanceStruct *chartInstance);
static void c10_enter_atomic_off(SFc10_aaaInstanceStruct *chartInstance);
static void c10_b_t(SFc10_aaaInstanceStruct *chartInstance);
static void c10_jiesuo(SFc10_aaaInstanceStruct *chartInstance);
static void c10_c_t(SFc10_aaaInstanceStruct *chartInstance);
static void c10_suoding(SFc10_aaaInstanceStruct *chartInstance);
static void c10_d_t(SFc10_aaaInstanceStruct *chartInstance);
static void c10_yajin(SFc10_aaaInstanceStruct *chartInstance);
static void c10_e_t(SFc10_aaaInstanceStruct *chartInstance);
static void c10_guangai(SFc10_aaaInstanceStruct *chartInstance);
static void c10_b_enter_atomic_off(SFc10_aaaInstanceStruct *chartInstance);
static void c10_f_t(SFc10_aaaInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_emlrt_marshallIn(SFc10_aaaInstanceStruct *chartInstance, const
  mxArray *c10_nargout, const char_T *c10_identifier);
static real_T c10_b_emlrt_marshallIn(SFc10_aaaInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static boolean_T c10_c_emlrt_marshallIn(SFc10_aaaInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_d_emlrt_marshallIn(SFc10_aaaInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_d_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static uint8_T c10_e_emlrt_marshallIn(SFc10_aaaInstanceStruct *chartInstance,
  const mxArray *c10_b_is_songkai, const char_T *c10_identifier);
static uint8_T c10_f_emlrt_marshallIn(SFc10_aaaInstanceStruct *chartInstance,
  const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static void c10_g_emlrt_marshallIn(SFc10_aaaInstanceStruct *chartInstance, const
  mxArray *c10_b_dataWrittenToVector, const char_T *c10_identifier, boolean_T
  c10_y[20]);
static void c10_h_emlrt_marshallIn(SFc10_aaaInstanceStruct *chartInstance, const
  mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId, boolean_T c10_y[20]);
static const mxArray *c10_i_emlrt_marshallIn(SFc10_aaaInstanceStruct
  *chartInstance, const mxArray *c10_b_setSimStateSideEffectsInfo, const char_T *
  c10_identifier);
static const mxArray *c10_j_emlrt_marshallIn(SFc10_aaaInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc10_aaaInstanceStruct
  *chartInstance, int32_T c10_ssid);
static void c10_init_sf_message_store_memory(SFc10_aaaInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc10_aaaInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc10_aaaInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c10_aaa(SFc10_aaaInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc10_aaa(chartInstance);
  ...
  *chartInstance->c10_is_active_c10_aaa = 0U;
  *chartInstance->c10_is_c10_aaa = c10_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c10_is_jiesuo == c10_IN_t2) {
  ...
  if (*chartInstance->c10_is_suoding == c10_IN_t2) {
  ...
  if (*chartInstance->c10_is_c10_aaa == c10_IN_off1) {
...
static void ext_mode_exec_c10_aaa(SFc10_aaaInstanceStruct *chartInstance)
{
  c10_update_debugger_state_c10_aaa(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  c10_u_hoistedGlobal = *chartInstance->c10_is_active_c10_aaa;
  c10_v_y = NULL;
  ...
  c10_cb_hoistedGlobal = *chartInstance->c10_is_c10_aaa;
  c10_db_y = NULL;
  ...
  mxArray *c10_st)
{
  ...
  *chartInstance->c10_is_active_c10_aaa = c10_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c10_aaa", c10_u, 20)),
    "is_active_c10_aaa");
  ...
  *chartInstance->c10_is_c10_aaa = c10_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c10_aaa", c10_u, 27)), "is_c10_aaa");
...
static void sf_gateway_c10_aaa(SFc10_aaaInstanceStruct *chartInstance)
{
  c10_set_sim_state_side_effects_c10_aaa(chartInstance);
  ...
  *chartInstance->c10_sfEvent = CALL_EVENT;
  ...
  c10_chartstep_c10_aaa(chartInstance);
...
static void c10_chartstep_c10_aaa(SFc10_aaaInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c10_is_active_c10_aaa == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 9U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_active_c10_aaa = 1U;
    ...
    *chartInstance->c10_is_c10_aaa = c10_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c10_sfEvent);
    ...
    *chartInstance->c10_yjyichang = 0.0;
    ...
    switch (*chartInstance->c10_is_c10_aaa) {
     case c10_IN_off:
      CV_CHART_EVAL(9, 0, 1);
     ...
     case c10_IN_shoudong:
      ...
      if (c10_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c10_sfEvent);
        *chartInstance->c10_is_c10_aaa = c10_IN_off1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c10_sfEvent);
...
static void c10_off(SFc10_aaaInstanceStruct *chartInstance)
{
  ...
  if (c10_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_c10_aaa = c10_IN_shoudong;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c10_sfEvent);
    ...
    *chartInstance->c10_skt = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c10_skt, 24U, 4U, 22U,
                          *chartInstance->c10_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
    ...
    *chartInstance->c10_jst = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c10_jst, 27U, 4U, 10U,
                          *chartInstance->c10_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
    ...
    if (c10_c_out) {
      ...
      *chartInstance->c10_skt += 0.002;
      ...
      if (CV_EML_COND(4, 0, 0, CV_RELATIONAL_EVAL(5U, 4U, 0,
            ...
            *chartInstance->c10_b_songkai, 0.0, -1, 0U,
            *chartInstance->c10_b_songkai == 0.0))) {
...
static void c10_t(SFc10_aaaInstanceStruct *chartInstance)
{
  ...
  if (c10_out) {
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_b_out, 2U, c10_b_sf_marshallOut,
      c10_b_sf_marshallIn);
    c10_b_out = CV_EML_IF(3, 0, 0, CV_RELATIONAL_EVAL(5U, 3U, 0,
      *chartInstance->c10_skdw, 0.0, -1, 0U, *chartInstance->c10_skdw == 0.0));
    _SFD_SYMBOL_SCOPE_POP();
    if (c10_b_out) {
      _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 3U, *chartInstance->c10_sfEvent);
    ...
    if (c10_c_out) {
      ...
      *chartInstance->c10_temporalCounter_i2 = 0U;
      ...
      if (CV_EML_COND(7, 0, 0, CV_RELATIONAL_EVAL(5U, 7U, 0,
            ...
            *chartInstance->c10_b_kaigai, 0.0, -1, 0U,
            *chartInstance->c10_b_kaigai == 0.0))) {
...
static void c10_enter_atomic_off(SFc10_aaaInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c10_kgt = 0.0;
  chartInstance->c10_dataWrittenToVector[9U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c10_kgt, 25U, 4U, 16U,
                        *chartInstance->c10_sfEvent, false);
  *chartInstance->c10_kgzhiling1 = 0.0;
  chartInstance->c10_dataWrittenToVector[4U] = true;
...
static void c10_jiesuo(SFc10_aaaInstanceStruct *chartInstance)
{
  ...
  switch (*chartInstance->c10_is_jiesuo) {
    ...
    if (c10_c_out) {
      ...
      *chartInstance->c10_temporalCounter_i3 = 0U;
      ...
      if (CV_EML_COND(19, 0, 0, CV_RELATIONAL_EVAL(5U, 19U, 0,
            ...
            *chartInstance->c10_b_jiesuo, 0.0, -1, 0U,
            *chartInstance->c10_b_jiesuo == 0.0))) {
   ...
   case c10_IN_t1:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 13U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_jiesuo = c10_IN_t2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 14U, *chartInstance->c10_sfEvent);
...
static void c10_suoding(SFc10_aaaInstanceStruct *chartInstance)
{
  ...
  switch (*chartInstance->c10_is_suoding) {
    ...
    if (c10_c_out) {
      ...
      *chartInstance->c10_temporalCounter_i4 = 0U;
      ...
      if (CV_EML_COND(13, 0, 0, CV_RELATIONAL_EVAL(5U, 13U, 0,
            ...
            *chartInstance->c10_b_suoding, 0.0, -1, 0U,
            *chartInstance->c10_b_suoding == 0.0))) {
   ...
   case c10_IN_t1:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 31U, *chartInstance->c10_sfEvent);
    *chartInstance->c10_is_suoding = c10_IN_t2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 32U, *chartInstance->c10_sfEvent);
  ...
  switch (*chartInstance->c10_is_yajin) {
    ...
    if (c10_c_out) {
      ...
      *chartInstance->c10_temporalCounter_i5 = 0U;
      ...
      if (CV_EML_COND(31, 0, 0, CV_RELATIONAL_EVAL(5U, 31U, 0,
            ...
            *chartInstance->c10_b_yajin, 0.0, -1, 0U,
            *chartInstance->c10_b_yajin == 0.0))) {
   ...
   case c10_b_IN_t2:
    ...
    if (c10_b_out) {
      ...
      *chartInstance->c10_sdt += 0.002;
      chartInstance->c10_dataWrittenToVector[10U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c10_sdt, 26U, 4U, 37U,
                            *chartInstance->c10_sfEvent, false);
      _SFD_SYMBOL_SCOPE_POP();
    } else {
  ...
  switch (*chartInstance->c10_is_guangai) {
    ...
    if (c10_c_out) {
      ...
      *chartInstance->c10_temporalCounter_i6 = 0U;
      ...
      if (CV_EML_COND(25, 0, 0, CV_RELATIONAL_EVAL(5U, 25U, 0,
            ...
            *chartInstance->c10_b_guangai, 0.0, -1, 0U,
            *chartInstance->c10_b_guangai == 0.0))) {
    ...
    *chartInstance->c10_is_guangai = c10_IN_t2;
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c10_d_nargout, 1U, c10_sf_marshallOut,
      c10_sf_marshallIn);
    if (!chartInstance->c10_dataWrittenToVector[10U]) {
      _SFD_DATA_READ_BEFORE_WRITE_ERROR(26U, 4U, 8U, *chartInstance->c10_sfEvent,
        false);
    }

    *chartInstance->c10_sdt += 0.002;
    chartInstance->c10_dataWrittenToVector[10U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c10_sdt, 26U, 4U, 8U,
                          *chartInstance->c10_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
...
static void c10_b_enter_atomic_off(SFc10_aaaInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c10_ggt = 0.0;
  chartInstance->c10_dataWrittenToVector[12U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c10_ggt, 28U, 4U, 4U,
                        *chartInstance->c10_sfEvent, false);
  *chartInstance->c10_ggzhiling1 = 0.0;
  chartInstance->c10_dataWrittenToVector[6U] = true;
  ...
  *c10_inData)
{
  ...
  real_T c10_u;
  const mxArray *c10_y = NULL;
  SFc10_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc10_aaaInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c10_aaa_get_eml_resolved_functions_info(void)
{
...
static void init_simulink_io_address(SFc10_aaaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_aaa = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c10_is_c10_aaa = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    2);
...
void sf_c10_aaa_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c10_aaa_get_post_codegen_info(void);
mxArray *sf_c10_aaa_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("QHfwytqc7UVOBnybCgoAe");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c10_aaa_get_post_codegen_info();
...
mxArray *sf_c10_aaa_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_aaa_jit_fallback_info(void)
{
...
mxArray *sf_c10_aaa_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c10_aaa(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c10_aaa\",},{M[8],M[1],T\"is_active_songkai\",},{M[8],M[32],T\"is_active_kaigai\",},{M[8],M[53],T\"is_active_suoding\",},{M[8],M[63],T\"is_active_jiesuo\",},{M[8],M[86],T\"is_active_guangai\",},{M[8],M[87],T\"is_active_yajin\",},{M[9],M[0],T\"is_c10_aaa\",},{M[9],M[1],T\"is_songkai\",},{M[9],M[32],T\"is_kaigai\",}}",
  ...
  sf_c10_aaa_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc10_aaaInstanceStruct *) chartInstance,
    msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc10_aaaInstanceStruct *chartInstance = (SFc10_aaaInstanceStruct *)
...
static void sf_opaque_initialize_c10_aaa(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc10_aaaInstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc10_aaaInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c10_aaa((SFc10_aaaInstanceStruct*) chartInstanceVar);
  initialize_c10_aaa((SFc10_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c10_aaa(void *chartInstanceVar)
{
  enable_c10_aaa((SFc10_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_aaa(void *chartInstanceVar)
{
  disable_c10_aaa((SFc10_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c10_aaa(void *chartInstanceVar)
{
  sf_gateway_c10_aaa((SFc10_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c10_aaa(void *chartInstanceVar)
{
  ext_mode_exec_c10_aaa((SFc10_aaaInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c10_aaa(SimStruct* S)
{
  return get_sim_state_c10_aaa((SFc10_aaaInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c10_aaa(SimStruct* S, const mxArray *st)
{
  set_sim_state_c10_aaa((SFc10_aaaInstanceStruct*)sf_get_chart_instance_ptr(S),
                        st);
}

static void sf_opaque_terminate_c10_aaa(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_aaaInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_aaa_optimization_info();
    }

    finalize_c10_aaa((SFc10_aaaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc10_aaa((SFc10_aaaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_aaa(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c10_aaa((SFc10_aaaInstanceStruct*)
      sf_get_chart_instance_ptr(S));
  }
}

mxArray *sf_c10_aaa_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c10_aaa(SimStruct *S)
{
...
static void mdlRTW_c10_aaa(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_aaa(SimStruct *S)
{
  SFc10_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc10_aaaInstanceStruct *)utMalloc(sizeof
    (SFc10_aaaInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc10_aaaInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c10_aaa;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c10_aaa;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c10_aaa;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_aaa;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_aaa;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c10_aaa;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c10_aaa;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c10_aaa;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_aaa;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_aaa;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_aaa;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c10_aaa;
  ...
  mdl_start_c10_aaa(chartInstance);
}

void c10_aaa_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_aaa(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_aaa(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_aaa_method_dispatcher.\n"
