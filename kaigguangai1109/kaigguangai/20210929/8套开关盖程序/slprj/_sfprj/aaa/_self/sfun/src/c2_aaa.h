...
/* Type Definitions */
#ifndef typedef_SFc2_aaaInstanceStruct
#define typedef_SFc2_aaaInstanceStruct
...
typedef struct {
  ...
  int32_T *c2_sfEvent;
  uint8_T *c2_is_active_c2_aaa;
  uint8_T *c2_is_c2_aaa;
...
#endif                                 /*typedef_SFc2_aaaInstanceStruct*/
...
extern void c2_aaa_method_dispatcher(SimStruct *S, int_T method, void *data);
