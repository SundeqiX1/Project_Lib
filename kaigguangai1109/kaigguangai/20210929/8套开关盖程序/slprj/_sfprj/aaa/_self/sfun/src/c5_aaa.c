...
static void initialize_c5_aaa(SFc5_aaaInstanceStruct *chartInstance);
static void initialize_params_c5_aaa(SFc5_aaaInstanceStruct *chartInstance);
static void enable_c5_aaa(SFc5_aaaInstanceStruct *chartInstance);
static void disable_c5_aaa(SFc5_aaaInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_aaa(SFc5_aaaInstanceStruct
  *chartInstance);
static void ext_mode_exec_c5_aaa(SFc5_aaaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c5_aaa(SFc5_aaaInstanceStruct *chartInstance);
static void set_sim_state_c5_aaa(SFc5_aaaInstanceStruct *chartInstance, const
  mxArray *c5_st);
static void c5_set_sim_state_side_effects_c5_aaa(SFc5_aaaInstanceStruct
  *chartInstance);
static void finalize_c5_aaa(SFc5_aaaInstanceStruct *chartInstance);
static void sf_gateway_c5_aaa(SFc5_aaaInstanceStruct *chartInstance);
static void mdl_start_c5_aaa(SFc5_aaaInstanceStruct *chartInstance);
static void initSimStructsc5_aaa(SFc5_aaaInstanceStruct *chartInstance);
static void c5_zidong(SFc5_aaaInstanceStruct *chartInstance);
static void c5_enter_atomic_chushihua(SFc5_aaaInstanceStruct *chartInstance);
static void c5_songkaishijian(SFc5_aaaInstanceStruct *chartInstance);
static void c5_start(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on10(SFc5_aaaInstanceStruct *chartInstance);
static void c5_songkaishijian1(SFc5_aaaInstanceStruct *chartInstance);
static void c5_yanchishijian1(SFc5_aaaInstanceStruct *chartInstance);
static void c5_tguiling(SFc5_aaaInstanceStruct *chartInstance);
static void c5_enter_atomic_on2(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on2(SFc5_aaaInstanceStruct *chartInstance);
static void c5_kaigaishijian(SFc5_aaaInstanceStruct *chartInstance);
static void c5_songkaishijian2(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on11(SFc5_aaaInstanceStruct *chartInstance);
static void c5_yanchishijian2(SFc5_aaaInstanceStruct *chartInstance);
static void c5_t2guiling(SFc5_aaaInstanceStruct *chartInstance);
static void c5_enter_atomic_on3(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on3(SFc5_aaaInstanceStruct *chartInstance);
static void c5_suodingshijian(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on7(SFc5_aaaInstanceStruct *chartInstance);
static void c5_songkaishijian3(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on12(SFc5_aaaInstanceStruct *chartInstance);
static void c5_yanchishijian3(SFc5_aaaInstanceStruct *chartInstance);
static void c5_t4guiling(SFc5_aaaInstanceStruct *chartInstance);
static void c5_enter_atomic_off(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on4(SFc5_aaaInstanceStruct *chartInstance);
static void c5_jiesuoshijian(SFc5_aaaInstanceStruct *chartInstance);
static void c5_songkaishijian4(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on14(SFc5_aaaInstanceStruct *chartInstance);
static void c5_yanchishijian4(SFc5_aaaInstanceStruct *chartInstance);
static void c5_t6guiling(SFc5_aaaInstanceStruct *chartInstance);
static void c5_enter_atomic_on5(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on5(SFc5_aaaInstanceStruct *chartInstance);
static void c5_guangaishijian(SFc5_aaaInstanceStruct *chartInstance);
static void c5_songkaishijian5(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on16(SFc5_aaaInstanceStruct *chartInstance);
static void c5_yanchishijian5(SFc5_aaaInstanceStruct *chartInstance);
static void c5_t8guiling(SFc5_aaaInstanceStruct *chartInstance);
static void c5_yanchishijian6(SFc5_aaaInstanceStruct *chartInstance);
static void c5_t10guiling(SFc5_aaaInstanceStruct *chartInstance);
static void c5_enter_atomic_on6(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on6(SFc5_aaaInstanceStruct *chartInstance);
static void c5_yajinshijian(SFc5_aaaInstanceStruct *chartInstance);
static void c5_songkaishijian6(SFc5_aaaInstanceStruct *chartInstance);
static void c5_on18(SFc5_aaaInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_aaaInstanceStruct *chartInstance, const
  mxArray *c5_nargout, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_aaaInstanceStruct *chartInstance, const
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_b_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static boolean_T c5_c_emlrt_marshallIn(SFc5_aaaInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_d_emlrt_marshallIn(SFc5_aaaInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static uint8_T c5_e_emlrt_marshallIn(SFc5_aaaInstanceStruct *chartInstance,
  const mxArray *c5_b_is_zidong, const char_T *c5_identifier);
static uint8_T c5_f_emlrt_marshallIn(SFc5_aaaInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint16_T c5_g_emlrt_marshallIn(SFc5_aaaInstanceStruct *chartInstance,
  const mxArray *c5_b_temporalCounter_i1, const char_T *c5_identifier);
static uint16_T c5_h_emlrt_marshallIn(SFc5_aaaInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_i_emlrt_marshallIn(SFc5_aaaInstanceStruct *chartInstance, const
  mxArray *c5_b_dataWrittenToVector, const char_T *c5_identifier, boolean_T
  c5_y[27]);
static void c5_j_emlrt_marshallIn(SFc5_aaaInstanceStruct *chartInstance, const
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, boolean_T c5_y[27]);
static const mxArray *c5_k_emlrt_marshallIn(SFc5_aaaInstanceStruct
  *chartInstance, const mxArray *c5_b_setSimStateSideEffectsInfo, const char_T
  *c5_identifier);
static const mxArray *c5_l_emlrt_marshallIn(SFc5_aaaInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc5_aaaInstanceStruct
  *chartInstance, int32_T c5_ssid);
static void c5_init_sf_message_store_memory(SFc5_aaaInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc5_aaaInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc5_aaaInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c5_aaa(SFc5_aaaInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc5_aaa(chartInstance);
  ...
  *chartInstance->c5_temporalCounter_i1 = 0U;
  *chartInstance->c5_temporalCounter_i1 = 0U;
  *chartInstance->c5_is_active_c5_aaa = 0U;
  *chartInstance->c5_is_c5_aaa = c5_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c5_is_active_c5_aaa == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 4U, *chartInstance->c5_sfEvent);
  }

  if (*chartInstance->c5_is_c5_aaa == c5_IN_zidong) {
...
static void ext_mode_exec_c5_aaa(SFc5_aaaInstanceStruct *chartInstance)
{
  c5_update_debugger_state_c5_aaa(chartInstance);
}
...
static const mxArray *get_sim_state_c5_aaa(SFc5_aaaInstanceStruct *chartInstance)
{
  ...
  c5_cb_hoistedGlobal = *chartInstance->c5_is_active_c5_aaa;
  c5_db_y = NULL;
  sf_mex_assign(&c5_db_y, sf_mex_create("y", &c5_cb_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c5_y, 27, c5_db_y);
  c5_db_hoistedGlobal = *chartInstance->c5_is_c5_aaa;
  c5_eb_y = NULL;
  ...
  mxArray *c5_st)
{
  ...
  *chartInstance->c5_is_active_c5_aaa = c5_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c5_aaa", c5_u, 27)), "is_active_c5_aaa");
  *chartInstance->c5_is_c5_aaa = c5_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell("is_c5_aaa", c5_u, 28)), "is_c5_aaa");
...
static void sf_gateway_c5_aaa(SFc5_aaaInstanceStruct *chartInstance)
{
  ...
  c5_set_sim_state_side_effects_c5_aaa(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u;
  const mxArray *c5_y = NULL;
  SFc5_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc5_aaaInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_aaa_get_eml_resolved_functions_info(void)
{
...
static void init_simulink_io_address(SFc5_aaaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_aaa = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c5_is_c5_aaa = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    2);
...
void sf_c5_aaa_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c5_aaa_get_post_codegen_info(void);
mxArray *sf_c5_aaa_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c5_aaa_get_post_codegen_info();
...
mxArray *sf_c5_aaa_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_aaa_jit_fallback_info(void)
{
...
mxArray *sf_c5_aaa_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_aaa(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[373],T\"yjyichang\",},{M[3],M[59],T\"t\",},{M[3],M[344],T\"t10\",},{M[3],M[74],T\"t2\",},{M[3],M[104],T\"t4\",},{M[3],M[124],T\"t6\",},{M[3],M[168],T\"t8\",},{M[8],M[0],T\"is_active_c5_aaa\",},{M[9],M[0],T\"is_c5_aaa\",},{M[9],M[374],T\"is_zidong\",}}",
  ...
  sf_c5_aaa_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc5_aaaInstanceStruct *) chartInstance,
    msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc5_aaaInstanceStruct *chartInstance = (SFc5_aaaInstanceStruct *)
...
static void sf_opaque_initialize_c5_aaa(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc5_aaaInstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc5_aaaInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c5_aaa((SFc5_aaaInstanceStruct*) chartInstanceVar);
  initialize_c5_aaa((SFc5_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_aaa(void *chartInstanceVar)
{
  enable_c5_aaa((SFc5_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_aaa(void *chartInstanceVar)
{
  disable_c5_aaa((SFc5_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_aaa(void *chartInstanceVar)
{
  sf_gateway_c5_aaa((SFc5_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c5_aaa(void *chartInstanceVar)
{
  ext_mode_exec_c5_aaa((SFc5_aaaInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_aaa(SimStruct* S)
{
  return get_sim_state_c5_aaa((SFc5_aaaInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_aaa(SimStruct* S, const mxArray *st)
{
  set_sim_state_c5_aaa((SFc5_aaaInstanceStruct*)sf_get_chart_instance_ptr(S), st);
}

static void sf_opaque_terminate_c5_aaa(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_aaaInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_aaa_optimization_info();
    }

    finalize_c5_aaa((SFc5_aaaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_aaa((SFc5_aaaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_aaa(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c5_aaa((SFc5_aaaInstanceStruct*)sf_get_chart_instance_ptr
      (S));
  }
}

mxArray *sf_c5_aaa_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c5_aaa(SimStruct *S)
{
...
static void mdlRTW_c5_aaa(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_aaa(SimStruct *S)
{
  SFc5_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc5_aaaInstanceStruct *)utMalloc(sizeof
    (SFc5_aaaInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc5_aaaInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_aaa;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_aaa;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_aaa;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_aaa;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_aaa;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_aaa;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_aaa;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_aaa;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_aaa;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_aaa;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_aaa;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c5_aaa;
  ...
  mdl_start_c5_aaa(chartInstance);
}

void c5_aaa_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_aaa(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_aaa(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_aaa_method_dispatcher.\n"
