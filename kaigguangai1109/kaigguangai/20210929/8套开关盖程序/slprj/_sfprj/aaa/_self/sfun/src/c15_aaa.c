...
static void initialize_c15_aaa(SFc15_aaaInstanceStruct *chartInstance);
static void initialize_params_c15_aaa(SFc15_aaaInstanceStruct *chartInstance);
static void enable_c15_aaa(SFc15_aaaInstanceStruct *chartInstance);
static void disable_c15_aaa(SFc15_aaaInstanceStruct *chartInstance);
static void c15_update_debugger_state_c15_aaa(SFc15_aaaInstanceStruct
  *chartInstance);
static void ext_mode_exec_c15_aaa(SFc15_aaaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_aaa(SFc15_aaaInstanceStruct
  *chartInstance);
static void set_sim_state_c15_aaa(SFc15_aaaInstanceStruct *chartInstance, const
  mxArray *c15_st);
static void c15_set_sim_state_side_effects_c15_aaa(SFc15_aaaInstanceStruct
  *chartInstance);
static void finalize_c15_aaa(SFc15_aaaInstanceStruct *chartInstance);
static void sf_gateway_c15_aaa(SFc15_aaaInstanceStruct *chartInstance);
static void mdl_start_c15_aaa(SFc15_aaaInstanceStruct *chartInstance);
static void c15_chartstep_c15_aaa(SFc15_aaaInstanceStruct *chartInstance);
static void initSimStructsc15_aaa(SFc15_aaaInstanceStruct *chartInstance);
static void c15_off(SFc15_aaaInstanceStruct *chartInstance);
static void c15_exit_internal_shoudong(SFc15_aaaInstanceStruct *chartInstance);
static void c15_songkai(SFc15_aaaInstanceStruct *chartInstance);
static void c15_t(SFc15_aaaInstanceStruct *chartInstance);
static void c15_kaigai(SFc15_aaaInstanceStruct *chartInstance);
static void c15_enter_atomic_off(SFc15_aaaInstanceStruct *chartInstance);
static void c15_b_t(SFc15_aaaInstanceStruct *chartInstance);
static void c15_jiesuo(SFc15_aaaInstanceStruct *chartInstance);
static void c15_c_t(SFc15_aaaInstanceStruct *chartInstance);
static void c15_suoding(SFc15_aaaInstanceStruct *chartInstance);
static void c15_d_t(SFc15_aaaInstanceStruct *chartInstance);
static void c15_yajin(SFc15_aaaInstanceStruct *chartInstance);
static void c15_e_t(SFc15_aaaInstanceStruct *chartInstance);
static void c15_guangai(SFc15_aaaInstanceStruct *chartInstance);
static void c15_b_enter_atomic_off(SFc15_aaaInstanceStruct *chartInstance);
static void c15_f_t(SFc15_aaaInstanceStruct *chartInstance);
...
static const mxArray *c15_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static real_T c15_emlrt_marshallIn(SFc15_aaaInstanceStruct *chartInstance, const
  mxArray *c15_nargout, const char_T *c15_identifier);
static real_T c15_b_emlrt_marshallIn(SFc15_aaaInstanceStruct *chartInstance,
...
static const mxArray *c15_b_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static boolean_T c15_c_emlrt_marshallIn(SFc15_aaaInstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
...
static const mxArray *c15_c_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_d_emlrt_marshallIn(SFc15_aaaInstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
...
static const mxArray *c15_d_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static uint8_T c15_e_emlrt_marshallIn(SFc15_aaaInstanceStruct *chartInstance,
  const mxArray *c15_b_is_songkai, const char_T *c15_identifier);
static uint8_T c15_f_emlrt_marshallIn(SFc15_aaaInstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static void c15_g_emlrt_marshallIn(SFc15_aaaInstanceStruct *chartInstance, const
  mxArray *c15_b_dataWrittenToVector, const char_T *c15_identifier, boolean_T
  c15_y[20]);
static void c15_h_emlrt_marshallIn(SFc15_aaaInstanceStruct *chartInstance, const
  mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId, boolean_T c15_y[20]);
static const mxArray *c15_i_emlrt_marshallIn(SFc15_aaaInstanceStruct
  *chartInstance, const mxArray *c15_b_setSimStateSideEffectsInfo, const char_T *
  c15_identifier);
static const mxArray *c15_j_emlrt_marshallIn(SFc15_aaaInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc15_aaaInstanceStruct
  *chartInstance, int32_T c15_ssid);
static void c15_init_sf_message_store_memory(SFc15_aaaInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc15_aaaInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc15_aaaInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c15_aaa(SFc15_aaaInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc15_aaa(chartInstance);
  ...
  *chartInstance->c15_is_active_c15_aaa = 0U;
  *chartInstance->c15_is_c15_aaa = c15_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c15_is_c15_aaa == c15_IN_off1) {
...
static void ext_mode_exec_c15_aaa(SFc15_aaaInstanceStruct *chartInstance)
{
  c15_update_debugger_state_c15_aaa(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  c15_u_hoistedGlobal = *chartInstance->c15_is_active_c15_aaa;
  c15_v_y = NULL;
  ...
  c15_cb_hoistedGlobal = *chartInstance->c15_is_c15_aaa;
  c15_db_y = NULL;
  ...
  mxArray *c15_st)
{
  ...
  *chartInstance->c15_is_active_c15_aaa = c15_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c15_aaa", c15_u, 20)),
    "is_active_c15_aaa");
  ...
  *chartInstance->c15_is_c15_aaa = c15_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c15_aaa", c15_u, 27)), "is_c15_aaa");
...
static void sf_gateway_c15_aaa(SFc15_aaaInstanceStruct *chartInstance)
{
  c15_set_sim_state_side_effects_c15_aaa(chartInstance);
  ...
  *chartInstance->c15_sfEvent = CALL_EVENT;
  ...
  c15_chartstep_c15_aaa(chartInstance);
...
static void c15_chartstep_c15_aaa(SFc15_aaaInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c15_is_active_c15_aaa == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 14U,
                 *chartInstance->c15_sfEvent);
    *chartInstance->c15_is_active_c15_aaa = 1U;
    ...
    *chartInstance->c15_is_c15_aaa = c15_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c15_sfEvent);
    ...
    *chartInstance->c15_yjyichang = 0.0;
    ...
    switch (*chartInstance->c15_is_c15_aaa) {
     case c15_IN_off:
     ...
     case c15_IN_shoudong:
      ...
      if (c15_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c15_sfEvent);
        *chartInstance->c15_is_c15_aaa = c15_IN_off1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c15_sfEvent);
...
static void c15_off(SFc15_aaaInstanceStruct *chartInstance)
{
  ...
  if (c15_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c15_sfEvent);
    *chartInstance->c15_is_c15_aaa = c15_IN_shoudong;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c15_sfEvent);
    ...
    *chartInstance->c15_skt = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_skt, 24U, 4U, 22U,
                          *chartInstance->c15_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
    ...
    *chartInstance->c15_sdt = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_sdt, 26U, 4U, 28U,
                          *chartInstance->c15_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
    ...
    *chartInstance->c15_jst = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_jst, 27U, 4U, 10U,
                          *chartInstance->c15_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
    ...
    *chartInstance->c15_yjt = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_yjt, 29U, 4U, 34U,
                          *chartInstance->c15_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
  } else {
    ...
    if (c15_c_out) {
      ...
      *chartInstance->c15_skt += 0.002;
      ...
      if (CV_EML_COND(4, 0, 0, CV_RELATIONAL_EVAL(5U, 4U, 0,
            ...
            *chartInstance->c15_b_songkai, 0.0, -1, 0U,
            *chartInstance->c15_b_songkai == 0.0))) {
    ...
    if (c15_c_out) {
      ...
      *chartInstance->c15_temporalCounter_i2 = 0U;
      ...
      if (CV_EML_COND(7, 0, 0, CV_RELATIONAL_EVAL(5U, 7U, 0,
            ...
            *chartInstance->c15_b_kaigai, 0.0, -1, 0U,
            *chartInstance->c15_b_kaigai == 0.0))) {
...
static void c15_enter_atomic_off(SFc15_aaaInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c15_kgt = 0.0;
  chartInstance->c15_dataWrittenToVector[9U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_kgt, 25U, 4U, 16U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_kgzhiling1 = 0.0;
  chartInstance->c15_dataWrittenToVector[4U] = true;
    ...
    if (c15_c_out) {
      ...
      *chartInstance->c15_temporalCounter_i3 = 0U;
      ...
      if (CV_EML_COND(19, 0, 0, CV_RELATIONAL_EVAL(5U, 19U, 0,
            ...
            *chartInstance->c15_b_jiesuo, 0.0, -1, 0U,
            *chartInstance->c15_b_jiesuo == 0.0))) {
    ...
    if (c15_c_out) {
      ...
      *chartInstance->c15_temporalCounter_i4 = 0U;
      ...
      if (CV_EML_COND(13, 0, 0, CV_RELATIONAL_EVAL(5U, 13U, 0,
            ...
            *chartInstance->c15_b_suoding, 0.0, -1, 0U,
            *chartInstance->c15_b_suoding == 0.0))) {
  ...
  switch (*chartInstance->c15_is_yajin) {
    ...
    if (c15_c_out) {
      ...
      *chartInstance->c15_temporalCounter_i5 = 0U;
      ...
      if (CV_EML_COND(31, 0, 0, CV_RELATIONAL_EVAL(5U, 31U, 0,
            ...
            *chartInstance->c15_b_yajin, 0.0, -1, 0U,
            *chartInstance->c15_b_yajin == 0.0))) {
   ...
   case c15_b_IN_t2:
    ...
    if (c15_b_out) {
      ...
      *chartInstance->c15_sdt += 0.002;
      chartInstance->c15_dataWrittenToVector[10U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c15_sdt, 26U, 4U, 37U,
                            *chartInstance->c15_sfEvent, false);
      _SFD_SYMBOL_SCOPE_POP();
    } else {
  ...
  switch (*chartInstance->c15_is_guangai) {
    ...
    if (c15_c_out) {
      ...
      *chartInstance->c15_temporalCounter_i6 = 0U;
      ...
      if (CV_EML_COND(25, 0, 0, CV_RELATIONAL_EVAL(5U, 25U, 0,
            ...
            *chartInstance->c15_b_guangai, 0.0, -1, 0U,
            *chartInstance->c15_b_guangai == 0.0))) {
    ...
    *chartInstance->c15_is_guangai = c15_IN_t2;
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c15_d_nargout, 1U, c15_sf_marshallOut,
      c15_sf_marshallIn);
    if (!chartInstance->c15_dataWrittenToVector[10U]) {
      _SFD_DATA_READ_BEFORE_WRITE_ERROR(26U, 4U, 8U, *chartInstance->c15_sfEvent,
        false);
    }

    *chartInstance->c15_sdt += 0.002;
    chartInstance->c15_dataWrittenToVector[10U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c15_sdt, 26U, 4U, 8U,
                          *chartInstance->c15_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
...
static void c15_b_enter_atomic_off(SFc15_aaaInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c15_ggt = 0.0;
  chartInstance->c15_dataWrittenToVector[12U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c15_ggt, 28U, 4U, 4U,
                        *chartInstance->c15_sfEvent, false);
  *chartInstance->c15_ggzhiling1 = 0.0;
  chartInstance->c15_dataWrittenToVector[6U] = true;
  ...
  *c15_inData)
{
  ...
  real_T c15_u;
  const mxArray *c15_y = NULL;
  SFc15_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc15_aaaInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c15_aaa_get_eml_resolved_functions_info(void)
{
...
static void init_simulink_io_address(SFc15_aaaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_aaa = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c15_is_c15_aaa = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    2);
...
void sf_c15_aaa_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c15_aaa_get_post_codegen_info(void);
mxArray *sf_c15_aaa_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c15_aaa_get_post_codegen_info();
...
mxArray *sf_c15_aaa_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c15_aaa_jit_fallback_info(void)
{
...
mxArray *sf_c15_aaa_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c15_aaa(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c15_aaa\",},{M[8],M[1],T\"is_active_songkai\",},{M[8],M[32],T\"is_active_kaigai\",},{M[8],M[53],T\"is_active_suoding\",},{M[8],M[63],T\"is_active_jiesuo\",},{M[8],M[86],T\"is_active_guangai\",},{M[8],M[87],T\"is_active_yajin\",},{M[9],M[0],T\"is_c15_aaa\",},{M[9],M[1],T\"is_songkai\",},{M[9],M[32],T\"is_kaigai\",}}",
  ...
  sf_c15_aaa_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc15_aaaInstanceStruct *) chartInstance,
    msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc15_aaaInstanceStruct *chartInstance = (SFc15_aaaInstanceStruct *)
...
static void sf_opaque_initialize_c15_aaa(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc15_aaaInstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc15_aaaInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c15_aaa((SFc15_aaaInstanceStruct*) chartInstanceVar);
  initialize_c15_aaa((SFc15_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c15_aaa(void *chartInstanceVar)
{
  enable_c15_aaa((SFc15_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c15_aaa(void *chartInstanceVar)
{
  disable_c15_aaa((SFc15_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c15_aaa(void *chartInstanceVar)
{
  sf_gateway_c15_aaa((SFc15_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c15_aaa(void *chartInstanceVar)
{
  ext_mode_exec_c15_aaa((SFc15_aaaInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c15_aaa(SimStruct* S)
{
  return get_sim_state_c15_aaa((SFc15_aaaInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c15_aaa(SimStruct* S, const mxArray *st)
{
  set_sim_state_c15_aaa((SFc15_aaaInstanceStruct*)sf_get_chart_instance_ptr(S),
                        st);
}

static void sf_opaque_terminate_c15_aaa(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_aaaInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_aaa_optimization_info();
    }

    finalize_c15_aaa((SFc15_aaaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc15_aaa((SFc15_aaaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_aaa(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c15_aaa((SFc15_aaaInstanceStruct*)
      sf_get_chart_instance_ptr(S));
  }
}

mxArray *sf_c15_aaa_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c15_aaa(SimStruct *S)
{
...
static void mdlRTW_c15_aaa(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c15_aaa(SimStruct *S)
{
  SFc15_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc15_aaaInstanceStruct *)utMalloc(sizeof
    (SFc15_aaaInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc15_aaaInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c15_aaa;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c15_aaa;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c15_aaa;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_aaa;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_aaa;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c15_aaa;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c15_aaa;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c15_aaa;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_aaa;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_aaa;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c15_aaa;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c15_aaa;
  ...
  mdl_start_c15_aaa(chartInstance);
}

void c15_aaa_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_aaa(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_aaa(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_aaa_method_dispatcher.\n"
