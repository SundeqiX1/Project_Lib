...
static void initialize_c13_aaa(SFc13_aaaInstanceStruct *chartInstance);
static void initialize_params_c13_aaa(SFc13_aaaInstanceStruct *chartInstance);
static void enable_c13_aaa(SFc13_aaaInstanceStruct *chartInstance);
static void disable_c13_aaa(SFc13_aaaInstanceStruct *chartInstance);
static void c13_update_debugger_state_c13_aaa(SFc13_aaaInstanceStruct
  *chartInstance);
static void ext_mode_exec_c13_aaa(SFc13_aaaInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_aaa(SFc13_aaaInstanceStruct
  *chartInstance);
static void set_sim_state_c13_aaa(SFc13_aaaInstanceStruct *chartInstance, const
  mxArray *c13_st);
static void c13_set_sim_state_side_effects_c13_aaa(SFc13_aaaInstanceStruct
  *chartInstance);
static void finalize_c13_aaa(SFc13_aaaInstanceStruct *chartInstance);
static void sf_gateway_c13_aaa(SFc13_aaaInstanceStruct *chartInstance);
static void mdl_start_c13_aaa(SFc13_aaaInstanceStruct *chartInstance);
static void c13_chartstep_c13_aaa(SFc13_aaaInstanceStruct *chartInstance);
static void initSimStructsc13_aaa(SFc13_aaaInstanceStruct *chartInstance);
static void c13_off(SFc13_aaaInstanceStruct *chartInstance);
static void c13_exit_internal_shoudong(SFc13_aaaInstanceStruct *chartInstance);
static void c13_songkai(SFc13_aaaInstanceStruct *chartInstance);
static void c13_t(SFc13_aaaInstanceStruct *chartInstance);
static void c13_kaigai(SFc13_aaaInstanceStruct *chartInstance);
static void c13_enter_atomic_off(SFc13_aaaInstanceStruct *chartInstance);
static void c13_b_t(SFc13_aaaInstanceStruct *chartInstance);
static void c13_jiesuo(SFc13_aaaInstanceStruct *chartInstance);
static void c13_c_t(SFc13_aaaInstanceStruct *chartInstance);
static void c13_suoding(SFc13_aaaInstanceStruct *chartInstance);
static void c13_d_t(SFc13_aaaInstanceStruct *chartInstance);
static void c13_yajin(SFc13_aaaInstanceStruct *chartInstance);
static void c13_e_t(SFc13_aaaInstanceStruct *chartInstance);
static void c13_guangai(SFc13_aaaInstanceStruct *chartInstance);
static void c13_b_enter_atomic_off(SFc13_aaaInstanceStruct *chartInstance);
static void c13_f_t(SFc13_aaaInstanceStruct *chartInstance);
...
static const mxArray *c13_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static real_T c13_emlrt_marshallIn(SFc13_aaaInstanceStruct *chartInstance, const
  mxArray *c13_nargout, const char_T *c13_identifier);
static real_T c13_b_emlrt_marshallIn(SFc13_aaaInstanceStruct *chartInstance,
...
static const mxArray *c13_b_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static boolean_T c13_c_emlrt_marshallIn(SFc13_aaaInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
...
static const mxArray *c13_c_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static int32_T c13_d_emlrt_marshallIn(SFc13_aaaInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
...
static const mxArray *c13_d_sf_marshallOut(void *chartInstanceVoid, void
  *c13_inData);
static uint8_T c13_e_emlrt_marshallIn(SFc13_aaaInstanceStruct *chartInstance,
  const mxArray *c13_b_is_songkai, const char_T *c13_identifier);
static uint8_T c13_f_emlrt_marshallIn(SFc13_aaaInstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c13_mxArrayInData, const char_T *c13_varName, void *c13_outData);
static void c13_g_emlrt_marshallIn(SFc13_aaaInstanceStruct *chartInstance, const
  mxArray *c13_b_dataWrittenToVector, const char_T *c13_identifier, boolean_T
  c13_y[20]);
static void c13_h_emlrt_marshallIn(SFc13_aaaInstanceStruct *chartInstance, const
  mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId, boolean_T c13_y[20]);
static const mxArray *c13_i_emlrt_marshallIn(SFc13_aaaInstanceStruct
  *chartInstance, const mxArray *c13_b_setSimStateSideEffectsInfo, const char_T *
  c13_identifier);
static const mxArray *c13_j_emlrt_marshallIn(SFc13_aaaInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static const mxArray *sf_get_hover_data_for_msg(SFc13_aaaInstanceStruct
  *chartInstance, int32_T c13_ssid);
static void c13_init_sf_message_store_memory(SFc13_aaaInstanceStruct
  *chartInstance);
static void init_dsm_address_info(SFc13_aaaInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc13_aaaInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c13_aaa(SFc13_aaaInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc13_aaa(chartInstance);
  ...
  *chartInstance->c13_is_active_jiesuo = 0U;
  *chartInstance->c13_is_jiesuo = c13_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance->c13_is_active_suoding = 0U;
  *chartInstance->c13_is_suoding = c13_IN_NO_ACTIVE_CHILD;
  ...
  *chartInstance->c13_is_active_c13_aaa = 0U;
  *chartInstance->c13_is_c13_aaa = c13_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (*chartInstance->c13_is_c13_aaa == c13_IN_off1) {
...
static void ext_mode_exec_c13_aaa(SFc13_aaaInstanceStruct *chartInstance)
{
  c13_update_debugger_state_c13_aaa(chartInstance);
}
  ...
  *chartInstance)
{
  ...
  c13_u_hoistedGlobal = *chartInstance->c13_is_active_c13_aaa;
  c13_v_y = NULL;
  ...
  c13_x_hoistedGlobal = *chartInstance->c13_is_active_suoding;
  c13_y_y = NULL;
  sf_mex_assign(&c13_y_y, sf_mex_create("y", &c13_x_hoistedGlobal, 3, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c13_y, 23, c13_y_y);
  c13_y_hoistedGlobal = *chartInstance->c13_is_active_jiesuo;
  c13_ab_y = NULL;
  ...
  c13_cb_hoistedGlobal = *chartInstance->c13_is_c13_aaa;
  c13_db_y = NULL;
  ...
  mxArray *c13_st)
{
  ...
  *chartInstance->c13_is_active_c13_aaa = c13_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_c13_aaa", c13_u, 20)),
    "is_active_c13_aaa");
  ...
  *chartInstance->c13_is_active_kaigai = c13_e_emlrt_marshallIn(chartInstance,
    ...
    "is_active_kaigai");
  *chartInstance->c13_is_active_suoding = c13_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_suoding", c13_u, 23)),
    "is_active_suoding");
  *chartInstance->c13_is_active_jiesuo = c13_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_active_jiesuo", c13_u, 24)),
    "is_active_jiesuo");
  ...
  *chartInstance->c13_is_c13_aaa = c13_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_c13_aaa", c13_u, 27)), "is_c13_aaa");
  ...
  *chartInstance->c13_is_suoding = c13_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_suoding", c13_u, 30)), "is_suoding");
  *chartInstance->c13_is_jiesuo = c13_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell("is_jiesuo", c13_u, 31)), "is_jiesuo");
  ...
  *chartInstance)
{
  if (chartInstance->c13_doSetSimStateSideEffects != 0) {
    ...
    if ((*chartInstance->c13_is_suoding == c13_IN_t) && (sf_mex_sub
         (chartInstance->c13_setSimStateSideEffectsInfo,
          "setSimStateSideEffectsInfo", 1, 20) == 0.0)) {
      *chartInstance->c13_temporalCounter_i4 = 0U;
    }

    if ((*chartInstance->c13_is_jiesuo == c13_IN_t) && (sf_mex_sub
         (chartInstance->c13_setSimStateSideEffectsInfo,
...
static void sf_gateway_c13_aaa(SFc13_aaaInstanceStruct *chartInstance)
{
  c13_set_sim_state_side_effects_c13_aaa(chartInstance);
  ...
  _SFD_DATA_RANGE_CHECK(*chartInstance->c13_b_guangai, 13U, 1U, 0U,
                        *chartInstance->c13_sfEvent, false);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c13_b_jiesuo, 12U, 1U, 0U,
                        *chartInstance->c13_sfEvent, false);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c13_b_suoding, 11U, 1U, 0U,
                        *chartInstance->c13_sfEvent, false);
  ...
  *chartInstance->c13_sfEvent = CALL_EVENT;
  ...
  c13_chartstep_c13_aaa(chartInstance);
...
static void c13_chartstep_c13_aaa(SFc13_aaaInstanceStruct *chartInstance)
{
  ...
  if (*chartInstance->c13_is_active_c13_aaa == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 12U,
                 *chartInstance->c13_sfEvent);
    *chartInstance->c13_is_active_c13_aaa = 1U;
    ...
    *chartInstance->c13_is_c13_aaa = c13_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *chartInstance->c13_sfEvent);
    ...
    *chartInstance->c13_yjyichang = 0.0;
    ...
    switch (*chartInstance->c13_is_c13_aaa) {
     case c13_IN_off:
     ...
     case c13_IN_shoudong:
      ...
      if (c13_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 2U, *chartInstance->c13_sfEvent);
        *chartInstance->c13_is_c13_aaa = c13_IN_off1;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *chartInstance->c13_sfEvent);
        ...
        *chartInstance->c13_ggzhiling2 = 0.0;
        ...
        c13_suoding(chartInstance);
        c13_jiesuo(chartInstance);
...
static void c13_off(SFc13_aaaInstanceStruct *chartInstance)
{
  ...
  if (c13_out) {
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, *chartInstance->c13_sfEvent);
    *chartInstance->c13_is_c13_aaa = c13_IN_shoudong;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 2U, *chartInstance->c13_sfEvent);
    ...
    *chartInstance->c13_skt = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c13_skt, 24U, 4U, 22U,
                          *chartInstance->c13_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
    ...
    *chartInstance->c13_is_active_suoding = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 27U, *chartInstance->c13_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 12U, *chartInstance->c13_sfEvent);
    *chartInstance->c13_is_suoding = c13_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 28U, *chartInstance->c13_sfEvent);
    ...
    *chartInstance->c13_sdt = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c13_sdt, 26U, 4U, 28U,
                          *chartInstance->c13_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
    *chartInstance->c13_is_active_jiesuo = 1U;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 9U, *chartInstance->c13_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 18U, *chartInstance->c13_sfEvent);
    *chartInstance->c13_is_jiesuo = c13_IN_off;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 10U, *chartInstance->c13_sfEvent);
    ...
    *chartInstance->c13_jst = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c13_jst, 27U, 4U, 10U,
                          *chartInstance->c13_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
    ...
    *chartInstance->c13_yjt = 0.0;
    ...
    _SFD_DATA_RANGE_CHECK(*chartInstance->c13_yjt, 29U, 4U, 34U,
                          *chartInstance->c13_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
  } else {
...
static void c13_exit_internal_shoudong(SFc13_aaaInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c13_is_active_guangai = 0U;
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 3U, *chartInstance->c13_sfEvent);
  switch (*chartInstance->c13_is_jiesuo) {
   case c13_IN_off:
    CV_STATE_EVAL(9, 1, 1);
    *chartInstance->c13_is_jiesuo = c13_IN_NO_ACTIVE_CHILD;
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 10U, *chartInstance->c13_sfEvent);
  ...
  *chartInstance->c13_is_active_jiesuo = 0U;
  _SFD_CS_CALL(STATE_INACTIVE_TAG, 9U, *chartInstance->c13_sfEvent);
  switch (*chartInstance->c13_is_suoding) {
   case c13_IN_off:
   ...
   case c13_IN_off:
    ...
    if (CV_EML_COND(1, 0, 0, CV_RELATIONAL_EVAL(5U, 1U, 0,
         ...
         CV_RELATIONAL_EVAL(5U, 1U, 1, *chartInstance->c13_yjdw, 1.0, -1, 0U,
                            *chartInstance->c13_yjdw == 1.0)) && CV_EML_COND(1,
         0, 2, CV_RELATIONAL_EVAL(5U, 1U, 2, *chartInstance->c13_sddw, 1.0, -1,
          0U, *chartInstance->c13_sddw == 1.0))) {
    ...
    if (c13_c_out) {
      ...
      *chartInstance->c13_skt += 0.002;
      ...
      if (CV_EML_COND(4, 0, 0, CV_RELATIONAL_EVAL(5U, 4U, 0,
            ...
            *chartInstance->c13_jsdw, 1.0, -1, 0U, *chartInstance->c13_jsdw ==
            1.0)) && CV_EML_COND(4, 0, 2, CV_RELATIONAL_EVAL(5U, 4U, 2,
            *chartInstance->c13_b_songkai, 0.0, -1, 0U,
            *chartInstance->c13_b_songkai == 0.0))) {
...
static void c13_t(SFc13_aaaInstanceStruct *chartInstance)
{
  ...
  if (c13_out) {
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c13_b_out, 2U, c13_b_sf_marshallOut,
      c13_b_sf_marshallIn);
    c13_b_out = CV_EML_IF(3, 0, 0, CV_RELATIONAL_EVAL(5U, 3U, 0,
      *chartInstance->c13_skdw, 0.0, -1, 0U, *chartInstance->c13_skdw == 0.0));
    _SFD_SYMBOL_SCOPE_POP();
    if (c13_b_out) {
      _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 3U, *chartInstance->c13_sfEvent);
   ...
   case c13_IN_off:
    ...
    if (CV_EML_COND(8, 0, 0, CV_RELATIONAL_EVAL(5U, 8U, 0,
         ...
         CV_RELATIONAL_EVAL(5U, 8U, 1, *chartInstance->c13_skdw, 1.0, -1, 0U,
                            *chartInstance->c13_skdw == 1.0)) && CV_EML_COND(8,
         0, 2, CV_RELATIONAL_EVAL(5U, 8U, 2, *chartInstance->c13_jsdw, 1.0, -1,
          0U, *chartInstance->c13_jsdw == 1.0))) {
    ...
    if (c13_c_out) {
      ...
      *chartInstance->c13_temporalCounter_i2 = 0U;
      ...
      if (CV_EML_COND(7, 0, 0, CV_RELATIONAL_EVAL(5U, 7U, 0,
            ...
            *chartInstance->c13_b_kaigai, 0.0, -1, 0U,
            *chartInstance->c13_b_kaigai == 0.0))) {
...
static void c13_enter_atomic_off(SFc13_aaaInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c13_kgt = 0.0;
  chartInstance->c13_dataWrittenToVector[9U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c13_kgt, 25U, 4U, 16U,
                        *chartInstance->c13_sfEvent, false);
  *chartInstance->c13_kgzhiling1 = 0.0;
  chartInstance->c13_dataWrittenToVector[4U] = true;
  ...
  switch (*chartInstance->c13_is_jiesuo) {
   case c13_IN_off:
    ...
    if (CV_EML_COND(22, 0, 0, CV_RELATIONAL_EVAL(5U, 22U, 0,
          *chartInstance->c13_b_jiesuo, 1.0, -1, 0U,
          *chartInstance->c13_b_jiesuo == 1.0)) && CV_EML_COND(22, 0, 1,
         CV_RELATIONAL_EVAL(5U, 22U, 1, *chartInstance->c13_yjdw, 1.0, -1, 0U,
                            *chartInstance->c13_yjdw == 1.0)) && CV_EML_COND(22,
         0, 2, CV_RELATIONAL_EVAL(5U, 22U, 2, *chartInstance->c13_sddw, 1.0, -1,
          0U, *chartInstance->c13_sddw == 1.0)) && CV_EML_COND(22, 0, 3,
         CV_RELATIONAL_EVAL(5U, 22U, 3, *chartInstance->c13_kgdw1, 1.0, -1, 0U, *
                            chartInstance->c13_kgdw1 == 1.0)) && CV_EML_COND(22,
         0, 4, CV_RELATIONAL_EVAL(5U, 22U, 4, *chartInstance->c13_kgdw2, 1.0, -1,
    ...
    if (c13_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 10U, *chartInstance->c13_sfEvent);
      *chartInstance->c13_is_jiesuo = c13_IN_on;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 11U, *chartInstance->c13_sfEvent);
   ...
   case c13_IN_on:
    ...
    if (c13_c_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 11U, *chartInstance->c13_sfEvent);
      *chartInstance->c13_is_jiesuo = c13_IN_t;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 12U, *chartInstance->c13_sfEvent);
      *chartInstance->c13_temporalCounter_i3 = 0U;
      ...
      if (CV_EML_COND(19, 0, 0, CV_RELATIONAL_EVAL(5U, 19U, 0,
            ...
            *chartInstance->c13_b_jiesuo, 0.0, -1, 0U,
            *chartInstance->c13_b_jiesuo == 0.0))) {
      ...
      if (c13_e_out) {
        ...
        *chartInstance->c13_jst = 0.0;
        ...
        if (c13_f_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 11U, *chartInstance->c13_sfEvent);
          *chartInstance->c13_is_jiesuo = c13_IN_t1;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 13U, *chartInstance->c13_sfEvent);
   ...
   case c13_IN_t1:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 13U, *chartInstance->c13_sfEvent);
    *chartInstance->c13_is_jiesuo = c13_IN_t2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 14U, *chartInstance->c13_sfEvent);
  ...
  switch (*chartInstance->c13_is_suoding) {
   case c13_IN_off:
    ...
    if (CV_EML_COND(14, 0, 0, CV_RELATIONAL_EVAL(5U, 14U, 0,
          *chartInstance->c13_b_suoding, 1.0, -1, 0U,
          *chartInstance->c13_b_suoding == 1.0)) && CV_EML_COND(14, 0, 1,
         CV_RELATIONAL_EVAL(5U, 14U, 1, *chartInstance->c13_skdw, 1.0, -1, 0U,
                            *chartInstance->c13_skdw == 1.0)) && CV_EML_COND(14,
         0, 2, CV_RELATIONAL_EVAL(5U, 14U, 2, *chartInstance->c13_jsdw, 1.0, -1,
          0U, *chartInstance->c13_jsdw == 1.0)) && CV_EML_COND(14, 0, 3,
         CV_RELATIONAL_EVAL(5U, 14U, 3, *chartInstance->c13_kgdw1, 1.0, -1, 0U, *
                            chartInstance->c13_kgdw1 == 1.0)) && CV_EML_COND(14,
         0, 4, CV_RELATIONAL_EVAL(5U, 14U, 4, *chartInstance->c13_kgdw2, 1.0, -1,
          0U, *chartInstance->c13_kgdw2 == 1.0))) {
    ...
    if (c13_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 28U, *chartInstance->c13_sfEvent);
      *chartInstance->c13_is_suoding = c13_IN_on;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 29U, *chartInstance->c13_sfEvent);
   ...
   case c13_IN_on:
    ...
    if (c13_c_out) {
      ...
      _SFD_CS_CALL(STATE_INACTIVE_TAG, 29U, *chartInstance->c13_sfEvent);
      *chartInstance->c13_is_suoding = c13_IN_t;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 30U, *chartInstance->c13_sfEvent);
      *chartInstance->c13_temporalCounter_i4 = 0U;
      ...
      if (CV_EML_COND(13, 0, 0, CV_RELATIONAL_EVAL(5U, 13U, 0,
            ...
            *chartInstance->c13_b_suoding, 0.0, -1, 0U,
            *chartInstance->c13_b_suoding == 0.0))) {
      ...
      if (c13_e_out) {
        ...
        *chartInstance->c13_sdt = 0.0;
        ...
        if (c13_f_out) {
          ...
          _SFD_CS_CALL(STATE_INACTIVE_TAG, 29U, *chartInstance->c13_sfEvent);
          *chartInstance->c13_is_suoding = c13_IN_t1;
          _SFD_CS_CALL(STATE_ACTIVE_TAG, 31U, *chartInstance->c13_sfEvent);
   ...
   case c13_IN_t1:
    ...
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 31U, *chartInstance->c13_sfEvent);
    *chartInstance->c13_is_suoding = c13_IN_t2;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 32U, *chartInstance->c13_sfEvent);
  ...
  switch (*chartInstance->c13_is_yajin) {
    ...
    if (c13_c_out) {
      ...
      *chartInstance->c13_temporalCounter_i5 = 0U;
      ...
      if (CV_EML_COND(31, 0, 0, CV_RELATIONAL_EVAL(5U, 31U, 0,
            ...
            *chartInstance->c13_b_yajin, 0.0, -1, 0U,
            *chartInstance->c13_b_yajin == 0.0))) {
   ...
   case c13_b_IN_t2:
    ...
    if (c13_b_out) {
      ...
      *chartInstance->c13_sdt += 0.002;
      chartInstance->c13_dataWrittenToVector[10U] = true;
      _SFD_DATA_RANGE_CHECK(*chartInstance->c13_sdt, 26U, 4U, 37U,
                            *chartInstance->c13_sfEvent, false);
      _SFD_SYMBOL_SCOPE_POP();
    } else {
  ...
  switch (*chartInstance->c13_is_guangai) {
   case c13_IN_off:
    ...
    if (CV_EML_COND(26, 0, 0, CV_RELATIONAL_EVAL(5U, 26U, 0,
         ...
         CV_RELATIONAL_EVAL(5U, 26U, 1, *chartInstance->c13_skdw, 1.0, -1, 0U,
                            *chartInstance->c13_skdw == 1.0)) && CV_EML_COND(26,
         0, 2, CV_RELATIONAL_EVAL(5U, 26U, 2, *chartInstance->c13_jsdw, 1.0, -1,
          0U, *chartInstance->c13_jsdw == 1.0))) {
    ...
    if (c13_c_out) {
      ...
      *chartInstance->c13_temporalCounter_i6 = 0U;
      ...
      if (CV_EML_COND(25, 0, 0, CV_RELATIONAL_EVAL(5U, 25U, 0,
            ...
            *chartInstance->c13_b_guangai, 0.0, -1, 0U,
            *chartInstance->c13_b_guangai == 0.0))) {
    ...
    *chartInstance->c13_is_guangai = c13_IN_t2;
    ...
    _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c13_d_nargout, 1U, c13_sf_marshallOut,
      c13_sf_marshallIn);
    if (!chartInstance->c13_dataWrittenToVector[10U]) {
      _SFD_DATA_READ_BEFORE_WRITE_ERROR(26U, 4U, 8U, *chartInstance->c13_sfEvent,
        false);
    }

    *chartInstance->c13_sdt += 0.002;
    chartInstance->c13_dataWrittenToVector[10U] = true;
    _SFD_DATA_RANGE_CHECK(*chartInstance->c13_sdt, 26U, 4U, 8U,
                          *chartInstance->c13_sfEvent, false);
    _SFD_SYMBOL_SCOPE_POP();
...
static void c13_b_enter_atomic_off(SFc13_aaaInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c13_ggt = 0.0;
  chartInstance->c13_dataWrittenToVector[12U] = true;
  _SFD_DATA_RANGE_CHECK(*chartInstance->c13_ggt, 28U, 4U, 4U,
                        *chartInstance->c13_sfEvent, false);
  *chartInstance->c13_ggzhiling1 = 0.0;
  chartInstance->c13_dataWrittenToVector[6U] = true;
  ...
  *c13_inData)
{
  ...
  real_T c13_u;
  const mxArray *c13_y = NULL;
  SFc13_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc13_aaaInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c13_aaa_get_eml_resolved_functions_info(void)
{
...
static void init_simulink_io_address(SFc13_aaaInstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_aaa = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 1);
  chartInstance->c13_is_c13_aaa = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    2);
  ...
  chartInstance->c13_is_active_kaigai = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 6);
  chartInstance->c13_is_jiesuo = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    7);
  chartInstance->c13_is_active_jiesuo = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 8);
  chartInstance->c13_is_suoding = (uint8_T *)ssGetDWork_wrapper(chartInstance->S,
    9);
  chartInstance->c13_is_active_suoding = (uint8_T *)ssGetDWork_wrapper
    (chartInstance->S, 10);
  ...
  chartInstance->c13_b_kaigai = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 10);
  chartInstance->c13_b_suoding = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 11);
  chartInstance->c13_b_jiesuo = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 12);
...
void sf_c13_aaa_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c13_aaa_get_post_codegen_info(void);
mxArray *sf_c13_aaa_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c13_aaa_get_post_codegen_info();
...
mxArray *sf_c13_aaa_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c13_aaa_jit_fallback_info(void)
{
...
mxArray *sf_c13_aaa_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c13_aaa(void)
{
  ...
  const char *infoEncStr[] = {
    ...
    "100 S1x10'type','srcId','name','auxInfo'{{M[8],M[0],T\"is_active_c13_aaa\",},{M[8],M[1],T\"is_active_songkai\",},{M[8],M[32],T\"is_active_kaigai\",},{M[8],M[53],T\"is_active_suoding\",},{M[8],M[63],T\"is_active_jiesuo\",},{M[8],M[86],T\"is_active_guangai\",},{M[8],M[87],T\"is_active_yajin\",},{M[9],M[0],T\"is_c13_aaa\",},{M[9],M[1],T\"is_songkai\",},{M[9],M[32],T\"is_kaigai\",}}",
  ...
  sf_c13_aaa_get_check_sum(&mxChecksum);
...
static const mxArray* sf_opaque_get_hover_data_for_msg(void* chartInstance,
  int32_T msgSSID)
{
  return sf_get_hover_data_for_msg( (SFc13_aaaInstanceStruct *) chartInstance,
    msgSSID);
}
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc13_aaaInstanceStruct *chartInstance = (SFc13_aaaInstanceStruct *)
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S)) {
      /* do this only if simulation is starting and after we know the addresses of all data */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(11U, chartInstance->c13_b_suoding);
        _SFD_SET_DATA_VALUE_PTR(12U, chartInstance->c13_b_jiesuo);
...
static void sf_opaque_initialize_c13_aaa(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc13_aaaInstanceStruct*) chartInstanceVar)->S);
  chart_debug_initialization(((SFc13_aaaInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c13_aaa((SFc13_aaaInstanceStruct*) chartInstanceVar);
  initialize_c13_aaa((SFc13_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_aaa(void *chartInstanceVar)
{
  enable_c13_aaa((SFc13_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_aaa(void *chartInstanceVar)
{
  disable_c13_aaa((SFc13_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_aaa(void *chartInstanceVar)
{
  sf_gateway_c13_aaa((SFc13_aaaInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c13_aaa(void *chartInstanceVar)
{
  ext_mode_exec_c13_aaa((SFc13_aaaInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c13_aaa(SimStruct* S)
{
  return get_sim_state_c13_aaa((SFc13_aaaInstanceStruct *)
    sf_get_chart_instance_ptr(S));     /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c13_aaa(SimStruct* S, const mxArray *st)
{
  set_sim_state_c13_aaa((SFc13_aaaInstanceStruct*)sf_get_chart_instance_ptr(S),
                        st);
}

static void sf_opaque_terminate_c13_aaa(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_aaaInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_aaa_optimization_info();
    }

    finalize_c13_aaa((SFc13_aaaInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_aaa((SFc13_aaaInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_aaa(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c13_aaa((SFc13_aaaInstanceStruct*)
      sf_get_chart_instance_ptr(S));
  }
}

mxArray *sf_c13_aaa_get_testpoint_info(void)
{
  return NULL;
}
...
static void mdlSetWorkWidths_c13_aaa(SimStruct *S)
{
...
static void mdlRTW_c13_aaa(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c13_aaa(SimStruct *S)
{
  SFc13_aaaInstanceStruct *chartInstance;
  chartInstance = (SFc13_aaaInstanceStruct *)utMalloc(sizeof
    (SFc13_aaaInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc13_aaaInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 0;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c13_aaa;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c13_aaa;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c13_aaa;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_aaa;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_aaa;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c13_aaa;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c13_aaa;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c13_aaa;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_aaa;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_aaa;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c13_aaa;
  chartInstance->chartInfo.callGetHoverDataForMsg =
    sf_opaque_get_hover_data_for_msg;
  chartInstance->chartInfo.extModeExec = sf_opaque_ext_mode_exec_c13_aaa;
  ...
  mdl_start_c13_aaa(chartInstance);
}

void c13_aaa_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_aaa(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_aaa(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_aaa_method_dispatcher.\n"
