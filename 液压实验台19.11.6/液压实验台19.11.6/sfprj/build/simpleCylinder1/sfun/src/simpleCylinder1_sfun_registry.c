...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_simpleCylinder1_process_check_sum_call( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_simpleCylinder1_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_autoinheritence_call( int nlhs, mxArray * plhs[], int
 nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_simpleCylinder1_autoinheritance_info( int nlhs, mxArray
   * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_simpleCylinder1_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
...
extern unsigned int sf_simpleCylinder1_method_dispatcher(SimStruct *S, const
 char *chartName, int_T method, void *data);
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
 char *chartName, int_T method, void *data)
{
  if(sf_simpleCylinder1_method_dispatcher(simstructPtr,chartName,method,data))
  return 1;
  return 0;
}
extern void simpleCylinder1_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    simpleCylinder1_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void simpleCylinder1_initializer(void);
extern void simpleCylinder1_register_exported_symbols(SimStruct* S);
extern void simpleCylinder1_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  simpleCylinder1_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      simpleCylinder1_debug_initialize();
    }
    simpleCylinder1_initializer();
  }
  return;
}
