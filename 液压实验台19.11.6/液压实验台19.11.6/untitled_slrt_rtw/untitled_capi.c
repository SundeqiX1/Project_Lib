...
static const rtwCAPI_BlockParameters rtBlockParameters[] = {
   ...
   */
  { 2, TARGET_STRING("Constant"),
    TARGET_STRING("Value"), 0, 0, 0 },

  { 3, TARGET_STRING("PCI-2"),
    TARGET_STRING("P1"), 0, 2, 0 },

  { 4, TARGET_STRING("PCI-2"),
    TARGET_STRING("P2"), 0, 2, 0 },

  { 5, TARGET_STRING("PCI-6208A DA "),
    TARGET_STRING("P1"), 0, 3, 0 },

  { 6, TARGET_STRING("PCI-6208A DA "),
    TARGET_STRING("P2"), 0, 0, 0 },

  { 7, TARGET_STRING("PCI-6208A DA "),
    TARGET_STRING("P3"), 0, 0, 0 },

  { 8, TARGET_STRING("PCI-6208A DA "),
    TARGET_STRING("P4"), 0, 2, 0 },

  { 9, TARGET_STRING("PCI-6208A DA "),
    TARGET_STRING("P5"), 0, 3, 0 },

  { 10, TARGET_STRING("PCI-6208A DA "),
...
static void* rtDataAddrMap[] = {
  &untitled_B.Constant,                /* 0: Signal */
  &untitled_B.PCI2[0],                 /* 1: Signal */
  &untitled_P.Constant_Value,          /* 2: Block Parameter */
  &untitled_P.PCI2_P1[0],              /* 3: Block Parameter */
  &untitled_P.PCI2_P2[0],              /* 4: Block Parameter */
  &untitled_P.PCI6208ADA_P1[0],        /* 5: Block Parameter */
  &untitled_P.PCI6208ADA_P2,           /* 6: Block Parameter */
  &untitled_P.PCI6208ADA_P3,           /* 7: Block Parameter */
  &untitled_P.PCI6208ADA_P4[0],        /* 8: Block Parameter */
  &untitled_P.PCI6208ADA_P5[0],        /* 9: Block Parameter */
  &untitled_P.PCI6208ADA_P6[0],        /* 10: Block Parameter */
};
